...
<body>
	...
	<div id="page-wrap">
		...
		<h3>:: Adjust Employee Opening Balance Into the system </h3>
...
<form name="new_user" action="processadjustempbal.php" method="post">			
...
?></td>
	...
	<tr height="30">
    <td>&nbsp;</td>
    <td  width="25%">Select Staff / Employee<font color="#FF0000">*</font></td>
    <td>
...
<tr height="20">
	...
	Increase<input type="radio" size="41" name="bal_type" checked="checked" value="1">&nbsp;&nbsp;
