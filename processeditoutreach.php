...
$sqlupdt= "UPDATE outreach_record SET date_from='$date_from',date_to='$date_to',location='$outreach_loc',fac_male='$fuc_male',fac_female='$fuc_female',
...
$sqlupdt= "UPDATE diagnosis SET disease_id='$disease_id',total_pat='$total_pat',male_pat='$male_pat',female_pat='$female_pat',child_pat='$child_pat',remarks='$remarks' where diagnosis_id='$diagnosis_id'";
$resultsupdt= mysql_query($sqlupdt) or die ("Error $sqlupdt.".mysql_error());

header ("Location:home.php?editoutreach=editoutreach&editconfirm=1&outreach_record_id=$outreach_record_id");
