...
<strong>By Date</strong>
   ...
   <tr style="background:url(images/description.gif);" height="30" >
	...
	<td width="10%"><div align="center"><strong>Amount </br>(Mixed Currency)</strong></td>
...
$queryop="select * FROM farmers,mop,farmers_advance_payments,currency where farmers_advance_payments.mop=mop.mop_id 
and farmers_advance_payments.farmer_id=farmers.farmer_id and farmers_advance_payments.currency_code=currency.curr_id
ORDER BY farmers_advance_payments.farmers_advance_payment_id desc ";
...
echo $date_received=$rows->date_paid; 
	...
	<td><?php $farmer_name=$rows->farmer_name;
...
echo $newchapter_name = wordwrap($farmer_name, 15, "<br />\n");  
...
$cred_acc_name2=$rows34c->account_code.' - '.$rows34c->account_type_name;

echo $newchapter_name = wordwrap($cred_acc_name2, 15, "<br />\n");  
...
$results34c= mysql_query($sql34c) or die ("Error $sql34c.".mysql_error());
$rows34c=mysql_fetch_object($results34c);
$cred_acc_name=$rows34c->account_code.' - '.$rows34c->account_type_name;


echo $newchapter_name = wordwrap($cred_acc_name, 15, "<br />\n");  
...
?>
	...
	<td align="center"><a href="home.php?farmers_advances&id=<?php echo $rows->farmers_advance_payment_id; ?>"><img src="images/edit.png"></a></td>
