...
?>
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
    ...
    <td align="center" width="100"><strong>Visa Type</strong></td>
...
$sql="select employees.emp_fname,employees.emp_lname,employees.emp_mname, employees.employee_no,renewed_visas.visa_type,employees.title,employees.nationality,
 renewed_visas.issue_date,renewed_visas.charges,renewed_visas.curr_rate,renewed_visas.visa_details_id,
 renewed_visas.exp_date,renewed_visas.emp_id,currency.curr_initials from currency,employees,renewed_visas 
 WHERE renewed_visas.currency=currency.curr_id AND employees.emp_id=renewed_visas.emp_id order by employees.emp_fname asc";
...
echo $rows->nationality;
	...
	?></td>
	<td align="center"><?php echo $rows->visa_type;?></td>
