...
<form name="emp" id="emp" action="processeditstaffids.php?emp_id=<?php echo $emp_id; ?>" method="post">			
...
?></td>
  ...
  <tr height="20">
	...
	$sql="SELECT * FROM staff_ids WHERE emp_id='$emp_id'";
...
$rows=mysql_fetch_object($results);
	...
	<td colspan="4" ><h3>Personal Certification - Staff Identification Card Details for (<?php 
...
echo $rowslatelpo->emp_fname.' '.$rowslatelpo->emp_mname.' '.$rowslatelpo->emp_lname;
  ...
  <tr height="20">
    ...
    <td width="15%">ID Number<font color="#FF0000">*</font></td>
    <td bgcolor="" width="20%"><input type="text" size="41" name="id_no" value="<?php echo $rows->id_no;?>"></td>
  ...
  <tr height="20">
    ...
    <td><textarea name="id_remarks" rows="5" cols="35"><?php echo $rows->id_remarks;?></textarea>
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("id_no","req",">>Please enter staff id number");
