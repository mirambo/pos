...
{
$sqllpo= "insert into lpo values('','$latest_comments','','','','','$currency','$curr_rate','$get_prnt_supid','$latest_order_code','$user_id',NOW(),'1')";
...
header ("Location:lpo_word.php?lpo_id=$latest_lpo_id&order_code=$latest_order_code&supp_id=$get_prnt_supid&currency=$currency&shipp_id=$get_prnt_ship&pay_terms=$get_prnt_payterms&lpo_no=$lpo_no&comments=$get_comments&freight_charge=$freight_charge");
