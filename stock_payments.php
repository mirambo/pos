...
?>
   ...
   <tr style="background:url(images/description.gif);" height="30" >
    <td width="100"><div align="center"><strong>LPO No.</strong></td>
	<td width="300"><div align="center"><strong>Date Generated</strong></td>
	<td width="350"><div align="center"><strong>Supplier Name</strong></td>
    <td width="200"><div align="center"><strong>Cost<br/>(Other Currency)</strong></td>
	<td width="100"><div align="center"><strong>Exchange Rate</strong></td>	
<td width="200"><div align="center"><strong>Cost<br/>(Kshs.)</strong></td>
<td width="200"><div align="center"><strong>Amount Paid<br/>(Kshs.)</strong></td>
<td width="200"><div align="center"><strong>Balance<br/>(Kshs.)</strong></td>
<td width="100"><div align="center"><strong>Mode of Payment</strong></td>
...
$sql="SELECT stock_payments.lpo_no,stock_payments.freight_charges,stock_payments.cost_of_stock,SUM(stock_payments.amnt_paid) as ttl_paid,stock_payments.exchange_rate,stock_payments.mop,stock_payments.date_paid,suppliers.supplier_name,currency.curr_name
FROM stock_payments,suppliers,currency WHERE stock_payments.supplier_id=suppliers.supplier_id AND stock_payments.currency=currency.curr_id GROUP BY stock_payments.lpo_no";
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>
	...
	<td align="right" ><?php echo $rows->curr_name.' '.number_format($ttl_stock_ret=$rows->cost_of_stock,2);?></td>
	<td align="right"><?php
...
echo $ex_rate=$rows->exchange_rate;
 ...
 <td width="200" align="right"><?php echo number_format($amnt_paid_kshs=$rows->ttl_paid*$ex_rate,2);?></td>
  <td width="200" align="right"><?php 
 echo  number_format($bal_kshs=$stock_ret_kshs-$amnt_paid_kshs,2);
  
  ?></td>
   <td width="200"><i><?php echo $rows->mop;?></i></td>
