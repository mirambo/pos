...
<form name="new_supplier" action="processeditperdm.php?per_dm_charge_id=<?php echo $per_dm_charge_id; ?>" method="post">			
...
?></td>
	...
	<?php 
$sql="SELECT per_dm_charges.per_dm_charge_value,per_dm_charges.per_dm_charge_id,per_dm_charges.curr_rate,per_dm_charges.curr_id,currency.curr_name,currency.curr_initials FROM per_dm_charges,currency
 where per_dm_charges.curr_id=currency.curr_id AND per_dm_charge_id='$per_dm_charge_id'";
...
$rows=mysql_fetch_object($results);
  ...
  <tr height="20">
    <td bgcolor="">&nbsp;</td>
    <td width="19%">Currency<font color="#FF0000">*</font></td>
    <td width="23%">
...
{								
	...
	<tr height="20">
    <td>&nbsp;</td>
    <td>Per Diem Charges<font color="#FF0000">*</font></td>
    <td><input type="text" size="41" name="per_dm_charge" value="<?php echo $rows->per_dm_charge_value;?>" ></td>
    </tr>
