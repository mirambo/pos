...
$sqlstch="update users set suspend ='0'  where user_id='$user_id'";
...
$sqlstch="update users set suspend ='1'  where user_id='$user_id'";
$resultsstch= mysql_query($sqlstch) or die ("Error $sqlstch.".mysql_error());
...
header ("Location:home.php?viewusers=viewusers");
