...
echo $quant_ret=$rowssalesret->ttl_ret_quant;
	...
	<td align="center"><a href="edit_return_stock.php?lpo_no=<?php echo $lpo_no; ?>&supplier_id=<?php echo $rows->supplier_id; ?>&order_code=<?php echo $rows->order_code; ?>&product_id=<?php echo $rows->product_id; ?>&qnty_ordered=<?php echo $quant_ordered; ?>&purchase_order_id=<?php  echo $rows->purchase_order_id;?>&stock_returns_id=<?php echo $rows->stock_returns_id;?>"><img src="images/edit.png"></a>
