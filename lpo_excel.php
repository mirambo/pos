...
header("Content-Disposition: attachment;Filename=Purchase_Order-$lpo_no.xls");
header("Expires: 0");
...
$rowscont=mysql_fetch_object($resultscont);
 ...
 <!--<td colspan="6" align="right">JUBA STATIONERY AND PRINTING COMPANY LIMITED</td>-->
 <td colspan="6" align="right"><?php echo $rowscont->cont_person;?></td>
  ...
  <tr height="30">
    <td colspan="7" bgcolor="#000033" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">PURCHASE ORDER</span></td>
  </tr>
   
   <tr height="30">
    <td colspan="4"  align="left"><strong>PURCHASE ORDER NO :  <?php 
	echo $lpo_no;
...
$rowscont=mysql_fetch_object($resultscont);
  ...
  <tr>
    <td colspan="3"><?php echo $rowscont->cont_person; ?></td>
  ...
  <tr>
    <td colspan="3"><?php echo  $rowscont->phone; ?></td>
  ...
  <tr>
    <td colspan="3"><?php echo  $rowscont->telephone; ?></td>
  ...
  <tr>
    <td colspan="3"><?php echo  $rowscont->email; ?></td>
