<tr height="10" bgcolor="#C0D7E5" >
    <td width="10%" colspan="3">Less Allowance for Doubtful Debts</td>
...
else
{
	...
	$ledger_bal_dd=$ledger_bal_dd+$amount_kshs; 
  ...
  <?php 
  echo "(".number_format($ledger_bal_dd,2).")";
  }
...
$grnd_amount_out_kshs=0; 
$sql="select  doubtful_debts_ledger.transaction_id,doubtful_debts_ledger.transactions,doubtful_debts_ledger.amount,doubtful_debts_ledger.debit,doubtful_debts_ledger.credit,doubtful_debts_ledger.currency_code,doubtful_debts_ledger.curr_rate,doubtful_debts_ledger.date_recorded, currency.curr_name 
from doubtful_debts_ledger,currency where doubtful_debts_ledger.currency_code=currency.curr_id AND doubtful_debts_ledger.date_recorded BETWEEN '$date_from' AND '$date_to' order by doubtful_debts_ledger.transaction_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
