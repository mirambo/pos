...
<body>
	...
	<?php require_once('includes/cashledgersubmenu.php');  ?>
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
	...
	<a style="float:right; margin-right:200px; font-weight:bold; font-size:13px; color:#000000" href="print_cash_ledger.php" target="_blank">Print</a>
	
	|<a style="float:right; margin-right:200px; font-weight:bold; font-size:13px; color:#000000" href="print_cash_ledger_word.php">Export to word</a>
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
	...
	<td width="200"><div align="center"><strong>Exchange Rate</strong></td>
	 <td width="200" ><div align="center"><strong>Debit (SSP)</strong></td>	
	<td width="200" ><div align="center"><strong>Credit (SSP)</strong></td>
...
from cash_ledger,currency where cash_ledger.currency_code=currency.curr_id AND cash_ledger.amount!='' and cash_ledger.amount!='0'  order by cash_ledger.transaction_id asc";
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
    ...
    <td colspan="9" height="30" align="right"><font size="+1">
	<a href="print_cash_ledger.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to; ?>" target="_blank">Print</a> | <a href="print_cash_ledger_word.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to; ?>">Export to word </a>
...
<?php 
$sqlbbd="select  cash_ledger.transaction_id,cash_ledger.transactions,cash_ledger.amount,cash_ledger.debit,cash_ledger.credit,cash_ledger.currency_code,cash_ledger.curr_rate,cash_ledger.date_recorded, currency.curr_name 
from cash_ledger,currency where cash_ledger.currency_code=currency.curr_id AND date_recorded <'$date_from' order by cash_ledger.transaction_id asc";
...
$grnd_amount_out_kshs=0; 
$sql="select  cash_ledger.transaction_id,cash_ledger.transactions,cash_ledger.amount,cash_ledger.debit,cash_ledger.credit,cash_ledger.currency_code,cash_ledger.curr_rate,cash_ledger.date_recorded, currency.curr_name 
from cash_ledger,currency where cash_ledger.currency_code=currency.curr_id AND date_recorded BETWEEN '$date_from' AND '$date_to' order by cash_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
    ...
    <td colspan="9" height="30" align="right"><font size="+1">
	<a href="print_cash_ledger.php" target="_blank">Print</a>|<a href="print_cash_ledger_word.php">Export to word </a>
