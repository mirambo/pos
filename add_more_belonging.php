...
?>
<form name="new_machine_category" action="process_add_customer_item.php" method="post">			
...
?></td>
  ...
  <tr style="background:url(images/description.gif);" height="20" >
	...
	<td width="100"><strong><input type="text" name="customer_item_name" size="50"></strong></td>
