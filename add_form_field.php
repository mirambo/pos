...
<form name="new_supplier" action="processaddfield.php" method="post">			
...
?></td>
  ...
  <tr height="20">
    <td bgcolor="" width="20%">&nbsp;</td>
    <td width="5%">Enter Form Field Name<font color="#FF0000">*</font></td>
    <td width="23%"><input type="text" size="41" name="field_name"></td>
