...
<form name="emp" id="emp" action="processspecs.php?emp_id=<?php echo $emp_id; ?>" method="post">			
...
echo $rowslatelpo->emp_fname.' '.$rowslatelpo->emp_mname.' '.$rowslatelpo->emp_lname;
  ...
  <tr height="20">
    ...
    <td bgcolor="" width="20%"><input type="text" size="41" name="spec_no"></td>
  ...
  <tr height="20">
    ...
    <td><textarea name="spec_remarks" rows="5" cols="35"></textarea>
