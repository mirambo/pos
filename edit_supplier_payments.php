...
$supplier_payments_id=$_GET['supplier_payments_id'];
...
and  supplier_payments.supplier_payments_id='$supplier_payments_id'";
...
<form name="gen_order" action="process_edit_supplier_payment.php?supplier_payments_id=<?php echo $supplier_payments_id;?>" method="post">			
...
if (mysql_num_rows($resultsbnk) > 0)
{
  ...
  <tr height="15" bgcolor="#FFFFCC">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2" align="center"><input onClick="return confirmEdit();" type="submit" name="submit" value="Save Transaction">&nbsp;<input type="reset" value="Cancel"></td>
