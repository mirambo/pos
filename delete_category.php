...
$sales_id=$_GET['cat_id'];
$sales_item_id=$_GET['sales_item_id'];
$view=$_GET['view'];
$cash=$_GET['cash'];


$sql= "delete from items_category where cat_id='$sales_id'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());


$sqlauditsav= "insert into audit_trail values('','$user_id',NOW(),'Deleted a category system')";
