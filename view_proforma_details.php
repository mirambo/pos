<?php 
$sqlrec="SELECT * FROM proforma WHERE sales_id='$sales_id'";
...
<script src="js/application.js" type="text/javascript" charset="utf-8"></script> -->
	...
	<h3 align="center">View Proforma Invoice Details
	...
	<a style="float:right; margin-right:200px;" target="_blank" href="print_proforma_invoice.php?sales_id=<?php echo $sales_id;?>&cash=1">
...
<strong>Customer Name : </strong><i><?php echo $customer_name;  ?></i>
 ...
 echo "No";
	...
	<a rel="facebox" href="edit_proforma.php?sales_id=<?php echo $sales_id;?>"><img src="images/edit.png"></a>
...
<a title="Creating New Items That doesnt exist" style="color:#fff;font-weight:bold; float:right;" rel="facebox" href="add_more_proforma_item.php?sales_id=<?php echo $sales_id ?>"> [ Add More Items ]</a>
</td></tr>
<tr><td>
<table width="100%">
...
<?php 
$task_totals=0;
$sqllpdet="select * FROM proforma_item,items WHERE proforma_item.item_id=items.item_id AND 
proforma_item.sales_id='$sales_id' order by sales_item_id desc";
...
if ($sess_allow_edit==1)
{
	...
	<a rel="facebox" href="edit_proforma_item.php?sales_item_id=<?php echo $rowslpdet->sales_item_id; ?>&sales_id=<?php echo $sales_id; ?>&cash=1"><img src="images/edit.png"></a>
	<?php
...
<a href="delete_proforma_item.php?sales_id=<?php echo $sales_id; ?>&sales_item_id=<?php echo $rowslpdet->sales_item_id;?>&cash=1"><img src="images/delete.png" onClick="return confirmDelete();"></a>
