...
header("Content-Disposition: attachment;Filename=National_Payroll_Report.xlsx");
header("Expires: 0");
...
<tr > <td colspan="24" width="100%"  align="center"><img src="<?php echo $base_url; ?>images/logoeaco.jpg" align="center" width="100" height="100"></td></tr>
<tr > <td colspan="24" align="center"><H2>SIPET ENGINEERING & CONSULTANCY SERVICES CO. LIMITED</H2></td></tr>
<tr > <td colspan="24" align="center"><H2>General National Payroll Report</H2></td>
...
echo number_format($cola=$rowscola->benefit_amount,2);
...
echo number_format($hse=$rowshse->benefit_amount,2);
...
echo number_format($cloth=$rowscloth->benefit_amount,2);
...
echo number_format($deduction_amount=$rowssic->deduction_amount,2);
...
echo number_format($comp_sic=$comp_sic_rate,2);
