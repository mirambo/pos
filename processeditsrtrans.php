...
$sql1= "update sales_returns_items set item_id='$prod',description='$description',
quantity='$qnty',vendor_prc='$vend_price' where sales_returns_items_id='$id'";
...
$sqlauditsav= "insert into audit_trail values('','$user_id',NOW(),'Updates Sales Returns Items Transactions')";
