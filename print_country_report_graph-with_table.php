...
<link href="FusionCharts/Code/assets/ui/css/style_graph.css" rel="stylesheet" type="text/css" />
...
INNER JOIN nrc_sub_project ON nrc_sub_project.sub_project_id=nrc_set_template.sub_project_id
INNER JOIN nrc_project ON nrc_project.project_id=nrc_set_template.project_id
WHERE nrc_set_template.country_id=$country_id AND nrc_set_template.cc_id=$cc_id and nrc_project.status=1  GROUP BY nrc_sub_project.sub_project_id  ORDER BY nrc_sub_project.sub_project_id
";
$resultssp=mysql_query($sqlsp) or die ("Error $sqlsp.".mysql_error());
...
<td width="300">
<table height="20" >
<tr><td style="padding:0px;" bgcolor="#ff5800" height="20" width="<?php 
...
?>">
<table height="20">
<tr><td bgcolor="#009900" height="20" width="<?php echo $ttl_achieved ?>"></td></tr>
...
?>px; height:30px; background:#ff5800">

<div style="width:<?php echo $ttl_achieved;?>px; height:30px; background:#009900"><?php echo $ttl_achieved; ?></div>


</div>-->
<span style="float:right;"><?php echo $ttl_achieved; ?> of <?php echo $real_target;?></span>
</td>
