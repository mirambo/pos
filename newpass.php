...
<form name="new_supplier" action="processnewpass.php" method="post">			
...
echo '<div align="center" style="background: #FFCC33; height:25px; width:600px; border:#FF0000 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#FF0000" >Congradutations !! Password has been changed successfully!!</font></strong></p></div>';
?></td>
    </tr>
  <tr height="20">
    <td bgcolor="">&nbsp;</td>
    <td width="19%">Enter Old Password<font color="#FF0000">*</font></td>
    <td width="23%"><input type="password" size="41" name="oldpass"></td>
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("oldpass","req",">>Please enter old password");
