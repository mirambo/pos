...
$sqlqt="SELECT * FROM requisition where requisition_id='$order_code'";
...
$task_totals=0;
$consumable=0;
$sqlts="SELECT * from requisition_item where requisition_id='$order_code'";
...
if (mysql_num_rows($resultsts) > 0)
						  ...
						  {
						  $task_cost=$rowsts->item_value;
						  $qnty=$rowsts->item_quantity;
