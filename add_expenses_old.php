...
<form name="gen_order" action="processaddexp.php" method="post">			
...
?></td>
 <!--<input type="hidden" name="supplier_id" size="20" value="<?php echo $rowstemp->supplier_id; ?>">
    ...
    <td colspan="9" >Select Payment Date:<input type="text" name="date_paid" size="40" id="date_paid" value="<?php echo date('Y-m-d'); ?>" readonly="readonly" /></td>
	</tr>
  ...
  <tr height="20" bgcolor="#C0D7E5">
    ...
    <td width="15%" valign="top" colspan="2" align="right">
	
	Expense Account
<select name="exp_cat_id" style="width:100px;">
	<option value="0">Select...........</option>
								  ...
								  </select><a rel="facebox" href="new_exp_account.php">New</a>
...
if (mysql_num_rows($resultsmop) > 0)
{
  ...
  <tr><td colspan="8" height="20" bgcolor="#FFFFCC" align="center"><strong>Cheque Payment Details(If paid via cheque )</strong></td></tr>
    ...
    <td valign="top">Cheque No:<font color="#FF0000"></font></td>
    <td valign="top"><input type="text" name="cheque_no" size="20" /></td>
							   <td valign="top" colspan="2">Check Issuer<font color="#FF0000"></font>
							<select name="our_bank1" style="width:100px;">
...
if (mysql_num_rows($resultsbnk) > 0)
{
						while ($rowsbnk=mysql_fetch_object($resultsbnk))
							{						
                               ...
                               </select> Client Bank<input type="text" name="client_bank1" size="15" /></td>
							   <td valign="top">Date Drawn</td>
							    <td><input type="text" name="date_drawn" value="<?php echo date('Y-m-d'); ?>" size="40" id="date_drawn" readonly="readonly" /><input name="DateFormats" id="DateFormats" disabled value="dd/mm/yyyy" type="hidden"></td>
...
<tr><td colspan="8" height="20" bgcolor="#FFFFCC" align="center"><strong>Bank Transfer Payment Details(If paid via bank transfer )</strong></td></tr>
    ...
    <td valign="top"><input type="text" name="transaction_code" size="20" /></td>
							   ...
							   <td valign="top">Date Transfered</td>
							    <td><input type="text" name="date_trans" size="40" id="date_trans" value="<?php echo date('Y-m-d'); ?>" readonly="readonly" /><input name="DateFormats" id="DateFormats" disabled value="dd/mm/yyyy" type="hidden"></td>
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("exp_cat_id","dontselect=0",">>Please select account category");
 ...
 frmvalidator.addValidation("curr_rate","req",">>Please enter exchange rate to Kshs");
 frmvalidator.addValidation("mop","dontselect=0",">>Please select mode of payment");
 //frmvalidator.addValidation("desc","req",">>Please enter expense description");
