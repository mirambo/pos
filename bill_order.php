...
$rowscont=mysql_fetch_object($resultscont);
  ...
  <tr height="30">
    <td colspan="11" bgcolor="#000033" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">RECEIVE ITEM WITH BILL</span></td>
  </tr>
  
  
   <tr height="30">
    <td colspan="6"  align="left"><strong>BILL ORDER NO :  <?php 
	echo $lpo_no;
...
echo $rowsrec->comments;
  ...
  <tr>
    <td colspan="8" align="right"><strong><em>Generated by :
          <?php 
$sqluser="select * FROM users WHERE user_id='$get_user_id'";
