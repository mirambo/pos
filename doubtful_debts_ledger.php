...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
	...
	Doubtful Debts Ledger</strong></font>
	...
	<a href="print_doubtful_ledger.php" target="_blank">Print</a>|<a href="print_doubtful_ledger_word.php">Export to word </a>
...
from doubtful_debts_ledger,currency where doubtful_debts_ledger.currency_code=currency.curr_id order by doubtful_debts_ledger.transaction_id asc";
...
else
{
  ...
  <tr bgcolor="#FFFFCC" height="30" >
    ...
    <td width="500"><div align="center"><strong></strong></td>
	<td width="200"><div align="center"><strong></strong></td>
    <td width="200" ><div align="center"><strong></strong></td>
	 <td width="200" ><div align="right"><strong><font color="#009900"></strong></td>
	<td width="200" ><div align="center"><strong></strong></td>
	<td width="200" ><div align="center"><strong></strong></td>
    ...
    <td width="500"><div align="center"><strong></strong></td>
	<td width="200"><div align="center"><strong></strong></td>
    <td width="200" ><div align="center"><strong>Ledger Balance</strong></td>
	 <td width="200" ><div align="right"><strong><font color="#009900"></strong></td>
	<td width="200" ><div align="center"><strong><font color="#0000ff"><?php echo number_format($balance=$grnd_amount_in_kshs-$grnd_amount_out_kshs,2); ?></strong></td>
	<td width="200" ><div align="center"><strong></strong></td>
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
    ...
    <td colspan="9" height="30" align="right"><font size="+1">
	<a href="print_doubtful_ledger.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to; ?>" target="_blank">Print</a> | <a href="print_doubtful_ledger_word.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to; ?>">Export to word </a>
    ...
    <td colspan="9" align="center"><strong>Period from <font color="#ff0000"><?php echo $date_from; ?></font> To <font color="#ff0000"> <?php echo $date_to; ?></font></strong></td>
    </tr>
  <tr  style="background:url(images/description.gif);" height="30" >
    <td  width="200"><div align="center"><strong>Transaction Date</strong></td>
    <td width="500"><div align="center"><strong>Transaction Details</strong></td>
...
<?php 
$sqlbbd="select  doubtful_debts_ledger.transaction_id,doubtful_debts_ledger.transactions,doubtful_debts_ledger.debit,doubtful_debts_ledger.credit,doubtful_debts_ledger.currency_code,doubtful_debts_ledger.curr_rate,doubtful_debts_ledger.date_recorded, currency.curr_name 
from doubtful_debts_ledger,currency where doubtful_debts_ledger.currency_code=currency.curr_id AND date_recorded <'$date_from' order by doubtful_debts_ledger.transaction_id asc";
...
$amount_out_kshs=0;
 $grnd_amount_in_kshs=0;
$grnd_amount_out_kshs=0; 
$sql="select  doubtful_debts_ledger.transaction_id,doubtful_debts_ledger.transactions,doubtful_debts_ledger.debit,doubtful_debts_ledger.credit,doubtful_debts_ledger.currency_code,doubtful_debts_ledger.curr_rate,doubtful_debts_ledger.date_recorded, currency.curr_name 
from doubtful_debts_ledger,currency where doubtful_debts_ledger.currency_code=currency.curr_id AND date_recorded BETWEEN '$date_from' AND '$date_to' order by doubtful_debts_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
else
{
  ...
  <tr bgcolor="#FFFFCC" height="30" >
	...
	<td width="200"><div align="center"><strong></strong></td>
    <td width="200" ><div align="center"><strong></strong></td>
	 <td width="200" ><div align="right"><strong><font color="#009900"><?php echo number_format($grnd_amount_in_kshs/2,2); ?></strong></td>
	<td width="200" ><div align="center"><strong></strong></td>
	<td width="200" ><div align="right"><strong><font color="#ff0000"><?php echo number_format($grnd_amount_out_kshs/2,2); ?></strong></td>
    ...
    <td width="200" ><div align="center"><strong>Ledger Balance</strong></td>
	 <td width="200" ><div align="right"><strong><font color="#009900"></strong></td>
	<td width="200" ><div align="center"><strong><font color="#0000ff"><?php echo number_format($balance=$grnd_amount_in_kshs-$grnd_amount_out_kshs,2); ?></strong></td>
	<td width="200" ><div align="right"><strong><font color="#ff0000"></strong></td>
...
<table width="100%" border="0">
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
    ...
    <td width="500"><div align="center"><strong>Transaction Details</strong></td>
	<td width="200"><div align="center"><strong>Exchange Rate</strong></td>
    <td width="200" ><div align="center"><strong>Debit (Other Currency)</strong></td>
	 <td width="200" ><div align="center"><strong>Debit (Kshs)</strong></td>
	<td width="200" ><div align="center"><strong>Credit (Other Currency)</strong></td>
	<td width="200" ><div align="center"><strong>Credit (Kshs)</strong></td>
...
{
echo $rows->curr_name.' '.number_format($amount_in,2);
}
...
{
echo $rows->curr_name.' '.number_format($amount_out,2);
}
