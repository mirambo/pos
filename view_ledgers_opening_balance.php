...
<body>
	...
	<?php require_once('includes/client_opening_balance_submenu.php');  ?>
		...
		<h3>::Accounts Ledger Opening Balance</h3>
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
	...
	Accounts Ledgers Opening Balance</strong></font>
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
    ...
    <td width="500"><div align="center"><strong>Accounts Ledger Name</strong></td>
