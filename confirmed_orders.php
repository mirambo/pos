...
$supplier=$_POST['supplier'];
	...
	<a href="print_lpos.php?supplier=<?php echo $supplier;?>&date_from=<?php echo $date_from;  ?>&date_to=<?php echo $date_to ?>" title="Export To Word"><img src="images/word.png" style="margin-right:30px;"/> </a>
