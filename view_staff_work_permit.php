...
<form name="emp" id="emp" action="processeditworkpermit.php?emp_id=<?php echo $emp_id; ?>" method="post">			
...
$sql="SELECT * FROM staff_work_permit WHERE emp_id='$emp_id'";
...
$rows=mysql_fetch_object($results);
	...
	<td colspan="4" ><h3>Personal Certification - Work Permit Details for (<?php 
...
echo $rowslatelpo->emp_fname.' '.$rowslatelpo->emp_mname.' '.$rowslatelpo->emp_lname;
  ...
  <tr height="20">
    ...
    <td width="15%">Work Permit Number<font color="#FF0000">*</font></td>
    <td bgcolor="" width="20%"><input type="text" size="41" name="work_permit_no" value="<?php echo $rows->work_permit_no;?>"></td>
  ...
  <tr height="20">
    ...
    <td><textarea name="work_permit_remarks" rows="5" cols="35"><?php echo $rows->work_permit_remarks;?></textarea>
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("work_permit_no","req",">>Please select visa type");
