...
$sql="select * from nrc_sub_project where sub_project_id='$sub_project_id'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
$rows=mysql_fetch_object($results);


?>
<form name="new_machine_category" action="process_edit_set_template_sub_project.php" method="post">			
...
?></td>
  ...
  <tr style="background:url(images/description.gif);" height="20" align="center">
	<td width="100">Select Sub Project</td>
...
<option value="<?php echo $sub_project_id ?>"><?php echo $rows->sub_project_code.' - '.$rows->sub_project_name?></option>	
