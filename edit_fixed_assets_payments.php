...
$id=$_GET['fixed_asset_repayment_id'];
		$sql=" select fixed_assets.fixed_asset_name,fixed_assets.description,mop.mop_name,fixed_assets_payments.amount_received,
		fixed_assets_payments.receipt_no,fixed_assets_payments.decription,fixed_assets_payments.fixed_asset_repayment_id ,
		fixed_assets_payments.mop,fixed_assets_payments.ref_no,fixed_assets_payments.cheque_no,fixed_assets_payments.client_bank,
fixed_assets_payments.our_bank,fixed_assets_payments.date_paid,fixed_assets_payments.receipt_no,fixed_assets_payments.date_received,fixed_assets_payments.status,currency.curr_name,
fixed_assets_payments.currency_code,fixed_assets_payments.curr_rate,fixed_assets_payments.amount_received FROM fixed_assets,mop,fixed_assets_payments,currency where 
fixed_assets_payments.mop=mop.mop_id AND fixed_assets.fixed_asset_id=fixed_assets_payments.fixed_asset_id AND fixed_assets_payments.currency_code=currency.curr_id AND fixed_assets_payments.fixed_asset_repayment_id='$id'";
...
<?php require_once('includes/fixedassetsubmenu.php');  ?>
		...
		<h3>:: Update Fixed Asset Payments Details</h3>
...
<form name="gen_order" action="processedit_fixed_payments.php?fixed_assets_payments_id=<?php echo $id;?>" method="post">			
...
if (mysql_num_rows($resultsmop) > 0)
{
  ...
  <tr><td colspan="8" height="20" bgcolor="#FFFFCC" align="center"><strong>Cheque Payment Details(If paid via cheque )</strong></td></tr>
    ...
    <td valign="top"><input type="text" name="cheque_no" size="20" value="<?php echo $rows->cheque_no;?>"/></td>
