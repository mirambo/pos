...
$invoice_payment_id=$_GET['customer_refund_id'];
$sql="select * FROM mop,customer_refund,currency where 
customer_refund.mop=mop.mop_id AND customer_refund.currency_code=currency.curr_id AND customer_refund_id='$invoice_payment_id'";
...
$exp_cat_id=$rows->client_id;
$queryprod="select * from customer where customer_id='$exp_cat_id'";
$resultsprod=mysql_query($queryprod) or die ("Error: $queryprod.".mysql_error());
$rowsprod=mysql_fetch_object($resultsprod); 
$exp_cat_name=$rowsprod->customer_name;
...
<?php require_once('includes/customer_refund_submenu.php');  ?>
		...
		<h3>:: Update Customer Refund Details</h3>
...
<form name="gen_order" action="processedit_customer_refund.php?invoice_payment_id=<?php echo $invoice_payment_id;?>" method="post">			
...
<select name="exp_cat_id" style="width:100px;">
	<option value="<?php echo $exp_cat_id ?>"><?php echo $exp_cat_name; ?></option>
								  ...
								  
								  {
                                    ...
                                    <option value="<?php echo $rows1->exp_cat_id; ?>"><?php echo $rows1->customer_name;?> </option>
