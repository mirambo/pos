...
$sql="SELECT * from released_item,items where released_item.item_id=items.item_id AND released_item.released_item_id='$invoice_item_id'";
...
?>
<form name="new_machine_category" action="process_edit_invoice_item.php" method="post">			
...
?></td>
  ...
  <tr style="background:url(images/description.gif);" height="20" >
	...
	<td width="100"><strong><input type="text" name="item_quantity" value="<?php echo $rows->released_quantity;?>" size="50"></strong></td>
