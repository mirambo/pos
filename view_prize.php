...
<form name="emp" id="emp" action="processeditprize.php?emp_id=<?php echo $emp_id; ?>" method="post">			
...
$sql="SELECT * FROM prize WHERE emp_id='$emp_id'";
...
echo $rowslatelpo->emp_fname.' '.$rowslatelpo->emp_mname.' '.$rowslatelpo->emp_lname;
    ...
    <td><textarea name="prize" rows="8" cols="55"><?php echo $rows->prize_description;?></textarea>
