...
and purchases_debit_journal_code.currency=currency.curr_id AND purchases_debit_journal_code.journal_type='DRT'
...
<td align="right"><strong><?php echo number_format($ttl_cred_vat,2); ?></strong></td>
	...
	<td align="center"><a href="home.php?purchases_debit_journal&id=<?php echo $journal_code_id; ?>"><img src="images/edit.png"></a></td>
