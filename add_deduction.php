...
<form name="new_machine_category" action="processadddeduction.php?approve=<?php echo $approve ?>" method="post">			
...
?></td>
 ...
 <!-- <tr height="30">
  ...
  <tr height="30">
    <td>&nbsp;</td>
    <td>Enter Deduction Name<font color="#FF0000">*</font>
	<input type="text" size="41" name="deduction_name">
	</td>
<tr height="30">
    <td>&nbsp;</td>
    <td width="23%">Enter Deduction Amount<input type="text" size="41" name="deduction_amount"></td>
	</tr>
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("deduction_name","req",">>Please enter deduction name");
