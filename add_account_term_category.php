...
<form name="new_user_group" action="processaddminorterminology.php" method="post">			
...
?></td>
  ...
  <tr>
    ...
    <td width="23%"><select name="major_term"><option>-------------------Select-----------------</option>
								  <?php
  ...
  <tr height="40">
    ...
    <td><input type="text" name="minor_term" size="30"></td>
    </tr>
