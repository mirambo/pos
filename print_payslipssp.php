...
$sqllpdet="select * from payrol_basic_log where emp_id='$id' AND payment_month='$current_month' order by payrol_basic_log_id desc limit 1";
...
<table width="100%" style="border:0px;" class="table">
	<tr><td>Basic Salary</td><td align="right"><?php echo number_format($rowslpdet->basic_pay*$curr_rate,2);
	$ttl_bas_pay=$rowslpdet->basic_pay;?></td></tr>
	<tr><td>Gross Pay</td><td align="right"><?php echo number_format($gross_pay=$rowslpdet->gross_pay*$curr_rate,2);
	...
	<tr><td>Overtime Amount(Weekdays)-(<?php echo $rowslpdet->overtime1; ?> Hrs)</td><td align="right"><?php echo number_format($overtime_amnt1=$rowslpdet->overtime_amnt1*$curr_rate,2);
	
	//$ttl_com=$rowslpdet->comm_pay;
	
	?></td></tr>
	<tr><td>Overtime Amount(Weekends)-(<?php echo $rowslpdet->overtime2; ?> Hrs)</td><td align="right"><?php echo number_format($overtime_amnt2=$rowslpdet->overtime_amnt2*$curr_rate,2);
...
$ttl_ben=0;
$sqlben="select benefit_log.benefit_amount,benefit_log.banefit_name,payrol_basic_log.payment_month 
from benefit_log,payrol_basic_log where payrol_basic_log.payrol_basic_log_id=benefit_log.payrol_basic_log_id AND payrol_basic_log.emp_id='$id' AND payrol_basic_log.payment_month='$current_month' ";
...
?>
	...
	<tr><td><?php echo $rowsben->banefit_name;?></td><td align="right">
	<?php echo number_format($ttl_ben=$rowsben->benefit_amount*$curr_rate,2);?></td></tr>
	<?php
...
?>
	...
	<tr><td>P.I.T (Personal Income Tax)</td><td align="right"><?php echo number_format($ttl_tax=$rowslpdet->tax*$curr_rate,2); ?></td></tr>
	<tr><td>Company S.I.C Contribution</td><td align="right"><?php echo number_format($comp_sic_rate=$rowslpdet->comp_sic_rate*$curr_rate,2); ?></td></tr>
	<tr><td>Personal S.I.C Contribution</td><td align="right">
	
	<?php 
  
$ttl_ded=0;
$sqlded="select deduction_logs.deduction_amount,payrol_basic_log.payment_month from deduction_logs,payrol_basic_log 
where payrol_basic_log.payrol_basic_log_id=deduction_logs.payrol_basic_log_id AND deduction_logs.emp_id='$id' AND payrol_basic_log.payment_month='$current_month'";
...
?>
	...
	<?php number_format($ttl_ded=$rowsded->deduction_amount*$curr_rate,2);
	
	
echo number_format($grnd_ded=$grnd_ded+$ttl_ded,2);
}
...
?>
	...
	<?php number_format($all_dedall=$rowsdedall->deduction_amount*$curr_rate,2);
...
?>
	...
	<?php number_format($all_dedallcomp=$rowsdedallcomp->comp_sic_rate*$curr_rate,2);
...
<td align="center"><strong>Gross Salary</strong></td></td>
	<td align="right"><strong><?php echo number_format($gross_salary=$gross_pay+$overtime_amnt1+$overtime_amnt2+$otherpayment+$grnd_ben,2);?></strong></td>
