...
$query1_p="select * from suppliers where supplier_id='$supplier_id'";
$results1_p=mysql_query($query1_p) or die ("Error: $query1_p.".mysql_error());
$rows1_p=mysql_fetch_object($results1_p);
$supp_name=$rows1_p->supplier_name;
...
$transaction_desc='Purchase Credit Journal Entry for <a href="home.php?purchases_credit_journal&id='.$journal_code_id.'">supplier '.$supp_name.', '.$trans_desc.' Ref No : '.$ref_no.'</a>';
...
$dr_transaction_code='pc-dr-jnl-dr'.$journal_transaction_id_dr;

$sqltransd="INSERT INTO chart_transactions SET 
account_type_id='$debit_account_id',
transaction_section='PCRJNTR',
...
$cr_transaction_code='pc-dr-jnl-cr'.$journal_transaction_id_cr;
...
$transaction_code2='sup-cred-jnr'.$journal_transaction_id_cr;
//$memo2=$transaction2;
...
alert('Record Saved Successfuly. Posting No : <?php echo $journal_code_id; ?>');
window.location = "home.php?view_purchases_credit_journal&sub_module_id=<?php echo $sub_module_id; ?>";
...
$transaction_desc='Purchase Credit Journal Entry for <a href="home.php?purchases_credit_journal&id='.$id.'">supplier '.$supp_name.', '.$trans_desc.' Ref No : '.$ref_no.'</a>';
...
currency='$currency',
curr_rate='$curr_rate',
transaction_date='$date_from' WHERE transaction_code='$transaction_code2'";
$resultstransc=mysql_query($sqltransc) or die ("Error $sqltransc.".mysql_error());
...
$resultstransc=mysql_query($sqltransc) or die ("Error $sqltransc.".mysql_error());
	...
	?>
<script type="text/javascript">
alert('Record Updated Successfuly. Posting No : <?php echo $id; ?>');
window.location = "home.php?view_purchases_credit_journal&sub_module_id=<?php echo $sub_module_id; ?>";
//window.location = "add_expenses.php?sales_id=<?php echo $expense_code_id ?>";
</script>
