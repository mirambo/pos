...
$sql= "delete from cheque_withdrawals where cheque_withdrawal_id='$id'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());

$sql= "delete from bank_statement where sales_code='chqwd$id'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());

$sql= "delete from bank_ledger where sales_code='chqwd$id'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());

$sql= "delete from cash_ledger where sales_code='chqwd$id'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
$sqlauditsav= "insert into audit_trail values('','$user_id',NOW(),'Deleted a cheque withdrawal record from the system')";
$resultsauditsav= mysql_query($sqlauditsav) or die ("Error $sqlauditsav.".mysql_error());

header ("Location:view_cheque_withdrawals.php?deleteconfirm=1");
