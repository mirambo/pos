...
<tr bgcolor="#FFFFCC">
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
    <td align="center" width="150"><strong>User Group Name</strong></td>
...
?>
	...
	<td align="center"><a href="home.php?editgroup=editgroup&user_group_id=<?php echo $rows->user_group_id;?>"><img src="images/edit.png"></a></td>
    <td align="center">
	<a href="delete_user_group.php?user_group_id=<?php echo $rows->user_group_id;?>"  onClick="return confirmDelete();"><img src="images/delete.png"></a>
	<?php
