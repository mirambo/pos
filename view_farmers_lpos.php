...
<table width="100%" border="0" align="center" bgcolor="#9AD7AF" class="display nowrap" style="border-radius:5px;" id="example">	
   ...
   <tr style="background:url(images/description.gif);" height="30" >
	...
	<td width="15%"><div align="center"><strong>Farmer Name</strong></td>
...
and order_code_get.supplier_id='$supplier' AND suppliers.sup_type='F' order by order_code_get.order_code_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
...
order_code_get.date_generated BETWEEN '$date_from' AND '$date_to' AND suppliers.sup_type='F' order by order_code_get.order_code_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
{
$sql="select * FROM mop,currency,suppliers,order_code_get WHERE order_code_get.mop_id=mop.mop_id AND 
order_code_get.currency=currency.curr_id AND order_code_get.supplier_id=suppliers.supplier_id and order_code_get.status='2' AND order_code_get.date_generated BETWEEN '$date_from' AND '$date_to' AND suppliers.sup_type='F' AND order_code_get.supplier_id='$supplier' order by order_code_get.order_code_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
{
$sql="select * FROM mop,currency,suppliers,order_code_get WHERE order_code_get.mop_id=mop.mop_id AND 
order_code_get.currency=currency.curr_id AND order_code_get.supplier_id=suppliers.supplier_id AND suppliers.sup_type='F' and order_code_get.status='2' 
order by order_code_get.order_code_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
