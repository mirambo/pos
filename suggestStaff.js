...
function searchSuggest() {
	if (searchReq.readyState == 4 || searchReq.readyState == 0) {
		...
		searchReq.open("GET", 'searchTemplate.php?search=' + str, true);
...
function handleSearchSuggest() {
	if (searchReq.readyState == 4) {
		...
		if(str.length==1)
		    ...
		    ss.setAttribute('style','position:absolute;top:'+curTop+';left:'+curLeft+';width:auto;z-index:1;padding:5px;border: 1px solid #000000; overflow:auto; height:105; margin-left:550px; background-color:#FFFFCC;');
		ss.innerHTML = '';
