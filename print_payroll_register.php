...
<tr height="40"> <td colspan="16" align="center"><H2>LONG TERM VIEW CAPITAL LTD</H2></td></tr>
<tr bgcolor="#FFFFCC">
...
$sql="select * FROM payroll,employees WHERE payroll.emp_id=employees.emp_id and payroll.payment_month='$date_month' order by employees.emp_firstname asc";
