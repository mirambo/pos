...
if (isset($_POST['assign_project_location']))
{
...
echo '<div align="center" style="background: #FFCC33; height:20px; width:600px; border:#FF0000 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#FF0000" >Sorry!! Some Locations have been allocated to this projects</font></strong></p></div>';
?></td>
    </tr>
...
echo "<font color='#ff0000'>".$rowspr->project_name."</font> ";
 ?>
In Areas (s) :  <?php 
$sqlcn="SELECT * FROM nrc_project,nrc_area,nrc_projectvsarea where nrc_projectvsarea.area_id=nrc_area.area_id 
AND nrc_projectvsarea.project_id=nrc_project.project_id AND nrc_projectvsarea.alloc_id='$latest_alloc_id' group by nrc_area.area_id ";
...
echo '<tr bgcolor="#FFFFCC" height="10" >';
    ...
    <td align="center" colspan="3"><input type="submit" name="submit" value="Proceed To Assigning Project To Settlement>>"><input type="hidden" name="assign_project_location" id="assign_project_location" value="1">&nbsp;&nbsp;</td>
