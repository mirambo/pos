              ...
              <table width='100%' border='0' cellpadding='3' cellspacing='0' bordercolorlight="#FFFFFF" bordercolordark="#123B95">
                      <tr>
					   <td width="17%" height="29" bgcolor='#eeeeee' class="ewTableHighlightRow">Sub Project Code</td>
                        ...
                        <td height="29" colspan="2" bgcolor='#eeeeee' class="ewTableHighlightRow">Progress Summary</td>
                </tr>
                <?
...
$i = '0';
                ...
                <tr bordercolor='#FFFFFF' bgcolor='<? echo $bgcolor;?>'> 
                  <td><span class="style3"><?php echo $sub_project_code;?></span>&nbsp;</td>
...
while($rr=mysql_fetch_array($ss))
{
	...
	echo $total;
                 ...
                 <?php 
				   $ss=@mysql_query("Select *  from update_indicator where Indicator_ID='$Indicator_ID'");
while($rr=mysql_fetch_array($ss))
{
	$totals=$rr['total'];
	...
	//echo $total;
                ...
                <tr bordercolor='#FFFFFF' bgcolor='#f5f8f7'> 
                  <td colspan='5' align='center'>Total Records:<?php echo $count?> </td>
                </tr>
              </table>
              </form>
            <span class="style3"><a href="javascript:window.print()">Print</a>... </span><?php
