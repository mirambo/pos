...
<form name="start_order" action="process_exit_shareholder.php?shares_id=<?php echo $shares_id; ?>" method="post">			
...
?></td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td valign="top" width="15%">Enter Reason for Exit</td>
    <td><textarea name="reasons" cols="40" rows="5"></textarea></td>
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.EnableMsgsTogether();
  ...
  frmvalidator.addValidation("reason","req",">>Please enter reason for exit");
