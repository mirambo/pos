...
<form name="new_machine_category" action="processaddloan.php" method="post">			
...
echo '<div align="center" style="background: #FFCC33; height:20px; width:600px; border:#339900 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#339900" >Loan Type Added Successfully!!</font></strong></p></div>';
?>
...
?></td>
  ...
  <tr height="30">
    ...
    <td width="23%"><input type="text" size="41" name="loan_type"></td>
  ...
  <tr height="30">
    ...
    <td width="23%"><input type="text" size="41" name="loan_amount"></td>
