...
<input type="submit" name="generate" value="Generate">								  
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
   ...
   <td align="center" width="50"><strong>Ref No</strong></td>
    ...
    <td align="center" width="150"><strong>Comment</strong></td>
...
echo $rowst->f_name;
  ...
  <td align="center"><a href="create_requisition.php?order_code=<?php echo $rows->requisition_id; ?>">View Requisition Details</a></td>
