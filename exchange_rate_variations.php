...
<body>
	...
	<?php require_once('includes/ledgerssubmenu.php');  ?>
		...
		<h3>::Exchange Rate Variations Legder</h3>
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
	...
	Exchange Rate Variations Legder</strong></font>
...
$sql="select  exchange_rate_variation_ledger.transaction_id,exchange_rate_variation_ledger.transactions,exchange_rate_variation_ledger.amount,exchange_rate_variation_ledger.debit,exchange_rate_variation_ledger.credit,exchange_rate_variation_ledger.currency_code,exchange_rate_variation_ledger.curr_rate,exchange_rate_variation_ledger.date_recorded, currency.curr_name 
from exchange_rate_variation_ledger,currency where exchange_rate_variation_ledger.currency_code=currency.curr_id order by exchange_rate_variation_ledger.transaction_id asc";
...
else
{
	...
	echo number_format($str2 = substr($amount_out_kshs, 1),2);
	}
...
$grnd_amount_out_kshs=0; 
$sql="select  exchange_rate_variation_ledger.transaction_id,exchange_rate_variation_ledger.transactions,exchange_rate_variation_ledger.amount,exchange_rate_variation_ledger.debit,exchange_rate_variation_ledger.credit,exchange_rate_variation_ledger.currency_code,exchange_rate_variation_ledger.curr_rate,exchange_rate_variation_ledger.date_recorded, currency.curr_name 
from exchange_rate_variation_ledger,currency where exchange_rate_variation_ledger.currency_code=currency.curr_id AND date_recorded BETWEEN '$date_from' AND '$date_to' order by exchange_rate_variation_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
