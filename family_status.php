...
<form name="emp" id="emp" action="processfamilystatus.php?emp_id=<?php echo $emp_id; ?>" method="post">			
...
echo $rowslatelpo->emp_fname.' '.$rowslatelpo->emp_mname.' '.$rowslatelpo->emp_lname;
  ...
  <tr height="20">
    ...
    <td bgcolor="" width="20%"><input type="text" size="41" name="family_address"></td>
    <td width="15%">Zip Code</td>
    <td width="5%"><input type="text" name="zip_code" size="41"  /></td>
    ...
    <td><textarea name="family_members" rows="5" cols="35"></textarea>
