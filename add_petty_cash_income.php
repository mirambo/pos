...
<form name="new_supplier" action="processaddpettyinc.php" method="post">			
...
echo '<div align="center" style="background: #FFCC33; height:20px; width:600px; border:#339900 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#339900" >Petty Cash Income added successfully!!</font></strong></p></div>';
?>
