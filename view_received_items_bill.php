...
<body>
	...
	<?php require_once('includes/invoicessubmenu.php');  ?>
		...
		<h3>::List of All Direct Bill Order</h3>
...
<a target="_blank" style="float:right; margin-right:200px; font-weight:bold; font-size:13px; color:#000000" href="print_list_direct_bill.php">Print</a>						  

<a style="float:right; margin-right:50px; font-weight:bold; font-size:13px; color:#000000" href="print_list_direct_bill_excel.php">Export To Excel</a>						  
   ...
   <tr style="background:url(images/description.gif);" height="30" >
    <td width="200"><div align="center"><strong>Order Number</strong></td>
    <td width="300"><div align="center"><strong>Date Generated</strong></td>
    <td width="300"><div align="center"><strong>Shop</strong></td>
...
AND order_code_get.supplier_id=suppliers.supplier_id and order_code_get.status='2' AND mop_id='dr' order by date_generated desc";
...
$querydc="select * FROM currency,suppliers,order_code_get WHERE order_code_get.currency=currency.curr_id 
AND order_code_get.supplier_id=suppliers.supplier_id and order_code_get.status='2' AND order_code_get.shop_id='$incharge' AND mop_id='dr' order by date_generated desc";
$resultsdc= mysql_query($querydc) or die ("Error $querydc.".mysql_error());
}
else
{
...
echo number_format($lpo_ttl=$rowsspm->amount,2); */
	...
	?></strong></td>
	<td align="center"><a href="begin_invoice.php?order_code=<?php echo $rows->order_code_id;?>">View Transactions</a></td>
	 <td align="center"><?php
