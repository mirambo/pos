...
<body>
	...
	<?php require_once('includes/invoice_payment_submenu.php');  ?>
		...
		<h3>::List of All Invoice Payments Recorded</h3>
...
<strong>Or By Mode Of Payment</strong>	
...
?>
  <td width="10%"><div align="center"><strong>Edit</strong></td>
   ...
   <td width="10%"><div align="center"><strong>Cancel</strong></td>
...
$queryop="select * FROM customer,mop,invoice_payments,currency where invoice_payments.mop=mop.mop_id and invoice_payments.customer_id=customer.customer_id and  invoice_payments.currency_code=currency.curr_id  ORDER BY invoice_payments.date_received desc ";
...
$queryop= "select * FROM customer,mop,invoice_payments,currency";
    $conditions = array();
...
$queryop .= " WHERE " . implode(' AND ', $conditions)." AND invoice_payments.mop=mop.mop_id and invoice_payments.customer_id=customer.customer_id and  
invoice_payments.currency_code=currency.curr_id ORDER BY invoice_payments.date_received desc";
...
$queryop="select * FROM customer,mop,invoice_payments,currency where invoice_payments.mop=mop.mop_id and invoice_payments.customer_id=customer.customer_id and  
invoice_payments.currency_code=currency.curr_id and invoice_payments.date_paid>='$start' and invoice_payments.date_paid<='$kesho' ORDER BY invoice_payments.date_received desc ";
$results= mysql_query($queryop) or die ("Error $queryop.".mysql_error());
...
$invoice_id=$rows->sales_id;
$sql34="select * FROM sales where sales_id='$invoice_id'";
$results34= mysql_query($sql34) or die ("Error $sql34.".mysql_error());
$rows34=mysql_fetch_object($results34);
$invoice_no=$rows34->invoice_no;
...
echo $date_received=$rows->date_paid; 
	...
	<td><a style="font-weight:bold; color:#000;" href="generate_invoice.php?sales_id=<?php echo $rows->sales_id;?>">
	
	<?php echo $invoice_no;?></a></td>
	<td>
...
<?php
	 ...
	 <?php echo number_format($curr_rate*$invoice_ttl,2); ?>
...
?>
	...
	<td align="center"><a href="receive_client_payment.php?invoice_payment_id=<?php echo $rows->invoice_payment_id; ?>"><img src="images/edit.png"></a></td>
