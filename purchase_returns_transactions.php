...
stock_returns.date_returned,stock_returns.currency,stock_returns.order_code,currency.curr_name from currency,products,stock_returns,suppliers
where stock_returns.currency=currency.curr_id and stock_returns.supplier_id=suppliers.supplier_id and stock_returns.product_id=products.product_id and stock_returns.stockreturn_code='$stockreturn_code'";
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>
	...
	<td align="right"><?php echo $rows->curr_name.' '. number_format($vendor_price=$rows->vendor_price,2);?></td>
	<td align="right"><?php echo $rows->curr_name.' '.number_format($stock_returns=$quant*$vendor_price,2);?></td>
	<td align="right">
	<?php
