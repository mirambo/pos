...
<form name="pack_size" action="processaddpacksize.php?start=<?php echo $start; ?>" method="post">			
...
echo '<div align="center" style="background: #FFCC33; height:20px; width:600px; border:#339900 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#339900" >Pack Size Created Successfully!!</font></strong></p></div>';
?>
...
?></td>
  ...
  <tr>
    <td bgcolor="">&nbsp;</td>
    <td width="19%">Enter Pack Size Unit <font color="#FF0000">*</font></td>
    <td width="23%"><input type="text" size="41" name="pack_size"></td>
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("pack_size","req",">>Please enter pack size");
