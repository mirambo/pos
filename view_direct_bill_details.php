...
<script src="js/application.js" type="text/javascript" charset="utf-8"></script>
	...
	<h3 align="center">View Direct Bill Details
	...
	?>
	<a style="float:right; margin-right:200px;" target="_blank" href="bill_order.php?order_code=<?php echo $order_code; ?>">
	...
	<a style="float:right; margin-right:50px;" href="bill_order_excel.php?order_code=<?php echo $order_code; ?>">
...
Bill Order Number : </strong><i><?php echo $lpo_no;  ?></i>
<strong>Supplier : </strong><i><?php echo $supplier_name;  ?></i>
	
	
	
	<strong>Order Date :</strong><i><?php echo $order_date=$rowsrec->date_generated;  ?></i>
	
	<strong>Currency: </strong><i><?php echo $curr_name;  ?></i>
	<strong>Exchange Rate: </strong><i><?php echo $curr_rate;  ?></i>
	<br/>
	<br/>
	...
	<a rel="facebox" href="edit_direct_bill_code.php?order_code=<?php echo $order_code;?>"><img src="images/edit.png"> </a>
...
<tr bgcolor="#2E3192"><td colspan="2"  align="center"><img src="images/task_icon.png" align="left" width="20" height="20"><strong><font color="#ffffff">View Items Details</font></strong><a rel="facebox" style="color:#ffffff;font-weight:bold; float:right;" href="add_bill_item.php?order_code=<?php echo $order_code; ?>">
...
<a title="Creating New Items That doesnt exist" style="color:#009900;font-weight:bold; float:right;" rel="facebox" href="create_new_itembill.php?order_code=<?php echo $order_code ?>"> [ Create New Items ]</a>
</td></tr>
<tr><td>
<table width="100%">
...
?>
	...
	<a rel="facebox" href="edit_bill_trans.php?purchase_order_id=<?php echo $rowslpdet->purchase_order_id; ?>&order_code=<?php echo $order_code; ?>"><img src="images/edit.png"></a>
<?php	
}
else
{
...
<a href="delete_bill_trans.php?order_code=<?php echo $order_code; ?>&purchase_order_id=<?php echo $rowslpdet->purchase_order_id;?>"><img src="images/delete.png" onClick="return confirmDelete();"></a>
...
<strong><font color="#ffffff">Order Value Details</strong></td></tr>
...
$transaction_desc='Direct Order No:'.$lpo_no;
//$transaction_descinv="Freight Charges for Goods Supplied By:".$shipper_name;

$sqlprof="select * from supplier_transactions where order_code='dro$order_code'";
...
$sqlupd="UPDATE supplier_transactions SET supplier_id='$supplier_id',transaction='$transaction_desc', 
amount='$grndttl',currency='$currency',date_recorded='$order_date',
curr_rate='$curr_rate' WHERE order_code='dro$order_code'";
$resultsupd=mysql_query($sqlupd) or die ("Error $sqlupd.".mysql_error());

$sqlupd="UPDATE accounts_payables_ledger SET amount='$grndttl',credit='$grndttl',
currency_code='$currency',
date_recorded='$order_date',
curr_rate='$curr_rate' 
WHERE order_code='dro$order_code'";
$resultsupd=mysql_query($sqlupd) or die ("Error $sqlupd.".mysql_error());

/* $sqlupd="UPDATE purchases_ledger SET amount='$grndttl',debit='$grndttl',currency_code='$currency',curr_rate='$curr_rate' WHERE order_code='dro$order_code'";
$resultsupd=mysql_query($sqlupd) or die ("Error $sqlupd.".mysql_error()); */
...
$sqltrans= "insert into supplier_transactions values('','$supplier_id','dro$order_code','$transaction_desc','$currency','$curr_rate','$grndttl','$order_date','$incharge','','')";
$resultstrans=mysql_query($sqltrans) or die ("Error $sqltrans.".mysql_error());

$sqlaccpay="insert into accounts_payables_ledger values('','$transaction_desc','$grndttl','','$grndttl','$currency','$curr_rate','$order_date','dro$order_code','','','$incharge')";
$resultsaccpay=mysql_query($sqlaccpay) or die ("Error $sqlaccpay.".mysql_error());

/* $sqlaccpay="insert into purchases_ledger values('','$transaction_desc','$grndttl','$grndttl','','$currency','$curr_rate',NOW(),'dro$order_code')";
$resultsaccpay=mysql_query($sqlaccpay) or die ("Error $sqlaccpay.".mysql_error()); */
