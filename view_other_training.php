...
<form name="emp" id="emp" action="processeditothertraining.php?emp_id=<?php echo $emp_id; ?>" method="post">			
...
$sql="SELECT * FROM other_training WHERE emp_id='$emp_id'";
...
$rows=mysql_fetch_object($results);	
	...
	<td colspan="4" ><h3>Education Background - Staff Education Background for (<?php 
...
echo $rowslatelpo->emp_fname.' '.$rowslatelpo->emp_mname.' '.$rowslatelpo->emp_lname;
    ...
    <td valign="top" width="15%">Other Training Description<font color="#FF0000">*</font></td>
    <td><textarea name="other_training" rows="8" cols="55"><?php echo $rows->other_training_description;?></textarea>
