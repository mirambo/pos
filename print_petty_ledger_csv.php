...
header("Content-Disposition: attachment;Filename=Petty_Cash_Ledger.xlsx");
header("Expires: 0");
...
$rowscont=mysql_fetch_object($resultscont);*/
  ...
  <tr height="30">
   <td colspan="7" bgcolor="#67C6FE" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">PETTY CASH LEDGER</span>
...
<table width="700" border="0" align="center" class="table">
    ...
    <td width="400"><div align="center"><strong>Amount (Mixed Currency)</strong></td>
  ...
  <?php 
 $bal=0; 
$sql="select  petty_cash_ledger.transaction_id,petty_cash_ledger.transactions,petty_cash_ledger.money_in,petty_cash_ledger.amount,petty_cash_ledger.money_out,petty_cash_ledger.currency,petty_cash_ledger.curr_rate,petty_cash_ledger.date_recorded, currency.curr_initials 
from petty_cash_ledger,currency where petty_cash_ledger.currency=currency.curr_id order by petty_cash_ledger.transaction_id asc";
