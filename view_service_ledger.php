...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
	...
	Service Revenue Ledger</strong></font>
...
<a href="print_service_ledger.php" target="_blank"><img src="images/print_icon.gif" title="Print"></a> &nbsp; 
<a href="print_service_ledger_csv.php"><img src="images/excel.png" title="Export to Excell"></a> &nbsp; 
<a href="print_service_ledger_word.php"><img src="images/word.png" title="Export to Word"></a>
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
    ...
    <td colspan="9" height="30" align="right"><font size="+1">
<a href="print_service_ledger.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to;?>" target="_blank"><img src="images/print_icon.gif" title="Print"></a> &nbsp; 
<a href="print_service_ledger_csv.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to;?>"><img src="images/excel.png" title="Export to Excell"></a> &nbsp; 
<a href="print_service_ledger_word.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to;?>"><img src="images/word.png" title="Export to Word"></a>
