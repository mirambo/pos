...
<form name="new_supplier" action="processeditpostgrad.php?post_grad_scholarship_id=<?php echo $post_grad_scholarship_id; ?>" method="post">			
...
$sql="SELECT * FROM post_grad_scholarship where institution_id='$institution_id' and post_grad_scholarship_id='$post_grad_scholarship_id' order by post_grad_scholarship_id desc";
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("adm_year","dontselect=0",">>Please select admission year");
 frmvalidator.addValidation("comp_year","dontselect=0",">>Please select completion year");  
