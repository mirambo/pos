...
header("Content-Disposition: attachment;Filename=Purchase_Order.xlsx");
header("Expires: 0");
...
<table width="700" border="0" align="center" >
  <tr>
    <td colspan="3" rowspan="7"><img src="http://localhost/brisk_sys/images/logolpo.png" /></td>
    <td colspan="3">&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr height="30">
    <td colspan="6" bgcolor="#000033" align="left"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">Purchase Order</span></td>
  </tr>
  <tr height="20">
    <td colspan="6"  align="left">DATE : <?php echo (Date("l F d, Y")); ?></td>
  </tr>
  
   <tr height="20">
    <td colspan="6"  align="left"><strong>ORDER NO :  <?php 
	$tempnum=$get_latest_lpo_id;
	if($tempnum < 10)
            {
              $newnum = "BD000".$tempnum."/".$year;
			   echo $newnum;
			  
			  
            } else if($tempnum < 100) 
			{
             $newnum = "BD00".$tempnum."/".$year;
			 
			 echo $newnum;
            } else 
			{ 
			$newnum = "BD".$tempnum."/".$year; 
...
<table width="700" border="0" align="center" class="table">
  <tr>
    ...
    <td width="97"><div align="center"><strong>Unit Price (<?php echo $currency; ?>)</strong></div></td>
    <td width="97"><div align="center"><strong>Totals (<?php echo $currency; ?>)</strong></div></td>
  </tr>
...
$sqllpdet="select  temp_purchase_order.quantity, temp_purchase_order.vendor_prc,temp_purchase_order.product_code,temp_purchase_order.ttl,products.product_name, products.pack_size from temp_purchase_order, products where temp_purchase_order.product_id=products.product_id order by temp_purchase_order.purchase_order_id asc";
