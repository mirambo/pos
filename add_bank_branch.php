...
<form name="new_machine_category" action="processaddbranch.php" method="post">			
			<table width="100%" border="0">
  <tr>
    <td width="18%">&nbsp;</td>
	<td colspan="3" height="30"><?php

if ($_GET['addbranchconfirm']==1)
echo '<div align="center" style="background: #FFCC33; height:20px; width:600px; border:#339900 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#339900" >Branch Added Successfully!!</font></strong></p></div>';
?>
...
?></td>
  ...
  <tr height="30">
    <td bgcolor="">&nbsp;</td>
    <td width="19%">Select Bank Name <font color="#FF0000">*</font></td>
    <td width="23%">
	<select name="bank_id"><option>Select Bank........................</option>
								  <?php
  ...
  <tr height="30">
    ...
    <td width="23%"><input type="text" size="41" name="branch"></td>
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("bank_id","dontselect=0",">>Please select bank");
