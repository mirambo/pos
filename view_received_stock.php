...
?>
	...
	<option value="0">-------------------Select-----------------------</option>
								  ...
								  $query1="select * from items_category order by cat_name";
...
$sql="select * from items, received_stock 
where items.item_id=received_stock.product_id and received_stock.order_code_id='$order_code_id' AND received_stock.product_id='$product_id' 
