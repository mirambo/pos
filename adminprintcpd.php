...
<tr height="40"> <td colspan="16" align="center"><H2>Continous Medical Education (CME) / Continous Professional Development (CPD) Record</H2></td></tr>
...
$rowssponsor=mysql_fetch_object($resultsspons);
  ...
  ?>
   ...
   <tr  bgcolor="#FFFFCC" height="30" >
    ...
    <td align="center" width="150" colspan="5" ><strong></strong></td>
