...
elseif ($bal_type=='0')
{*/
$sqltrans= "insert into commisions_expected values('','','$amount','$currency','$curr_rate','','$employee',NOW(),'1')";
$resultstrans=mysql_query($sqltrans) or die ("Error $sqltrans.".mysql_error());

$sqlaccpay= "insert into accounts_payables_ledger values('','Staff Opening Balance','$amount','','$amount','$currency','$curr_rate',NOW(),'$get_latest_order_id')";
...
header ("Location:add_staff_opening_balance.php? addconfirm=1");
