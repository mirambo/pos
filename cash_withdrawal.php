...
<body>
	...
	<?php require_once('includes/banking_submenu.php');  ?>
		...
		<div id="main-content">
			...
			<form name="new_supplier" action="processaddcashwithdrawal.php" method="post">			
...
echo '<div align="center" style="background: #FFCC33; height:20px; width:600px; border:#339900 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#339900" >Cash Withdrawal Recorded Successfully!!</font></strong></p></div>';
?>
...
?></td>
	...
	<tr height="20">
    <td>&nbsp;</td>
    <td>Enter Bank Slip Number<font color="#FF0000">*</font></td>
    <td><input type="text" size="41" name="slip_no" ></td>
...
if (mysql_num_rows($resultscurr) > 0)
{
   ...
   <tr height="20">
    <td>&nbsp;</td>
    <td>Person Withdrew (Name)<font color="#FF0000">*</font></td>
    <td><input type="text" name="person_dep" size="40" /></td>
    </tr>
	<tr height="20">
    <td>&nbsp;</td>
    <td>Person Phone No<font color="#FF0000">*</font></td>
    <td><input type="text" name="phone_no" size="40" /></td>
    </tr>
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("date_deposited","req",">>Please enter date withdrew");
