...
AND farmers_advance_payments.farmers_advance_payment_id='$id'";
...
<script type="text/javascript">
    ...
    $("#parent_cat12rrrrrrrrrrrrr").change(function() {
    ...
    $(this).remove();
	 ...
	 $("#parent_cat12rrrrrrrrrrrr").change(function() {
    //$(this).after('<div id="loader"><img src="loader.gif" alt="loading subcategory" /></div>');
	...
	$("#farmer_id12rrrrrrrrrrr").change(function() {
    //$(this).after('<div id="loader"><img src="loader.gif" alt="loading subcategory" /></div>');
...
<form name="gen_order" action="process_pay_farmer_advance.php?id=<?php echo $id; ?>" method="post">			
...
<option value="<?php echo $account_to_debit; ?>"><?php echo $account_to_debit_name; ?></option>
  ...
  <tr height="20" bgcolor="#C0D7E5">
	...
	Select Farmer<font color="#FF0000"></font>
	<br/>
	<br/>
	...
	<select name="farmer_id" required id="parent_cat12">
		<option value="<?php echo $rows->farmer_id; ?>"><?php echo $rows->farmer_name; ?></option>
    <?php 
