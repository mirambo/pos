...
<body>
	...
	<?php require_once('includes/sharesledgersubmenu.php');  ?>
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
	...
	<a href="print_shares_ledger.php" target="_blank">Print</a>|<a href="print_shares_ledger_word.php">Export to word </a>
...
from shares_ledger,currency where shares_ledger.currency_code=currency.curr_id AND shares_ledger.amount!='' and shares_ledger.amount!='0'  order by shares_ledger.transaction_id asc";
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
    ...
    <td colspan="9" height="30" align="right"><font size="+1">
	<a href="print_shares_ledger.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to; ?>" target="_blank">Print</a> | <a href="print_shares_ledger_word.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to; ?>">Export to word </a>
...
<?php 
$sqlbbd="select  shares_ledger.transaction_id,shares_ledger.transactions,shares_ledger.amount,shares_ledger.debit,shares_ledger.credit,shares_ledger.currency_code,shares_ledger.curr_rate,shares_ledger.date_recorded, currency.curr_name 
from shares_ledger,currency where shares_ledger.currency_code=currency.curr_id AND date_recorded <'$date_from' order by shares_ledger.transaction_id asc";
...
$grnd_amount_out_kshs=0; 
$sql="select  shares_ledger.transaction_id,shares_ledger.transactions,shares_ledger.amount,shares_ledger.debit,shares_ledger.credit,shares_ledger.currency_code,shares_ledger.curr_rate,shares_ledger.date_recorded, currency.curr_name 
from shares_ledger,currency where shares_ledger.currency_code=currency.curr_id AND date_recorded BETWEEN '$date_from' AND '$date_to' order by shares_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
$grnd_amount_out_kshs=0; 
$sql="select  shares_ledger.transaction_id,shares_ledger.transactions,shares_ledger.amount,shares_ledger.debit,shares_ledger.credit,shares_ledger.currency_code,shares_ledger.curr_rate,shares_ledger.date_recorded, currency.curr_name 
from shares_ledger,currency where shares_ledger.currency_code=currency.curr_id order by shares_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
