...
where estimates.booking_id=bookings.booking_id AND customer.customer_id=bookings.customer_id AND estimates.item_id=items.item_id AND estimates.job_card_status='1' GROUP BY estimates.booking_id order by estimates.estimates_date desc";
...
AND estimates.item_id=items.item_id AND bookings.customer_id='$location_id'  AND estimates.job_card_status='1' GROUP BY estimates.booking_id order by estimates.estimates_date desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
customer.customer_name,bookings.reg_no,bookings.booking_date,bookings.vehicle_make,bookings.vehicle_model
 FROM bookings,customer,estimates,items 
where estimates.booking_id=bookings.booking_id AND customer.customer_id=bookings.customer_id 
AND estimates.item_id=items.item_id AND bookings.reg_no LIKE '%$settlement_name%'  AND estimates.job_card_status='1' GROUP BY estimates.booking_id order by estimates.estimates_date desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
...
customer.customer_name,bookings.reg_no,bookings.booking_date,bookings.vehicle_make,bookings.vehicle_model
 FROM bookings,customer,estimates,items 
where estimates.booking_id=bookings.booking_id AND customer.customer_id=bookings.customer_id 
AND estimates.item_id=items.item_id AND bookings.reg_no LIKE '%$settlement_name%' AND bookings.customer_id='$location_id' AND estimates.job_card_status='1' GROUP BY estimates.booking_id order by estimates.estimates_date desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
else
{
...
$sql="SELECT estimates.curr_sp,estimates.item_id,estimates.booking_id,estimates.estimates_date,estimates.estimates_date,estimates.quantity,estimates.discout,SUM(estimates.discount_value) as ttl_disc,
SUM(estimates.vat_value) as ttl_vat,estimates.vat,estimates.estimates_id,estimates.user_id,items.item_name,items.item_code,customer.customer_name,bookings.reg_no,bookings.booking_date,bookings.vehicle_make,bookings.vehicle_model FROM bookings,customer,estimates,items 
where estimates.booking_id=bookings.booking_id AND estimates.user_id='$user_id' AND customer.customer_id=bookings.customer_id AND estimates.item_id=items.item_id AND estimates.job_card_status='1' GROUP BY estimates.booking_id order by estimates.estimates_date desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
else
{
