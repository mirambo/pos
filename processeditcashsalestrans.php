...
$sql= "update temp_cash_sales set quantity='$qnty',vat_value='$vat_value',discount_perc='$discount',discount_value='$disc_value',selling_price='$selling_price' where temp_cash_sales_id='$id'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());

$sql1= "update cash_sales set quantity='$qnty',vat_value='$vat_value',discount_perc='$discount',discount_value='$disc_value',selling_price='$selling_price' where temp_cash_sales_id='$id'";
...
$sqlauditsav= "insert into audit_trail values('','$user_id',NOW(),'Updates Cash Sales Transactions')";
...
window.location = "generate_cash_sales.php?client_id=<?php echo $client_id ?>&sales_code=<?php echo $sales_code ?>&currency=<?php echo $currency ?>";
