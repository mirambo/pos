...
<a target="_blank" style="float:right; margin-right:200px; font-weight:bold; font-size:13px; color:#000000" href="print_list_invoice_sales_approved.php?location_id=<?php echo $supplier; ?>&from=<?php echo $date_from ?>&to=<?php echo $date_to; ?>">Print</a>						  
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
    ...
    <td align="center" width="150"><strong>Transation Date</strong></td>
...
<td align="center" width="150"><strong>Invoice Value(TZS)</strong></td> 
...
echo $rowst->f_name;
	...
	<td align="center"><a href="generate_invoice.php?sales_id=<?php echo $rows->sales_id;?>">View invoice Details</a></td>
 ...
 if ($posted==1)
 {
echo '<font color="#ff0000"><i>Posted</i></font>';	 
 ...
 <a rel="facebox" href="cancel_submited_invoices.php?sales_id=<?php echo $rows->sales_id;?>" onClick="return confirmDelete();">Cancel Invoice</a>
 <?php 
 }
