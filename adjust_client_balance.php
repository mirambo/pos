...
{
    return confirm("Are you sure you want to adjust customer balance?");
}
</script>
...
<body>
	...
	<div id="page-wrap">
		...
		<h3>:: Adjust Client Statement Balance Into the system </h3>
...
<form name="new_user" action="processadjustclientbal.php" method="post">			
...
?></td>
	...
	<tr height="20">
    <td>&nbsp;</td>
    <td>Adjustement Date <font color="#FF0000">*</font></td>
	...
	<tr height="30">
    <td>&nbsp;</td>
    <td  width="25%">Select Client / Customer<font color="#FF0000">*</font></td>
    <td>
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("date_paid","req","Please enter adjustment date");
 ...
 frmvalidator.addValidation("bal_type","selone_radio","Please choose to effect to the balance");
