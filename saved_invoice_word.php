...
FROM users,user_group,employees where users.user_group_id=user_group.user_group_id and users.emp_id=employees.emp_id AND users.user_id='$get_user_id'";
