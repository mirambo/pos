...
header("Content-Disposition: attachment;Filename=Outreach_Report.doc");
header("Expires: 0");
...
<table width="100%" border="0" class="table">
	...
	<tr  style="background:url(images/description.gif);" height="30" >
	<td align="center" ><strong>Istitution of Origin</strong></td>
    ...
    <td align="center"><strong>Disease Name</strong></td>
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?> <td align="center" onClick="document.location.href='home.php?editoutreach=editoutreach&outreach_record_id=<?php echo $rows->outreach_record_id;?>'"><?php echo $rows->institution_name; ?></td>
	<td align="center" onClick="document.location.href='home.php?editoutreach=editoutreach&outreach_record_id=<?php echo $rows->outreach_record_id;?>'"><?php echo $rows->date_from; ?></td>
	<td align="center" onClick="document.location.href='home.php?editoutreach=editoutreach&outreach_record_id=<?php echo $rows->outreach_record_id;?>'"><?php echo $rows->date_to; ?></td>
	<td onClick="document.location.href='home.php?editoutreach=editoutreach&outreach_record_id=<?php echo $rows->outreach_record_id;?>'"><?php echo $rows->location; ?></td>
	<td align="center" onClick="document.location.href='home.php?editoutreach=editoutreach&outreach_record_id=<?php echo $rows->outreach_record_id;?>'"><?php echo $fac_male=$rows->fac_male; ?></td>
	<td align="center" onClick="document.location.href='home.php?editoutreach=editoutreach&outreach_record_id=<?php echo $rows->outreach_record_id;?>'"><?php echo $fac_female=$rows->fac_female; ?></td>
	<td align="center" onClick="document.location.href='home.php?editoutreach=editoutreach&outreach_record_id=<?php echo $rows->outreach_record_id;?>'"><?php echo $res_male=$rows->res_male; ?></td>
	<td align="center" onClick="document.location.href='home.php?editoutreach=editoutreach&outreach_record_id=<?php echo $rows->outreach_record_id;?>'"><?php echo $res_female=$rows->res_female; ?></td>
	<td align="center" onClick="document.location.href='home.php?editoutreach=editoutreach&outreach_record_id=<?php echo $rows->outreach_record_id;?>'"><?php echo $pat_male=$rows->pat_male; ?></td>
	<td align="center" onClick="document.location.href='home.php?editoutreach=editoutreach&outreach_record_id=<?php echo $rows->outreach_record_id;?>'"><?php echo $pat_female=$rows->pat_female; ?></td>
	<td align="center" onClick="document.location.href='home.php?editoutreach=editoutreach&outreach_record_id=<?php echo $rows->outreach_record_id;?>'"><?php echo $pat_child=$rows->pat_child; ?></td>
	<td onClick="document.location.href='home.php?editoutreach=editoutreach&outreach_record_id=<?php echo $rows->outreach_record_id;?>'"><?php echo $disease_name=$rows->disease_name; ?></td>
	<td align="center" onClick="document.location.href='home.php?editoutreach=editoutreach&outreach_record_id=<?php echo $rows->outreach_record_id;?>'"><strong><?php echo $total_pat=$rows->total_pat; ?></strong></td>
	<td align="center" onClick="document.location.href='home.php?editoutreach=editoutreach&outreach_record_id=<?php echo $rows->outreach_record_id;?>'"><?php echo $male_pat=$rows->male_pat; ?></td>
	<td align="center" onClick="document.location.href='home.php?editoutreach=editoutreach&outreach_record_id=<?php echo $rows->outreach_record_id;?>'"><?php echo $female_pat=$rows->female_pat; ?></td>
	<td align="center" onClick="document.location.href='home.php?editoutreach=editoutreach&outreach_record_id=<?php echo $rows->outreach_record_id;?>'"><?php echo $child_pat=$rows->child_pat; ?></td>
