...
<?php require_once('includes/incomesubmenu.php');  ?>
		...
		<h3>::List Of All Other Income Recorded</h3>
...
?>
	...
	<tr bgcolor="#FFFFCC">
	<td colspan="11" align="center"><strong>Search :  By Date</strong>
...
<a target="_blank" style="float:right; margin-right:100px; font-weight:bold; font-size:13px; color:#000000" href="print_list_income.php?client=<?php echo $client?>&date_from=<?php echo $date_from ?>&date_to=<?php echo $date_to ?>">Print</a>						  
...
$sql="select * FROM mop,income,currency where 
income.mop=mop.mop_id AND income.currency_code=currency.curr_id ORDER BY income.date_received desc";
...
//echo "Dea only";
$sql="SELECT * FROM mop,income,currency where 
income.mop=mop.mop_id AND income.currency_code=currency.curr_id and income.date_paid BETWEEN '$date_from' AND '$date_to' order by income.date_paid  desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
...
else
{
	...
	<td align="center"><a href="edit_income.php?income_id=<?php echo $rows->income_id;?>"><img src="images/edit.png"></a></td>
    <td align="center"><a href="delete_income.php?income_id=<?php echo $rows->income_id;?>"  onClick="return confirmDelete();"><img src="images/delete.png"></a></td>
