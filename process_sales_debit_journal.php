...
$transaction_code='sldbtjn'.$customer_payments_code_id;
...
$cr_transaction_code="crsldbtjn".$customer_payments_code_id;
$dr_transaction_code="drsldbtjn".$customer_payments_code_id;




//$transaction='Lampsum amount of ref no '.$cheque_no.' to pay for multiple customer invoice from customer '.$c_name;
$transaction='Sales Debit Journal entry of ref no '.$cheque_no.' <i>('.$comments.')</i> for customer '.$c_name;
...
window.location = "home.php?view_sales_debit_journal";
</script>
<?php
}
