...
$sql= "delete from stock_transfer_items where stock_transfer_item_id='$id'";
...
$sqlauditsav= "insert into audit_trail values('','$user_id',NOW(),'Deleted a stock transfer item transaction')";
