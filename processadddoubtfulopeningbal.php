...
$queryprof="select * from  doubtful_debts_ledger where transactions='$transaction'";
...
header ("Location:add_doubtful_opening_balance.php? recordexist=1");
...
$sql= "insert into doubtful_debts_ledger values ('','$transaction','$amount','$amount','','6','1',NOW())";
...
header ("Location:add_doubtful_opening_balance.php? addconfirm=1");
