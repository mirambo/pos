...
sub_module.sublink,sub_module.sublink,sub_module.description FROM modules,sub_module where modules.module_id=sub_module.module_id AND sub_module.status='0' order by sub_module.sort_order asc";
...
{
$sql="SELECT modules.module_name,sub_module.module_id,sub_module.sub_module_id,sub_module.sub_module_name, sub_module.sort_order,
sub_module.sublink,sub_module.sublink,sub_module.description FROM modules,sub_module where modules.module_id=sub_module.module_id AND sub_module.status='0' AND sub_module.sub_module_name LIKE '%$sub_module%' order by sub_module.sort_order asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>
	...
	<td align="center"><a href="home.php?editsubmodules=editsubmodules&sub_module_id=<?php echo $rows->sub_module_id; ?>"><img src="images/edit.png"></a></td>
