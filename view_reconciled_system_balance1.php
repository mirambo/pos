...
self.location='view_reconciled_system_balance1.php?bank=' + val ;
...
<body>
	...
	<div id="page-wrap">
		...
		<h3>:: View Reconciled System Bank Balance</h3>
...
$queryst="select * from reconciled_system_balance where bank_id='$id' group by date_from ";
...
echo '<tr bgcolor="#FFFFCC" height="25">';
   ...
   <td align="center" width="200"><a href="view_reconciled_system_balance.php?date_from=<?php echo $rowsst->date_from ?>
