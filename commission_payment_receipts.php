...
<body>
	...
	<?php require_once('includes/commision_submenu.php');   ?>
		...
		<h3>::List of All Staff Commission Payment Receipts</h3>
...
?>
   ...
   <tr style="background:url(images/description.gif);" height="30" >
	...
	<td width="70"><div align="center"><strong>Staff Name</strong></td>
...
$sql="select comm_payment_receipt.comm_payment_receipt_id,comm_payment_receipt.receipt_no,comm_payment_receipt.curr_rate,comm_payment_receipt.currency_code,comm_payment_receipt.date_generated,
comm_payment_receipt.amnt_rec,comm_payment_receipt.mop,comm_payment_receipt.sales_rep,currency.curr_name,employees.emp_firstname,employees.emp_middle_name,employees.emp_lastname from comm_payment_receipt,employees,users,currency
where comm_payment_receipt.sales_rep=users.user_id AND employees.emp_id=users.emp_id AND comm_payment_receipt.currency_code=currency.curr_id order by comm_payment_receipt.date_generated desc";
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>
    ...
    <td><a href="comm_payment_receipt2.php?receipt_no=<?php echo $rows->receipt_no;?>&amnt_rec=<?php echo $rows->amnt_rec; ?>&sales_rep=<?php echo $rows->sales_rep;?>&curr_id=<?php echo $rows->currency_code; ?>&date_generated=<?php echo $rows->date_generated; ?>"><?php echo $rows->receipt_no;?></a></td>
