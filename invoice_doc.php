...
<table width="700" border="0" align="center" class="table">
  <tr>
    ...
    <td colspan="3" width="20%"><div align="center"><strong>Item Name </strong></div></td>
    <td width="20%"><div align="center"><strong>Product Description</strong></div></td>
...
products where sales.product_id=products.product_id AND sales.sales_code_id=sales_code.sales_code_id AND sales.sales_code_id='$sales_code_id' AND sales_code.user_id='$user_id' order by sales.sales_id asc";
