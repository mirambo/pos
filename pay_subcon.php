...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC" height="40">
    ...
    <td colspan="13" height="30" align="center"><font size="+1"><strong>Pay Subcontractor's Invoiced Amount
	</strong></font>
	</td>
...
?> 
  ...
  <a href="home.php?recordpaysubcon=recordpaysubcon&project_id=<?php echo $rows->project_id;?>
