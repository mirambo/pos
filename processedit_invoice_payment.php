...
$sql= "update invoice_payments set amount_received='$amnt_paid' where invoice_payment_id='$id'";
...
$sqlauditsav= "insert into audit_trail values('','$user_id',NOW(),'Updated Amount Received from the client')";
