...
$sql="SELECT * from invoice_task,task where invoice_task.task_name=task.task_id AND invoice_task.invoice_task_id='$invoice_task_id'";
...
?>
<form name="new_machine_category" action="process_edit_invoice_task.php" method="post">			
<table width="100%" border="1" class="table1" id="tbl1">
	...
	<input type="hidden" size="41" name="invoice_task_id" value="<?php echo $invoice_task_id;?>">
...
?></td>
  ...
  <tr style="background:url(images/description.gif);" height="20" >
	...
	<td width="100"><strong><input type="text" name="task_remarks" value="<?php echo $rows->task_remarks;?>" size="50"></strong></td>
