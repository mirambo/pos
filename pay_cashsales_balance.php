...
$sql="select cash_sales_payments.currency_code,cash_sales_payments.user_id,cash_sales_payments.cash_sales_payment_id,cash_sales_payments.cash_sales_payment_id,cash_sales_payments.receipt_no,cash_sales_payments.client_id,cash_sales_payments.curr_rate,cash_sales_payments.date_generated,
cash_sales_payments.ttl_amount,cash_sales_payments.sales_code,cash_sales_payments.cash_paid,cash_sales_payments.sales_rep,currency.curr_name,clients.c_name from cash_sales_payments,clients,currency 
where cash_sales_payments.client_id=clients.client_id AND cash_sales_payments.currency_code=currency.curr_id AND cash_sales_payments.user_id='$user_id' and cash_sales_payments.status='1' order by cash_sales_payments.date_generated desc";
...
$sql="select cash_sales_payments.currency_code,cash_sales_payments.user_id,cash_sales_payments.cash_sales_payment_id,cash_sales_payments.cash_sales_payment_id,cash_sales_payments.receipt_no,cash_sales_payments.client_id,cash_sales_payments.curr_rate,cash_sales_payments.date_generated,
cash_sales_payments.ttl_amount,cash_sales_payments.sales_code,cash_sales_payments.cash_paid,cash_sales_payments.sales_rep,currency.curr_name,clients.c_name from cash_sales_payments,clients,currency 
where cash_sales_payments.client_id=clients.client_id and cash_sales_payments.status='1' AND cash_sales_payments.currency_code=currency.curr_id order by cash_sales_payments.date_generated desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
$sql="select cash_sales_payments.currency_code,cash_sales_payments.user_id,cash_sales_payments.cash_sales_payment_id,cash_sales_payments.cash_sales_payment_id,cash_sales_payments.receipt_no,cash_sales_payments.client_id,cash_sales_payments.curr_rate,cash_sales_payments.date_generated,
cash_sales_payments.ttl_amount,cash_sales_payments.sales_code,cash_sales_payments.cash_paid,cash_sales_payments.sales_rep,currency.curr_name,clients.c_name from cash_sales_payments,clients,currency 
where cash_sales_payments.client_id=clients.client_id and cash_sales_payments.status='1' AND cash_sales_payments.currency_code=currency.curr_id and cash_sales_payments.client_id='$client' order by cash_sales_payments.date_generated desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
$sql="select cash_sales_payments.currency_code,cash_sales_payments.user_id,cash_sales_payments.cash_sales_payment_id,cash_sales_payments.cash_sales_payment_id,cash_sales_payments.receipt_no,cash_sales_payments.client_id,cash_sales_payments.curr_rate,cash_sales_payments.date_generated,
cash_sales_payments.ttl_amount,cash_sales_payments.sales_code,cash_sales_payments.cash_paid,cash_sales_payments.sales_rep,currency.curr_name,clients.c_name from cash_sales_payments,clients,currency 
where cash_sales_payments.client_id=clients.client_id and cash_sales_payments.status='1' AND cash_sales_payments.currency_code=currency.curr_id and cash_sales_payments.date_generated BETWEEN '$date_from' AND '$date_to'  order by cash_sales_payments.date_generated desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
$sql="select cash_sales_payments.currency_code,cash_sales_payments.user_id,cash_sales_payments.cash_sales_payment_id,cash_sales_payments.cash_sales_payment_id,cash_sales_payments.receipt_no,cash_sales_payments.client_id,cash_sales_payments.curr_rate,cash_sales_payments.date_generated,
cash_sales_payments.ttl_amount,cash_sales_payments.sales_code,cash_sales_payments.cash_paid,cash_sales_payments.sales_rep,currency.curr_name,clients.c_name from cash_sales_payments,clients,currency 
where cash_sales_payments.client_id=clients.client_id and cash_sales_payments.status='1' AND cash_sales_payments.currency_code=currency.curr_id and cash_sales_payments.date_generated BETWEEN '$date_from' AND '$date_to' and cash_sales_payments.client_id='$client' order by cash_sales_payments.date_generated desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
else
{
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>
	...
	<td align="center">
	<!--<a href="cancel_cash_sale_reason.php?invoice_id=<?php echo $rows->invoice_id;?>&sales_code=<?php echo $rows->sales_code;?>&invoice_no=<?php echo $rows->invoice_no;?>" onClick="return confirmCancel();"><img src="images/dissaprove.png"></a>-->
	<a href="cancel_cash_sale_reason.php?cash_sales_payment_id=<?php echo $rows->cash_sales_payment_id;?>&sales_code=<?php echo $rows->sales_code;?>&receipt_no=<?php echo $rows->receipt_no; ?>
	&client_id=<?php echo $rows->client_id; ?>&currency=<?php echo $rows->currency_code; ?>&sales_rep=<?php echo $rows->sales_rep; ?>&inv_bal=<?php echo $inv_bal=$rows->inv_bal;?>&inv_ttl=<?php echo $rows->ttl_amount; ?>&date_generated=<?php echo $rows->date_generated;?>&user=<?php echo $rows->user_id;?>" onClick="return confirmCancel();"><img src="images/dissaprove.png"></a>
	</td>
