...
header("Content-Disposition: attachment;Filename=Expenses_Payment_Voucher.doc");
header("Expires: 0");
...
<title>Expenses Receipt <?php echo $receipt_no;  ?></title>
...
<table width="700" border="0" align="center" >
  ...
  <tr>
    <td colspan="3"><div align="right"><font color="#000033" size="+2"><strong>
      <!--Brisk Diagnostics Limited --><a href="view_expenses.php"><div style="background-image:url(images/back.jpg); width:201px; height:32px;"></div></a>
    </strong></font></div></td>
  </tr>
  <tr>
...
$rowscont=mysql_fetch_object($resultscont); 
  ...
  <tr height="30">
    <td colspan="6" bgcolor="#000033" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">EXPENSES PAYMENT VOUCHER</span></td>
  </tr>
  <tr height="20">
    <td></td>
    <td colspan="5"></td>
...
$rowssupp=mysql_fetch_object($resultssup);
  ...
  ?>
<tr>
    <td colspan="6"><font size="+1">Expenses Payment Voucher<u><i><?php echo $rowssupp->supplier_name; ?></u></i></font></td>
  ...
  <tr height="20">
    <td colspan="6"><font size="+1">Being payment of <i><u>The expenses <?php echo $desc;  ?></font></u></i></td>
