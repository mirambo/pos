...
<body>
	...
	<?php require_once('includes/baddebtssubmenu.php');  ?>
		...
		<h3>::Recover Written Off Bad Debts</h3>
...
if ($_GET['success']==1)
echo '<div align="center" style="background: #FFCC33; height:20px; width:550px; border:#FF0000 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#FF0000" >Bad Debts Recovered successfully</font></strong></p></div>';
?> 
...
?>
   ...
   <tr style="background:url(images/description.gif);" height="30" >
	...
	<td width="13%"><div align="center"><strong>Doubtful Debts(Foreign Currencies)</strong></td>
	<td width="10%"><div align="center"><strong>Exchange Rate</strong></td>
	<td width="15%"><div align="center"><strong>Doubtful Debts Amount(Kshs)</strong></td>
	<td width="12%"><div align="center"><strong>Recover</strong></td>
...
$sql="select bad_debts.bad_debt_id,bad_debts.client_id,bad_debts.curr_rate,bad_debts.date_received,invoices.invoice_no,invoices.invoice_id,
bad_debts.amount,bad_debts.sales_code, currency.curr_name,clients.c_name from bad_debts,clients,invoices,
currency where bad_debts.client_id=clients.client_id AND bad_debts.status='0' AND bad_debts.sales_code=invoices.sales_code AND  bad_debts.currency_code=currency.curr_id order by bad_debts.bad_debt_id desc";
...
$sqldc="SELECT sales_code from recovered_bad_debts where sales_code='$sales_code1'";
...
echo '<font color="#ff0000">Bad Debt..</font>';

/*$sqlpdt="update bad_debts set status='1' where sales_code='$sales_codedc'";
...
<a href="recover_bad_debts2.php?bad_debt_id=<?php echo $rows->bad_debt_id;?>" style="color:#000099;">Recover</a>
