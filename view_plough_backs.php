...
$sql="SELECT ploughed_back_dividend.dividend,ploughed_back_dividend.description,ploughed_back_dividend.transaction_date,shares.shares_id,shares.share_holder_name
FROM shares,ploughed_back_dividend where shares.shares_id=ploughed_back_dividend.shares_id";
$results=mysql_query($sql) or die ("Error $sql.".mysql_error());
