...
$id=$_GET['reconciled_system_balance'];
$bank=$_GET['bank_id'];
...
$sql= "delete from reconciled_system_balance where reconciled_system_balance_id='$id'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());



header ("Location:view_reconciled_system_balance.php?deleteconfirm=1&date_from=$date_from&date_to=$date_to&bank_id=$bank&out_bal=$out_bal");
