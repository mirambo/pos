...
//$account_from=mysql_real_escape_string($_POST['account_from']); 
$trans_desc=mysql_real_escape_string($_POST['title']);
//$journal_amount=mysql_real_escape_string($_POST['journal_amount']); 
...
$sql34="INSERT INTO journal_code SET 
...
$transaction_desc='<a href="home.php?general_journal=general_journal&id='.$journal_code_id.'">Journal Entry for '.$trans_desc.'</a>';
...
$sql34="INSERT INTO journal_transaction SET 
...
else
{
	...
	$dr_transaction_code='jnl-dr'.$journal_code_id;
...
$cr_transaction_code='jnl-cr'.$journal_code_id;
