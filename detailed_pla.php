...
<span style="float:rig;"><a target="_blank" href="print_detailed_pa.php?date_from=<?php echo $date_from; ?>&id=<?php echo $id; ?>&date_to=<?php echo $date_to; ?>"><img src="images/print_icon.gif"></a></span>
<span style="float:rig;" style="margin-right:x;"><a href="detailed_pa_excel.php?date_from=<?php echo $date_from; ?>&id=<?php echo $id; ?>&date_to=<?php echo $date_to; ?>"><img src="images/excel.png"></a></span>
	</td>
	</tr>
...
<tr bgcolor="#FFFFCC">
    ...
    <strong>To</strong>
    <input type="text" name="date_to" size="20" value="<?php echo $date_to; ?>" id="date_to" /><input name="DateFormats" id="DateFormats" disabled value="dd/mm/yyyy" type="hidden">
...
<strong>Profit and Loss Account for the period between : <font color="#ff0000"><?php echo $date_from; ?></font> and <font color="#ff0000"><?php echo $date_to; ?></font></strong>
<?php
...
<strong>Profit and Loss Account for the period ending : <font color="#ff0000"><?php echo $date_to; ?></font></strong>
<?php
...
<strong>Profit and Loss Account for the period ending : <font color="#ff0000"><?php echo $date_from; ?></font></strong>
<?php	
	...
	{
		?>
<strong>Profit and Loss Account for the period ending : <font color="#ff0000"><?php echo date('Y-m-d'); ?></font></strong>
<?php		
...
echo number_format($ttl_cos_amount,2);
 ...
 //cost of sales income
$queryop="select * FROM account_type where account_cat_id='6' and account_type_id!='492' AND account_type_id!='493' AND account_type_id!='494' AND account_type_id!='496'";
$results= mysql_query($queryop) or die ("Error $queryop.".mysql_error());
while ($rows=mysql_fetch_object($results))
{
...
echo number_format($op_amount,2);
 ...
 //cost of sales income
$queryop="select * FROM account_type where account_cat_id='6' and (account_type_id='492' OR account_type_id='493' OR account_type_id='494' OR account_type_id='496')";
$results= mysql_query($queryop) or die ("Error $queryop.".mysql_error());
while ($rows=mysql_fetch_object($results))
{
...
echo number_format($dep_amount,2);
 ...
 <tr onmouseover="ChangeColor(this, true);" 
              onmouseout="ChangeColor(this, false);" height="40"><td><strong>2700-100 Profit For The Year</strong></td><td align="right"><strong><font size=""><?php echo number_format($gross_margin-$ttl_op_amount-$ttl_dep_amount,2); ?></font></strong></td></tr>
