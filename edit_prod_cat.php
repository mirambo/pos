...
<body>
	...
	<div id="page-wrap">
		...
		<h3>:: Adding New Stock Category</h3>
...
<form name="new_machine_category" action="processeditprodcat.php?cat_id=<?php echo $id; ?>" method="post">			
...
$queryprodcat="select * from  product_categories where cat_id='$id'";
...
?></td>
  ...
  <tr>
    ...
    <td width="23%"><input type="text" size="41" name="mach_cat_name" value="<?php echo $rowsprodcat->cat_name;?>"></td>
    <td width="40%" rowspan="2" valign="top"><div id='new_machine_category_errorloc' class='error_strings'></div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Enter Description</td>
    <td><textarea rows="5" cols="30" name="mach_cat_desc"><?php echo $rowsprodcat->cat_desc;?></textarea></td>
    </tr>
