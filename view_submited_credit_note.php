...
<input type="submit" name="generate" value="Generate">								  
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
    ...
    <td align="center" width="150"><strong>Credit No</strong></td>   
    <td align="center" width="150"><strong>Date Generated</strong></td>
<td align="center" width="300"><strong>Customer Name</strong></td>  
<td align="center" width="150"><strong>Credit Note Value (SSP)</strong></td> 
...
$sql="SELECT * FROM credit_note  order by date_generated desc";
...
{
$sql="SELECT * FROM credit_note where customer_id='$location_id' order by date_generated desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
{
$sql="SELECT * FROM credit_note where job_card_id LIKE '%$settlement_name%'  order by date_generated desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}

elseif ($location_id!=0 && $settlement_name!='')
{
$sql="SELECT * FROM credit_note WHERE customer_id='$location_id'  AND job_card_id LIKE 
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>
    ...
    <td><?php echo $job_card_id=$rows->credit_note_id;?></td>
...
$rowslpdet=mysql_fetch_object($resultslpdet);
    ...
    <td align="right"><?php include ('credit_note_value.php');?></td>
    <td align="right">
	
	<?php include ('credit_note_payment_value.php');?>
...
echo $rowst->f_name;
	...
	<td align="center"><a href="home.php?dropdowntitle=dropdowntitle&credit_note_id=<?php echo $job_card_id;?>">View Details</a></td>
