...
<?php require_once('includes/banking_submenu.php');  ?>
		...
		<h3>:: List of All Cheque Withdrawals</h3>
...
<a target="_blank" style="float:right; margin-right:200px; font-weight:bold; font-size:13px; color:#000000" href="print_list_cheque_withdrawal.php?location_id=<?php echo $supplier; ?>&from=<?php echo $date_from ?>&to=<?php echo $date_to; ?>">Print</a>						  
...
<table width="100%" border="0" class=demoTable id=demoTable align="center">
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
   ...
   <td align="center" width="160"><strong>Amount <br/>(Mixed Currency)</strong></td>
    ...
    <td align="center" width="200"><strong>Bank and Account Withdrawn</strong></td>
...
$querydc="SELECT * FROM banks,cheque_withdrawals,currency where cheque_withdrawals.bank_withdrawn=banks.bank_id 
AND currency.curr_id=cheque_withdrawals.curr_id order by cheque_withdrawals.cheque_withdrawal_id desc";
...
else
{
	...
	$querydc= "SELECT * FROM banks,cheque_withdrawals,currency";
    $conditions = array();
    if($supplier!=0) 
	
	{
	
    $conditions[] = "cheque_withdrawals.bank_withdrawn='$supplier'";
	...
	if($date_from!='' && $date_to!='' ) {
       ...
       $conditions[] = "cheque_withdrawals.date_drawn>='$date_from' AND cheque_withdrawals.date_drawn<='$date_to'";
    }
    ...
    if (count($conditions) > 0) {
      $querydc .= " WHERE " . implode(' AND ', $conditions)." and cheque_withdrawals.bank_withdrawn=banks.bank_id 
AND currency.curr_id=cheque_withdrawals.curr_id order by cheque_withdrawals.cheque_withdrawal_id desc";
    }
	else
	{	
...
/* $sql="SELECT * FROM banks,cheque_withdrawals,currency where cheque_withdrawals.bank_withdrawn=banks.bank_id 
AND currency.curr_id=cheque_withdrawals.curr_id order by cheque_withdrawals.cheque_withdrawal_id desc";
...
if ($sess_allow_edit==1)
{
	...
	<a href="edit_chequewithdrawal.php?cheque_withdrawal_id=<?php echo $rows->cheque_withdrawal_id; ?>"><img src="images/edit.png"></a>
	<?php
}
else
{
...
if ($sess_allow_delete==1)
{
	?>
	 ...
	 <a href="delete_cheque_withdrawal.php?cheque_withdrawal_id=<?php echo $rows->cheque_withdrawal_id;?>&income_desc=<?php echo $rows->description;?>"  onClick="return confirmDelete();"><img src="images/delete.png"></a>
	<?php 
	}
	else
	{
