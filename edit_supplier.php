...
<form name="new_supplier" action="processeditsuppliers.php?supplier_id=<?php echo $id; ?>" method="post">			
...
echo '<div align="center" style="background: #FFCC33; height:20px; width:600px; border:#339900 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#339900" >Supplier Updated Successfully!!</font></strong></p></div>';
?>
...
?></td>
  ...
  <tr height="20">
    <td bgcolor="">&nbsp;</td>
    <td width="19%">Supplier Name <font color="#FF0000">*</font></td>
    <td width="23%"><input type="text" size="41" name="sup_name" value="<?php echo $rows->supplier_name;?>"></td>
    <td width="40%" rowspan="6" valign="top"><div id='new_supplier_errorloc' class='error_strings'></div></td>
  </tr>
  <tr height="20">
    <td>&nbsp;</td>
    <td>Supplier Code<font color="#FF0000">*</font></td>
    <td><input type="text" size="41" name="sup_code" value="<?php echo $rows->sup_code;?>"></td>
    </tr>
	
  <tr height="20">
    <td>&nbsp;</td>
    <td>Contact Person Name<font color="#FF0000">*</font></td>
    <td><input type="text" size="41" name="cont_person" value="<?php echo $rows->cont_person;?>"></td>
    </tr>	
...
<option value="Zimbabwe">Zimbabwe</option>
    ...
    <td><input type="text" size="41" name="address" value="<?php echo $rows->cont_person;?>"></td>
    </tr>
	
	<tr height="20">
    <td>&nbsp;</td>
    <td>Physical Address</td>
    <td><input type="text" size="41" name="address" value="<?php echo $rows->postal;?>"></td>
    </tr>	
	<!--<tr height="20">
    <td>&nbsp;</td>
    <td>Location</td>
    <td><input type="text" size="41" name="address" value="<?php echo $rows->town;?>"></td>
    </tr>-->
	<tr height="20">
    <td>&nbsp;</td>
