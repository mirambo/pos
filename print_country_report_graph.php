...
$sqlsact="SELECT * FROM nrc_set_template where sub_project_id='$sub_proj_id' AND nrc_set_template.cc_id='$cc_id' and country_id='$country_id' and project_id='$project_id' order by activity asc";
$resultsact=mysql_query($sqlsact) or die ("Error $sqlsact.".mysql_error());
...
elseif ( $country_id!=0 && $cc_id!=0 && $project_id==0 && $date_from=='' && $date_to=='')
{
$sqlsact="SELECT * FROM nrc_set_template where sub_project_id='$sub_proj_id' AND nrc_set_template.cc_id='$cc_id' AND country_id='$country_id' order by activity asc";
$resultsact=mysql_query($sqlsact) or die ("Error $sqlsact.".mysql_error());
