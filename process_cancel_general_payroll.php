...
$sqlredday="select * from payroll where payment_month='$date_month'";
...
$sql= "delete from payroll where payment_month='$date_month'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());

$sql= "delete from benefits where benefit_month='$date_month'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());

$sql= "delete from deductions where deduction_month='$date_month'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());

$sql= "delete from staff_advance_repayment where month_paid='$date_month'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
/*
...
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
*/
header ("Location:begin_cancel_general_payrol.php?delconfirm=1");
