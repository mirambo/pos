...
header("Content-Disposition: attachment;Filename=Client_Statement.doc");
header("Expires: 0");
...
$rowscont=mysql_fetch_object($resultscont);
  ...
  <tr>
    <td colspan="3"><div align="right"><?php echo $rowscont->building.' '.$rowscont->street; ?><!--Kigali Road, Jamia Plaza, 2nd Floor --></div></td>
  </tr>
   <tr>
  ...
  <tr>
    <td colspan="3"><div align="right">Website : www.briskdiagnostics.com</div></td>
  </tr>
  <tr height="30">
...
<table width="700" border="1" align="center" class="table" style="margin:auto;">
...
<tr bgcolor="#FFFFCC" height="30">
    <td width="5%" colspan="4"><div align="center"><strong>Period From : <font color="#ff0000"><?php echo $date_from; ?></font> To :  <font color="#ff0000"><?php echo $date_to; ?></font> </strong></div></td>
</tr>
