...
<body>
	...
	<?php require_once('includes/advance_submenu.php');  ?>
		...
		<h3>:: Record Staff Advance Payments</h3>
...
<form name="gen_order" action="process_staff_advance.php" method="post">			
...
?></td>
 <!--<input type="hidden" name="supplier_id" size="20" value="<?php echo $rowstemp->supplier_id; ?>">
  ...
  <tr height="20" bgcolor="#C0D7E5">
    ...
    <td width="15%" valign="top">Select Staff <font color="#FF0000"></font></td>
	...
	<td valign="top" width="15%">Advance Amount<font color="#FF0000"></font></td>
    ...
    <td valign="top"><input type="text" name="install" size="40"></td>
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("employee","dontselect=0",">>Please select staff");
 frmvalidator.addValidation("amount","req",">>Please enter advance amount paid");
 frmvalidator.addValidation("installment","req",">>Please enter repayment installment");
