...
$sqlauditsav= "insert into audit_trail values('','$user_id',NOW(),'edited prepaid expenses details')";
$resultsauditsav= mysql_query($sqlauditsav) or die ("Error $sqlauditsav.".mysql_error());



header ("Location:edit_prepaid_expenses.php?expenses_id=$id&updateconfirm=1");
