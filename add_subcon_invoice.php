...
<form name="new_supplier" action="processaddsubconinv.php" method="post">			
...
<?php 
  ...
  FROM operations,clients,projects where projects.operation_id=operations.operation_id AND projects.client_id=clients.client_id";
	...
	<tr height="20">
    <td>&nbsp;</td>
    <td>Enter Days Spent By Staff</td>
    <td><input type="text" name="days_spent" size="41" /></td>
    </tr>
	<tr height="20">
    <td>&nbsp;</td>
