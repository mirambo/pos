...
<form name="new_supplier" action="processadd_omrates_perday.php" method="post">			
...
?></td>
  ...
  <!--<tr height="20">
    <td bgcolor="">&nbsp;</td>
    <td width="19%">Select Location/ Segments<font color="#FF0000">*</font></td>
    <td width="23%">
	<select name="omlocation_id">	
	<option>Select..................................</option>
	
								  <?php
								
								  $queryinst="SELECT * FROM omlocations order by omlocation_name asc";
								  ...
								  
								  {
                                    ...
                                    <option value="<?php echo $rowsinst->omlocation_id; ?>"><?php echo $rowsinst->omlocation_name; ?> </option>
