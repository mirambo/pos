...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
	...
	<a href="print_general_ledger.php" target="_blank">Print</a>|<a href="print_general_ledger_word.php">Export to word </a>
...
$sql="select  general_ledger.transaction_id,general_ledger.transactions,general_ledger.amount,general_ledger.debit,general_ledger.credit,general_ledger.currency_code,general_ledger.curr_rate,general_ledger.date_recorded, currency.curr_name 
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
    ...
    <td colspan="9" height="30" align="right"><font size="+1">
	<a href="print_general_ledger.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to; ?>" target="_blank">Print</a> | <a href="print_general_ledger_word.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to; ?>">Export to word </a>
