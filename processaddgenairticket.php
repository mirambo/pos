...
$sql= "insert into genairtickets values('','$full_name','$dep_town','$dep_date','$dest_town','$arrive_date','$ret_date',
'$flight_comp','$flight_no','$flight_cost','$remarks','0',NOW())";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());

$sqlauditsav= "insert into audit_trails values('','2',NOW(),'Processed General Air Ticket')";
$resultsauditsav= mysql_query($sqlauditsav) or die ("Error $sqlauditsav.".mysql_error());


$sqlss="INSERT INTO expenses_ledger VALUES('','General Air Ticket for $full_name','$flight_cost','$flight_cost', '','$currency','$curr_rate',NOW())";
$resultsss= mysql_query($sqlss) or die ("Error $sqlss.".mysql_error());

$sqlgenled= "insert into general_ledger values('','General Air Ticket Fee for $full_name','-$flight_cost','','$flight_cost','$currency','$curr_rate',NOW(),'')";
$resultsgenled=mysql_query($sqlgenled) or die ("Error $sqlgenled.".mysql_error());

$sqlgenled= "insert into general_ledger values('','General Air Ticket for $full_name','$flight_cost','$flight_cost','','$currency','$curr_rate',NOW(),'')";
$resultsgenled=mysql_query($sqlgenled) or die ("Error $sqlgenled.".mysql_error());

$sqlgenled= "insert into cash_ledger values('','General Air Ticket for $full_name','-$flight_cost','','$flight_cost','$currency','$curr_rate',NOW())";
$resultsgenled=mysql_query($sqlgenled) or die ("Error $sqlgenled.".mysql_error());
...
header ("Location:home.php?processgenflight=processgenflight&addempconfirm=1");
