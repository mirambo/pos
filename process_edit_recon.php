...
if ($effect==1)
{
$sql= "UPDATE reconciled_system_balance SET 
effect='$effect',
description='$desc',
amount='$amount2',
...
WHERE reconciled_system_balance_id='$id'";
...
header ("Location:edit_reconciled_system_balance.php?editconfirm=1&reconciled_system_balance=$id");
