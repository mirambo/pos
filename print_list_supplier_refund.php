...
<H2>List Of All Supplier Refund</H2>
...
//echo "client only";
$sql="select * FROM mop,supplier_refund,currency where 
supplier_refund.mop=mop.mop_id AND supplier_refund.currency_code=currency.curr_id and supplier_refund.client_id='$client' order by supplier_refund.date_paid  desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
...
supplier_refund.date_paid BETWEEN '$date_from' AND '$date_to' and supplier_refund.client='$client' order by supplier_refund.date_paid  desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
