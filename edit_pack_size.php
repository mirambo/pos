...
<body>
	...
	<div id="page-wrap">
		...
		<h3>:: Update Pack Size Details</h3>
...
<form name="new_machine_category" action="processeditpacksize.php?pack_size_id=<?php echo $id; ?>" method="post">			
...
$queryprodcat="select * from  pack_size where pack_size_id='$id'";
...
?></td>
 ...
 <tr>
    ...
    <td width="23%"><input type="text" size="41" name="pack_size" value="<?php echo $rowsprodcat->pack_size;?>"></td>
