...
<body>
	...
	<?php require_once('includes/compayableledgersubmenu.php');  ?>
		
		<h3>::Salaries And Commission Payables Legder</h3>
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
	...
	Salaries And Commission Payables Legder</strong></font>
	...
	<a href="print_ap_ledger.php" target="_blank">Print</a>|<a href="print_ap_ledger_word.php">Export to word </a>
	...
	<strong>Filter By Date From</strong>
...
$sql="select  com_payables_ledger.transaction_id,com_payables_ledger.transactions,com_payables_ledger.amount,
com_payables_ledger.debit,com_payables_ledger.credit,com_payables_ledger.currency_code,com_payables_ledger.curr_rate,
com_payables_ledger.date_recorded, currency.curr_name 
from com_payables_ledger,currency where com_payables_ledger.currency_code=currency.curr_id and com_payables_ledger.amount!='0' order by com_payables_ledger.transaction_id asc";
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
    ...
    <td colspan="9" height="30" align="right"><font size="+1">
	<a href="print_ap_ledger.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to; ?>" target="_blank">Print</a> | <a href="print_ap_ledger_word.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to; ?>">Export to word </a>
...
<?php 
$sqlbbd="select  com_payables_ledger.transaction_id,com_payables_ledger.transactions,com_payables_ledger.amount,com_payables_ledger.debit,com_payables_ledger.credit,com_payables_ledger.currency_code,com_payables_ledger.curr_rate,com_payables_ledger.date_recorded, currency.curr_name 
from com_payables_ledger,currency where com_payables_ledger.currency_code=currency.curr_id AND date_recorded <'$date_from'order by com_payables_ledger.transaction_id asc";
...
from com_payables_ledger,currency where com_payables_ledger.currency_code=currency.curr_id AND date_recorded BETWEEN '$date_from' AND '$date_to' order by com_payables_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
$grnd_amount_out_kshs=0; 
$sql="select  com_payables_ledger.transaction_id,com_payables_ledger.transactions,com_payables_ledger.amount,com_payables_ledger.debit,com_payables_ledger.credit,com_payables_ledger.currency_code,com_payables_ledger.curr_rate,com_payables_ledger.date_recorded, currency.curr_name 
from com_payables_ledger,currency where com_payables_ledger.currency_code=currency.curr_id order by com_payables_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
