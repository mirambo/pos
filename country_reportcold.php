...
<input type="submit" name="generate" value="Generate">								  
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
    ...
    <td align="center" width="150"><strong>Booking No</strong></td>
    ...
    <td align="center" width="150"><strong>Create Job Card</strong></td> 
...
$sql="SELECT estimates.curr_sp,estimates.item_id,estimates.booking_id,estimates.quantity,estimates.discout,SUM(estimates.discount_value) as ttl_disc,
...
where estimates.booking_id=bookings.booking_id AND customer.customer_id=bookings.customer_id AND estimates.item_id=items.item_id AND estimates.job_card_status='0' GROUP BY estimates.booking_id order by bookings.booking_date desc";
...
AND estimates.item_id=items.item_id AND estimates.job_card_status='0' AND bookings.customer_id='$location_id'  GROUP BY estimates.booking_id order by bookings.booking_date desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
customer.customer_name,bookings.reg_no,bookings.booking_date,bookings.vehicle_make,bookings.vehicle_model
 FROM bookings,customer,estimates,items 
where estimates.booking_id=bookings.booking_id AND customer.customer_id=bookings.customer_id 
AND estimates.item_id=items.item_id AND estimates.job_card_status='0' AND bookings.reg_no LIKE '%$settlement_name%'  GROUP BY estimates.booking_id order by bookings.booking_date desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
...
customer.customer_name,bookings.reg_no,bookings.booking_date,bookings.vehicle_make,bookings.vehicle_model
 FROM bookings,customer,estimates,items 
where estimates.booking_id=bookings.booking_id AND customer.customer_id=bookings.customer_id 
AND estimates.item_id=items.item_id AND estimates.job_card_status='0' AND bookings.reg_no LIKE '%$settlement_name%' AND bookings.customer_id='$location_id' GROUP BY estimates.booking_id order by bookings.booking_date desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
else
{
$sql="SELECT estimates.curr_sp,estimates.item_id,estimates.booking_id,estimates.quantity,estimates.discout,SUM(estimates.discount_value) as ttl_disc,
SUM(estimates.vat_value) as ttl_vat,estimates.vat,estimates.estimates_id,estimates.user_id,items.item_name,items.item_code,customer.customer_name,bookings.reg_no,bookings.booking_date,bookings.vehicle_make,bookings.vehicle_model FROM bookings,customer,estimates,items 
where estimates.booking_id=bookings.booking_id AND estimates.job_card_status='0' AND customer.customer_id=bookings.customer_id AND estimates.item_id=items.item_id GROUP BY estimates.booking_id order by bookings.booking_date desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
$sql="SELECT estimates.curr_sp,estimates.item_id,estimates.booking_id,estimates.quantity,estimates.discout,SUM(estimates.discount_value) as ttl_disc,
SUM(estimates.vat_value) as ttl_vat,estimates.vat,estimates.estimates_id,estimates.user_id,items.item_name,items.item_code,customer.customer_name,bookings.reg_no,bookings.booking_date,bookings.vehicle_make,bookings.vehicle_model FROM bookings,customer,estimates,items 
where estimates.booking_id=bookings.booking_id AND estimates.user_id='$user_id' AND customer.customer_id=bookings.customer_id AND estimates.item_id=items.item_id AND estimates.job_card_status='0' GROUP BY estimates.booking_id order by bookings.booking_date desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
else
{
...
$sql="SELECT estimates.curr_sp,estimates.item_id,estimates.booking_id,estimates.quantity,estimates.discout,SUM(estimates.discount_value) as ttl_disc,
SUM(estimates.vat_value) as ttl_vat,estimates.vat,estimates.estimates_id,estimates.user_id,items.item_name,items.item_code,customer.customer_name,bookings.reg_no,bookings.booking_date,bookings.vehicle_make,bookings.vehicle_model FROM bookings,customer,estimates,items 
where estimates.booking_id=bookings.booking_id AND estimates.job_card_status='0' AND estimates.user_id='$user_id' AND customer.customer_id=bookings.customer_id AND estimates.item_id=items.item_id GROUP BY estimates.booking_id order by bookings.booking_date desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>
    ...
    <td><?php echo $booking_date=$rows->booking_date;?></td>
...
<td align="center"><a href="home.php?locationreportc=locationreportc&booking_id=<?php echo $rows->booking_id;?>">Create Job Card</a></td>
