...
<span style="float:left;margin:auto;"><strong>General Area Level Bi-Weekly Graphical Report </strong></span>
<?php
...
if ($area_id==0)
{
echo "<font color='#ff0000'><i><strong>No Area Selected!!</strong></i></font>";
}
else
{
$sqlccn="SELECT * from nrc_area where area_id='$area_id'";
$resultsccn=mysql_query($sqlccn) or die ("Error $sqlccn.".mysql_error());
$rowsccn=mysql_fetch_array($resultsccn);


echo "<font color='#009900'><i><strong>".$country_name=$rowsccn['area_name'].'</strong></i></font>';
}
 ?>
...
<td colspan="3" align="center" width="10%"><strong>Activitites(Key Indicator)</strong></td>
</tr>
...
<td  align="center" ><strong>Progress Bar [<img src="images/green.jpg" width="15" height="15"/>Achieved <img src="images/blue.jpg" width="15" height="15"/> Target]</strong></td>
</tr>
...
if ( $area_id!=0 && $cc_id!=0 && $project_id!=0 && $date_from!='' && $date_to!='')
{

/*$sqlsp="SELECT nrc_project.project_id, nrc_sub_project.sub_project_name, nrc_sub_project.sub_project_code, nrc_subprojectvslocation.sub_project_id, nrc_location.area_id, nrc_location.area_id
...
AND nrc_subprojectvslocation.area_id = nrc_location.area_id
AND nrc_location.area_id=$area_id
...
WHERE nrc_set_template.area_id=$area_id AND nrc_set_template.cc_id=$cc_id and nrc_project.project_id=$project_id AND nrc_project.status=1
...
elseif ( $area_id!=0 && $cc_id==0 && $project_id==0 && $date_from=='' && $date_to=='')
{
...
INNER JOIN nrc_sub_project ON nrc_sub_project.sub_project_id = nrc_set_template.sub_project_id
INNER JOIN nrc_project ON nrc_project.project_id=nrc_set_template.project_id
WHERE nrc_set_template.area_id = $area_id and nrc_project.status=1
GROUP BY nrc_sub_project.sub_project_id
...
INNER JOIN nrc_sub_project ON nrc_sub_project.sub_project_id=nrc_set_template.sub_project_id
INNER JOIN nrc_project ON nrc_project.project_id=nrc_set_template.project_id
WHERE nrc_set_template.area_id=$area_id AND nrc_set_template.cc_id=$cc_id and nrc_project.status=1  GROUP BY nrc_sub_project.sub_project_id  ORDER BY nrc_sub_project.sub_project_name asc
";
$resultssp=mysql_query($sqlsp) or die ("Error $sqlsp.".mysql_error());
...
WHERE nrc_set_template.area_id=$area_id and nrc_project.project_id=$project_id AND nrc_project.status=1
GROUP BY nrc_sub_project.sub_project_id  ORDER BY nrc_sub_project.sub_project_name asc";
$resultssp=mysql_query($sqlsp) or die ("Error $sqlsp.".mysql_error());
...
WHERE nrc_set_template.area_id=$area_id AND nrc_set_template.cc_id=$cc_id  AND nrc_project.status=1
GROUP BY nrc_sub_project.sub_project_id  ORDER BY nrc_sub_project.sub_project_name asc";
$resultssp=mysql_query($sqlsp) or die ("Error $sqlsp.".mysql_error());
...
while ($rowsp=mysql_fetch_object($resultssp))
							  ...
							  if($RowCounter % 2==0)
							  {
echo '<tr style="padding:0px;" bgcolor="#C0D7E5" height="25"  onmouseover="ChangeColor(this, true);" 
              onmouseout="ChangeColor(this, false);">';
}
else 
{
echo '<tr style="padding:0px;" bgcolor="#FFFFCC" height="25"  onmouseover="ChangeColor(this, true);" 
              onmouseout="ChangeColor(this, false);" 
              >';
}
	?>
...
if (!isset($_POST['generate']))
{
$sqlsact="SELECT * FROM nrc_set_template where sub_project_id='$sub_proj_id' order by activity asc";
...
$sqlsact="SELECT * FROM nrc_set_template where sub_project_id='$sub_proj_id' AND nrc_set_template.cc_id='$cc_id' and area_id='$area_id' 
and project_id='$project_id' order by activity asc";
$resultsact=mysql_query($sqlsact) or die ("Error $sqlsact.".mysql_error());
...
elseif ( $area_id!=0 && $cc_id==0 && $project_id==0 && $date_from=='' && $date_to=='')
{
$sqlsact="SELECT * FROM nrc_set_template where sub_project_id='$sub_proj_id' and area_id='$area_id' order by activity asc";
$resultsact=mysql_query($sqlsact) or die ("Error $sqlsact.".mysql_error());
...
elseif ( $area_id!=0 && $cc_id!=0 && $project_id==0 && $date_from=='' && $date_to=='')
{
$sqlsact="SELECT * FROM nrc_set_template where sub_project_id='$sub_proj_id' AND nrc_set_template.cc_id='$cc_id' AND area_id='$area_id' order by activity asc";
$resultsact=mysql_query($sqlsact) or die ("Error $sqlsact.".mysql_error());
...
elseif ( $area_id==0 && $cc_id!=0 && $project_id==0 && $date_from=='' && $date_to=='')
{
$sqlsact="SELECT * FROM nrc_set_template where sub_project_id='$sub_proj_id' AND nrc_set_template.cc_id='$cc_id' order by activity asc";
$resultsact=mysql_query($sqlsact) or die ("Error $sqlsact.".mysql_error());
...
elseif ( $area_id!=0 && $cc_id==0 && $project_id!=0 && $date_from!='' && $date_to!='')
{
$sqlsact="SELECT * FROM nrc_set_template where sub_project_id='$sub_proj_id' AND area_id='$area_id' ";
$resultsact=mysql_query($sqlsact) or die ("Error $sqlsact.".mysql_error());
}
...
while ($rowsact=mysql_fetch_object($resultsact))
							  ...
							  if($RowCounter % 2==0)
							  {
echo '<tr bgcolor="#C0D7E5" height="20"  onmouseover="ChangeColor(this, true);" 
              onmouseout="ChangeColor(this, false);">';
}
else 
{
echo '<tr bgcolor="#FFFFCC" height="20"  onmouseover="ChangeColor(this, true);" 
              onmouseout="ChangeColor(this, false);" 
              >';
}
	?>
...
$mylocation=$rowsact->area_id;   
$query1="SELECT * from nrc_area where area_id='$mylocation'";
$results1=mysql_query($query1) or die ("Error: $query1.".mysql_error());
$rows1=mysql_fetch_object($results1);

//echo $location=$rows1->location_name; 
echo $rowsact->activity.' - - - <font color="#ff0000">'.$location=$rows1->area_name.'</font>';  
...
?>
<img src="images/green.jpg" style="width:<?php echo  $ttl_achieved; ?>px; height:30px; position:relative; margin-top:0px; margin-right:0px;" /><img src="images/blue.jpg" style="width:<?php echo  $target_dif; ?>px; height:30px; position:relative; margin-top:0px; margin-left:0px;" />

<span style="float:right; margin-right:100px;">(<?php echo $ttl_achieved; ?> of <?php echo $real_target;?>)</span>
