...
$queryprof="select * from  salary_expenses_ledger where transactions='$transaction'";
...
header ("Location:add_expenses_opening_balance.php? recordexist=1");
...
$sql= "insert into salary_expenses_ledger values ('','$transaction','$amount','$amount','','6','1',NOW())";
...
header ("Location:add_expenses_opening_balance.php? addconfirm=1");
