...
$sqllpdet="select * from payrol_basic_log where emp_id='$id' AND payment_month='$month_gen'";
...
benefit_log.payrol_basic_log_id=payrol_basic_log.payrol_basic_log_id AND payrol_basic_log.payment_month='$month_gen' AND benefit_log.emp_id='$id'";
...
deduction_logs.payrol_basic_log_id=payrol_basic_log.payrol_basic_log_id AND payrol_basic_log.payment_month='$month_gen' AND deduction_logs.emp_id='$id'";
