...
$queryprod="select products.cat_id,products.pack_size,products.product_name,products.product_id,prod_code,products.pack_size,products.weight,products.reorder_level,products.curr_sp,
...
where products.cat_id=product_categories.cat_id and products.currency_code=currency.curr_id and products.product_id='$product_id' order by product_categories.cat_name";
...
?></td>
	...
	?>
	<option value="<?php echo $rowsprod->cat_id;?>"><?php echo $rowsprod->cat_name;?></option>
  ...
  <tr height="30">
	...
	<?php 
								  ...
								  
								  {
                                    ...
                                    <option value="<?php echo $rows1->pack_size; ?>"><?php echo $rows1->pack_size; ?> </option>
 ...
 echo "<blink ><font color='#ff0000'> Change currency to USD</font></blink>";
  ...
  <tr height="20">
	...
	<select name="currency">
	                  <option value="<?php echo $rowsprod->currency_code; ?>"><?php echo $rowsprod->curr_name; ?></option>
								<?php 
