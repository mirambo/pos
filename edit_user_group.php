...
<form name="new_supplier" action="processeditusergroup.php?user_group_id=<?php echo $id; ?>" method="post">			
...
?></td>
  ...
  <tr height="20">
    ...
    <td width="12%">User Group Name<font color="#FF0000">*</font></td>
    <td width="23%"><input type="text" size="41" name="user_group" value="<?php echo $rows->user_group_name;?>"></td>
    <td width="40%" rowspan="6" valign="top"><div id='new_supplier_errorloc' class='error_strings'></div></td>
  </tr>
  
   <tr height="20">
    <td bgcolor="" width="30%">&nbsp;</td>
    <td width="12%" valign="top">Description<font color="#FF0000"></font></td>
    <td width="23%"><textarea cols="36" rows="4" name="desc"><?php echo $rows->description;?></textarea></td>
