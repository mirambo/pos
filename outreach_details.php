...
?></font></strong></td>
  ...
  <tr height="20">
    ...
    <td bgcolor="" width="15%"><span><?php echo $rows->date_from; ?></span></td>
    <td width="15%">Outreach Date To :</td>
    <td ><span><?php echo $rows->date_to; ?></span></td>
  ...
  <tr height="20">
    ...
    <td><span><?php echo $rows->fac_male; ?></span></td>
    <td>Faculty Member Female:</td>

    <td><span><?php echo $rows->fac_female; ?></span></td>
    </tr>
  <tr height="20">
   <td  colspan="2">Resident Male :</td>
    <td><span><?php echo $rows->res_male; ?></span></td>
    <td>Resident Female</td>
	


    <td><span><?php echo $rows->res_female; ?></span></td>
    </tr>
	<tr height="20">
    <td  colspan="2">Patients Male :</td>
    <td><span><?php echo $rows->pat_male; ?></span></td>
    <td>Patients Female :</td>
    <td><span><?php echo $rows->pat_female; ?></span></td>
    </tr>
	<tr height="20">
    <td  colspan="2">Patient Children :</td>
    <td><span><?php echo $rows->pat_child; ?></span></td>
    <td>Outreach Location :</td>
    <td><span><?php echo $rows->location; ?></span></td>
    </tr>
	...
	<td>Female :</td>
    <td><span><?php echo $rows->glauc_female; ?></span></td>
    <td>Children :</td>
	...
	<td>Female :</td>
    <td><span><?php echo $rows->trauma_female; ?></span></td>
    <td>Children :</td>
	...
	<td>Female :</td>
    <td><span><?php echo $rows->cornea_ulcers_female; ?></span></td>
    <td>Children :</td>
	...
	<td>Female :</td>
    <td><span><?php echo $rows->uveitis_female; ?></span></td>
    <td>Children :</td>
	...
	<td>Female :</td>
    <td><span><?php echo $rows->conjuct_female; ?></span></td>
    <td>Children :</td>
	...
	<td>Female :</td>
    <td><span><?php echo $rows->reflective_error_female; ?></span></td>
    <td>Children :</td>
	...
	<td>Female :</td>
    <td><span><?php echo $rows->squint_female; ?></span></td>
    <td>Children :</td>
	...
	<td>Female :</td>
    <td><span><?php echo $rows->others_female; ?></span></td>
    <td>Children :</td>
	...
	<td>Female :</td>
    <td><span><?php echo $rows->sur_cat_female; ?></span></td>
    <td>Children :</td>
	...
	<td>Female :</td>
    <td><span><?php echo $rows->sur_trauma_rep_female; ?></span></td>
    <td>Children :</td>
	...
	<td>Female :</td>
    <td><span><?php echo $rows->sur_other_female; ?></span></td>
    <td>Children :</td>
    ...
    <td>Bilateral :</td>
    <td><span><?php echo $rows->bilateral; ?></span></td>
    </tr>
    ...
    <td>Female :</td>
    <td><span><?php echo $rows->ref_female; ?></span></td>
    <td>Children :</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="outreach_details_csv.php?outreach_record_id=<?php echo $outreach_id; ?>">Export to Excel</a></td>
    <td>&nbsp;</td>
    <td><a href="outreach_details_word.php?outreach_record_id=<?php echo $outreach_id; ?>">Export to Word</a></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
