...
<form name="new_supplier" action="processedit_subconrate.php?omjobtitle_id=<?php echo $omjobtitle_id; ?>" method="post">			
...
?></td>
  ...
  <td width="19%">Job Title<font color="#FF0000">*</font></td>
	...
	$queryst="select * FROM subcon_rates WHERE omjob_title_id='$omjobtitle_id' AND job_cat_id='2'";
	...
	$queryst="select * FROM subcon_rates WHERE omjob_title_id='$omjobtitle_id' AND job_cat_id='1'";
	$resultsst=mysql_query($queryst) or die ("Error: $queryst.".mysql_error());
	$rowssst=mysql_fetch_object($resultsst);
