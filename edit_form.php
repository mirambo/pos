...
$sqlupdt= "UPDATE shop SET shop_name ='$cat_name',shop_description='$cat_desc' WHERE shop_id='$service_item_id'";
$resultsupdt= mysql_query($sqlupdt) or die ("Error $sqlupdt.".mysql_error());

$sqlauditsav= "insert into audit_trails values('','$user_id',NOW(),'Update shop $cat_name details into the system ')";
$resultsauditsav= mysql_query($sqlauditsav) or die ("Error $sqlauditsav.".mysql_error());
...
function edit_competency($cont_person,$phone,$telephone,$email,$pin,$fax,$street,$building,$address,$town,$user_id)
{
$id=$_GET['contacts_id'];
...
//edit set template
function edit_set_template ($item_name,$reorder_level,$item_value,$item_sp,$item_desc,$user_id)
{
