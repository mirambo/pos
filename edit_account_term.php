...
$sqlx="select * from accounting_terminologies where terminology_id='$id'";
...
<form name="new_user_group" action="processeditterm.php?terminology_id=<?php echo $id; ?>" method="post">			
...
echo '<div align="center" style="background: #FFCC33; height:20px; width:600px; border:#339900 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#339900" >Terminology Updated Successfully!!</font></strong></p></div>';
?>
...
?></td>
  ...
  <tr >
    <td bgcolor="">&nbsp;</td>
    <td width="19%">Major Accounting Terminology</td>
    <td width="23%"><input type="text" size="41" name="accounting_term" value="<?php echo $rowsx->terminology_name;?>"></td>
    <td width="40%" rowspan="2" valign="top"><div id='new_user_group_errorloc' class='error_strings'></div></td>
  </tr>
  <tr height="40">
    <td>&nbsp;</td>
    <td>Description</td>
    <td><textarea name="term_desc" rows="3" cols="36"><?php echo $rowsx->terminology_desc;?></textarea></td>
    </tr>
