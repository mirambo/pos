...
$rows=mysql_fetch_object($results);
    ...
    <td width="400" colspan="8" align="center">
	...
	<strong>Requested By:</strong><?php echo $rows->f_name;?>
	</td>
    </tr>
...
?>
    ...
    <td align="center">Date Issued : <input type="text" autocomplete="off" name="delivery_date" size="20" required id="delivery_date" value="" /><!--Account To Debit
