...
?></th> 
                  <th width="10%"><?php $english_text9="Section";
...
?></th> 				  
                  <th width="5%"><?php $english_text9="Branch";
...
$queryop = "SELECT *,hs_hr_employee.employee_id as employee_number FROM hs_hr_employee WHERE employee_id!='' order by emp_firstname asc";
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>
				  ...
				  <td  ><a href="home.php?add_employee=add_employee&sub_module_id=<?php echo $sub_module_id; ?>&qt=1&employee_id=<?php echo $rows->emp_number; ?>"><?php echo $rows->emp_firstname.' '.$rows->emp_father_name.' '.$rows->emp_lastname.' '.$rows->emp_fourth_name;
...
echo $job_term_name= $query2rowsj['job_term_name'];
	 ...
	 ?></td>
				  <td ><?php
    $dept_id=$rowjob->department;
    $dept="SELECT * FROM departments WHERE Did='$dept_id'";
	$resd=mysql_query($dept) or die(mysql_error());
	$rowdept=mysql_fetch_object($resd);
	
	echo $rowdept->Department;
	 ?>
				   ...
				   <td>
<?php
$section_id=$rowjob->section;
	
    $dept3="SELECT * FROM section WHERE id='$section_id'";
	$resd3=mysql_query($dept3) or die(mysql_error());
	$rowdept3=mysql_fetch_object($resd3);
	
	echo $rowdept3->Section;
	 ?>				   
				  </td>

                  <td width="250">
				  <?php
    $branch_id=$rowjob->branch_id;
    $dept4="SELECT * FROM branch WHERE branch_id='$branch_id'";
	$resd4=mysql_query($dept4) or die(mysql_error());
	$rowdept4=mysql_fetch_object($resd4);
	
	echo $rowdept4->branch_name;
	 ?>
