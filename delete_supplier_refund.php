...
$sql= "delete from supplier_refund where supplier_refund_id='$id'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());

$sql= "delete from supplier_transactions where order_code='srf$id'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());

$sql= "delete from cash_ledger where sales_code='srf$id'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());

$sql= "delete from accounts_payables_ledger where order_code='srf$id'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
header ("Location:view_supplier_refund.php? deleteconfirm=1");
