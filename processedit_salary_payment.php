...
WHERE sales_code='salpmnt$id'";
$resultstranslg=mysql_query($sqltranslg) or die ("Error $sqltranslg.".mysql_error());

$sqltranslg= "UPDATE com_payables_ledger SET 
amount='-$amount',
debit='$amount',
currency_code='$currency',
curr_rate='$curr_rate'

WHERE order_code='salpmnt$id'";
$resultstranslg=mysql_query($sqltranslg) or die ("Error $sqltranslg.".mysql_error());


$sqltranslg= "UPDATE staff_transactions SET 
amount='-$amount',
currency='$currency',
curr_rate='$curr_rate'
...
$sqlauditsav= "insert into audit_trail values('','$user_id',NOW(),'edited Salary payments details')";
$resultsauditsav= mysql_query($sqlauditsav) or die ("Error $sqlauditsav.".mysql_error());



header ("Location:edit_salary_payments.php?salary_payment_id=$id&updateconfirm=1");
