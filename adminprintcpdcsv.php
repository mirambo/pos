...
header("Content-Disposition: attachment;Filename=Post_Graduate_Scholarships_Report.doc");
header("Expires: 0");
header("Cache-Control: must-revalidate, post-check=0, pre-check=0");*/

header("Content-Type: application/vnd.ms-excel");
header("Content-Disposition: attachment;Filename=Continous_Professional_Development(CPD)_Record");
header("Expires: 0");
header("Cache-Control: must-revalidate, post-check=0, pre-check=0");
?>
...
<tr height="40"> <td colspan="11" align="center"><img src="G:/wamp/www/eaco_syst/images/logoeaco.jpg" align="center"></td></tr>
<tr height="40"> <td colspan="11" align="center"><H2>EACO DATA COLLECTION PORTAL</H2></td></tr>
<tr height="40"> <td colspan="11" align="center"><H2>Continous Medical Education (CME) / Continous Professional Development (CPD) Record</H2></td></tr>
...
$rowssponsor=mysql_fetch_object($resultsspons);
  ...
  ?>
  <table width="100%">
	<tr height="60"><td colspan="11"align="right"> <i><strong>Printed by <?php  
...
?> - <?php echo $rowstc->institution_name;  ?></strong></i></td></tr>
 ...
 <?php 
  ...
  <tr><td colspan="11" align="center"><font color="#ff0000"><strong>No Results</strong></font></td></tr>
