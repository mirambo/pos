<?php 
$id=$_GET['id'];
$queryprodcat="select * from  benefit_logs where benefit_log_id='$id'";
...
<form name="new_machine_category" action="processadd_ben_type.php?sub_module_id=<?php echo $sub_module_id; ?>&id=<?php echo $id; ?>" method="post">			
...
?></td>
  ...
  <tr height="30">
    <td bgcolor="">&nbsp;</td>
    <td width="19%">Allowance Name<font color="#FF0000">*</font></td>
    <td width="23%"><input type="text" size="41" name="station_name" required value="<?php echo $rowsprodcat->benefit_log_name;?>"></td>
    ...
    <td width="23%"><input type="number" size="41" name="sort_order" placeholder="e.g. 1,2,3 etc" value="<?php echo $rowsprodcat->sort_order;?>"></td>
	  </tr>
  
  <tr height="30">
    <td>&nbsp;</td>
    <td>Amount<font color="#FF0000">*</font></td>
    <td width="23%"><input type="text" size="41" name="default_ben_amount" value="<?php echo $rowsprodcat->default_benefit_amount;?>"></td>
	  </tr>
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("station_name","req",">>Please enter benefit name");
frmvalidator.addValidation("default_ben_amount","req",">>Please enter default amount");
