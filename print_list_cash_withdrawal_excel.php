...
header("Content-Disposition: attachment;Filename=Cash_Withdrawl.xls");
header("Expires: 0");
...
<H5>Cash Withdrawal Report</H5>
 ...
 <tr  style="background:url(images/description.gif);" height="30" >
   ...
   <td align="center" ><strong>Slip Number</strong></td>
    ...
    <td align="center" ><strong>Bank Withdrawn</strong></td>
	<td align="center" ><strong>Person Withdrew</strong></td>
...
$sql="SELECT * FROM banks,cash_withdrawal,currency where cash_withdrawal.bank_withdrawn=banks.bank_id AND currency.curr_id=cash_withdrawal.curr_id order by cash_withdrawal.cash_withdrawal_id desc";
