...
<?php require_once('includes/invoicessubmenu.php');  ?>
		...
		<h3>::List of All Cancelled Invoices Generated</h3>
...
AND sales_code.status='1' order by sales_code.sales_code_id desc";
...
$sql="select sales_code.invoice_no,sales_code.sales_code_id,sales_code.invoice_no,
sales_code.date_generated,sales_code.user_id,clients.c_name FROM clients,sales_code WHERE sales_code.client_id=clients.client_id 
AND sales_code.status='1' AND sales_code.client_id='$client' order by sales_code.sales_code_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
...
$sql="select sales_code.invoice_no,sales_code.sales_code_id,sales_code.invoice_no,
sales_code.date_generated,sales_code.user_id,clients.c_name FROM clients,sales_code WHERE sales_code.client_id=clients.client_id 
AND sales_code.status='1' AND sales_code.date_generated BETWEEN '$date_from' AND '$date_to' order by sales_code.sales_code_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
elseif($client!='0' && $date_from!='' && $date_to!='')
{
...
$sql="select sales_code.invoice_no,sales_code.sales_code_id,sales_code.invoice_no,
sales_code.date_generated,sales_code.user_id,clients.c_name FROM clients,sales_code WHERE sales_code.client_id=clients.client_id 
AND sales_code.status='1' AND sales_code.client_id='$client' AND sales_code.date_generated BETWEEN '$date_from' AND '$date_to' order by sales_code.sales_code_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
AND sales_code.status='1' and sales_code.user_id=users.user_id AND users.shop_id='$shop_id' order by sales_code.sales_code_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
$sql="select sales_code.invoice_no,sales_code.user_id,sales_code.sales_code_id,sales_code.invoice_no,
sales_code.date_generated,clients.c_name FROM clients,sales_code,users WHERE sales_code.client_id=clients.client_id 
AND sales_code.status='1' and sales_code.user_id=users.user_id AND users.shop_id='$shop_id' AND sales_code.client_id='$client' order by sales_code.sales_code_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
elseif($client=='0' && $date_from!='' && $date_to!='')
{
...
$sql="select sales_code.invoice_no,sales_code.user_id,sales_code.sales_code_id,sales_code.invoice_no,
sales_code.date_generated,clients.c_name FROM clients,sales_code,users WHERE sales_code.client_id=clients.client_id 
AND sales_code.status='1' and sales_code.user_id=users.user_id AND users.shop_id='$shop_id' AND sales_code.date_generated BETWEEN '$date_from' AND '$date_to' order by sales_code.sales_code_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
elseif($client!='0' && $date_from!='' && $date_to!='')
{
...
$sql="select sales_code.invoice_no,sales_code.user_id,sales_code.sales_code_id,sales_code.invoice_no,
sales_code.date_generated,clients.c_name FROM clients,sales_code,users WHERE sales_code.client_id=clients.client_id 
AND sales_code.status='1' and sales_code.user_id=users.user_id AND users.shop_id='$shop_id' AND sales_code.client_id='$client' AND sales_code.date_generated BETWEEN '$date_from' AND '$date_to' order by sales_code.sales_code_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
?></strong></td>
	...
	<a href="view_sales_trans.php?sales_code_id=<?php echo $rows->sales_code_id;?>">View Details</a>
	...
	<a href="cancel_invoice_reason.php?sales_code_id=<?php echo $rows->sales_code_id;?>&grndttl=<?php echo $amount; ?>" onClick="return confirmCancel();"><img src="images/dissaprove.png"></a>
