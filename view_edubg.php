...
<form name="emp" id="emp" action="processeditedubg.php?emp_id=<?php echo $emp_id; ?>" method="post">			
...
$sql="SELECT * FROM education_description WHERE emp_id='$emp_id'";
...
echo $rowslatelpo->emp_fname.' '.$rowslatelpo->emp_mname.' '.$rowslatelpo->emp_lname;
    ...
    <td valign="top" width="15%">Describe Education Background<font color="#FF0000">*</font></td>
    <td><textarea name="edu_desc" rows="8" cols="55"><?php echo $rows->education_description;?></textarea>
