...
<form name="emp" id="emp" action="processadminaddoutreach.php?original_bunch_id=<?php echo $original_bunch_id;?>&period_to=<?php echo $period_to; ?>" method="post">			
...
?></td>
	...
	<tr height="20">
    <td bgcolor="">&nbsp;</td>
    <td width="10%">Select Block<font color="#FF0000">*</font></td>
    <td width="15%">
...
else
{
 ?>
	<option>Select..................................</option>
								  ...
								  $queryinst2="SELECT * FROM clients where status='0' order by c_name asc";
								  ...
								  
								  {
                                    ...
                                    <option value="<?php echo $rowsinst2->client_id; ?>"><?php echo $rowsinst2->c_name; ?> </option>
  ...
  <tr height="20">
    <td bgcolor="">&nbsp;</td>
    <td width="19%">Select Project Manager<font color="#FF0000">*</font></td>
    <td width="23%">
	<select name="emp_id">	
...
if($original_bunch_id!='')
{?>
<option value="<?php echo $rowsinstb->emp_id; ?>"><?php echo $rowsinstb->emp_fname.' '.$rowsinstb->emp_mname.' '.$rowsinstb->emp_lname; ?></option>
<?php 

$queryinst3="SELECT * FROM employees where work_place!='1' order by emp_fname asc";
								  $resultsinst3=mysql_query($queryinst3) or die ("Error: $queryinst3.".mysql_error());
								  
								  if (mysql_num_rows($resultsinst3)>0)
								  
								  {
									  while ($rowsinst3=mysql_fetch_object($resultsinst3))
									  
									  { ?>
										  
                                    <option value="<?php echo $rowsinst3->emp_id; ?>"><?php echo $rowsinst3->emp_fname.' '.$rowsinst3->emp_mname.' '.$rowsinst3->emp_lname;?></option>
	...
	<option>Select..................................</option>
								  ...
								  $queryinst3="SELECT * FROM employees order by emp_fname asc";
								  $resultsinst3=mysql_query($queryinst3) or die ("Error: $queryinst3.".mysql_error());
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.EnableOnPageErrorDisplaySingleBox();
 frmvalidator.EnableMsgsTogether();
 frmvalidator.addValidation("block_id","dontselect=0",">>Please select block");
 frmvalidator.addValidation("client_id","dontselect=0",">>Please select client");
 frmvalidator.addValidation("emp_id","dontselect=0",">>Please select project manager");
 frmvalidator.addValidation("period_from","req",">>Please enter period from");
 frmvalidator.addValidation("period_to","req",">>Please enter period to");
</script>
