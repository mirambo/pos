...
?>
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
    ...
    <td align="center" width="70"><strong>Work Permit No</strong></td>
...
$sql="select employees.emp_fname,employees.emp_lname,employees.emp_mname, employees.employee_no,staff_work_permit.work_permit_no,employees.title,employees.nationality,
 staff_work_permit.issue_date,staff_work_permit.work_permit_id,staff_work_permit.exp_date,staff_work_permit.status,staff_work_permit.emp_id from employees,staff_work_permit WHERE employees.emp_id=staff_work_permit.emp_id order by employees.emp_fname asc";
...
$sqlrn="select *  from renewed_staff_work_permit where emp_id='$emp_id' order by date_recorded desc limit 1";
...
{
	?>
	<a href="home.php?reneworkpermit2=reneworkpermit2&work_permit_id=<?php echo $rows->work_permit_id; ?>&emp_id=<?php echo $rows->emp_id;?>"><img src="images/renew.png"></a>
	<?php
	}
	else
{
