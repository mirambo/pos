...
<body>
	...
	<div id="page-wrap">
		...
		<?php require_once('includes/proforma_submenu.php');  ?>
...
<form name="start_order" action="process_proforma_invoice.php" method="post">	
<?php 
if ($sales_id!=0)
{
include('view_proforma_details.php');
?>
...
<h3 align="center">Enter Proforma Invoice Details</h3>
