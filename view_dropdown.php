...
?>
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
	...
	<td align="center" width="100"><strong>Drop down Choice</strong></td>
...
$sql="SELECT drop_down.dropdown_name,form_fields.form_field_name from drop_down,form_fields where drop_down.form_field_id=form_fields.form_field_id ";
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>
    ...
    <td ><?php echo $rows->dropdown_name;?></td>
	<td align="center"><a href="home.php?editformsections=editformsections&form_section_id=<?php echo $rows->form_section_id; ?>"><img src="images/edit.png"></a></td>
