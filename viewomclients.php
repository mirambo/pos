...
<tr bgcolor="#FFFFCC">
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
	...
	<td align="center" width="150"><strong>Town</strong></td>
	<td align="center" width="150"><strong>Physical Address</strong></td>
    <td width="180" align="center"><strong>Telephone No.</strong></td>
    <td width="180" align="center"><strong>Email</strong></td>
	<td width="180" align="center"><strong>Contact Person</strong></td>
...
$sql="SELECT * FROM omclients order by omclients.c_name asc";
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>
	...
	<td align="center" width="50"><a href="home.php?editsubspeciality=editsubspeciality&client_id=<?php echo $rows->client_id; ?>"><img src="images/edit.png"></a></td>
	<td align="center" width="50"><a href="delete_subspeciality.php?client_id=<?php echo $rows->client_id; ?>" onClick="return confirmDelete();"><img src="images/delete.png"></td>
    </tr>
  <?php 
