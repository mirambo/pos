...
<form name="emp" id="emp" action="processaddgenairticket.php" method="post">			
...
?></td>
  ...
  <tr height="20">
	...
	<td colspan="4" ><h3>General Air Ticket and Flight Details</h3></td>
    
    <td>&nbsp;</td>
    </tr>
  <tr height="20">
    
    <td width="12%">Enter Person Full Name<font color="#FF0000">*</font></td>
	
    <td bgcolor="" width="20%"><input type="text" size="41" name="full_name">
	</td>
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("full_name","req",">>Please enter full name");
