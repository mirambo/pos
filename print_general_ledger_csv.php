...
$rowscont=mysql_fetch_object($resultscont);*/
  ...
  <tr height="30">
    <td colspan="6" bgcolor="#67C6FE" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">GENERAL LEDGER</span>
...
$rowscont=mysql_fetch_object($resultscont);*/
  ...
  <tr>
    <td colspan="6"><div align="center"><h2>SIPET ENGINEERING & CONSULTANCY SERVICES CO. LIMITED</h2><br/>
	Plot 257, Tong Ping Area, Juba, South Sudan<br/>
	Tel No: +211 (0) 911112662 / +211(0)959 0012273<br/>
	</div>
...
$grnd_amount_out_kshs=0; 
$sql="select  general_ledger.transaction_id,general_ledger.transactions,general_ledger.amount,general_ledger.debit,general_ledger.credit,general_ledger.currency_code,general_ledger.curr_rate,general_ledger.date_recorded, currency.curr_initials 
from general_ledger,currency where general_ledger.currency_code=currency.curr_id and general_ledger.date_recorded BETWEEN '$date_from' AND '$date_to' order by general_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
if ($currency_code==2)
 ...
 <tr>
    <td colspan="6" align="right"><strong><em>Printed by :
         <?php 
