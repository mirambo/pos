...
header("Content-Disposition: attachment;Filename=Fixed_Assets_Ledger.doc");
header("Expires: 0");
...
<tr>
  ...
  <tr height="30">
    <td colspan="7" bgcolor="#000033" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">FIXED ASSETS LEDGER</span>
...
$sql="select  fixed_assets_ledger.transaction_id,fixed_assets_ledger.transactions,fixed_assets_ledger.amount,fixed_assets_ledger.debit,fixed_assets_ledger.credit,fixed_assets_ledger.currency_code,fixed_assets_ledger.curr_rate,fixed_assets_ledger.date_recorded, currency.curr_name 
from fixed_assets_ledger,currency where fixed_assets_ledger.currency_code=currency.curr_id order by fixed_assets_ledger.transaction_id asc";
...
$grnd_amount_out_kshs=0; 
$sql="select  fixed_assets_ledger.transaction_id,fixed_assets_ledger.transactions,fixed_assets_ledger.amount,fixed_assets_ledger.debit,fixed_assets_ledger.credit,fixed_assets_ledger.currency_code,fixed_assets_ledger.curr_rate,fixed_assets_ledger.date_recorded, currency.curr_name 
from fixed_assets_ledger,currency where fixed_assets_ledger.currency_code=currency.curr_id AND date_recorded BETWEEN '$date_from' AND '$date_to' order by fixed_assets_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
