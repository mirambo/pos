...
<?php require_once('includes/loanrecsubmenu.php');  ?>
		...
		<h3>::List Of All Loan Repayment Transactions</h3>
...
?>
	...
	<tr bgcolor="#FFFFCC">
	<td colspan="11" align="center"><strong>Search : By Lender Name:</strong>
	<select name="client">
...
<strong>Or By Date</strong>
	...
	<a target="_blank" style="float:right; margin-right:100px; font-weight:bold; font-size:13px; color:#000000" href="print_list_loan_repayment.php">Print</a>						  
<a  style="float:right; margin-right:50px; font-weight:bold; font-size:13px; color:#000000" href="print_list_loan_repayment_excel.php">Export To Excel</a>						  
...
else
{
	...
	<td align="center"><a href="edit_loan_repayments.php?loan_repayment_id=<?php echo $rows->loan_repayment_id;?>"><img src="images/edit.png"></a></td>
    <td align="center"><a href="delete_loan_repayment.php?loan_repayment_id=<?php echo $rows->loan_repayment_id;?>"  onClick="return confirmDelete();"><img src="images/delete.png"></a></td>
