...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
	...
	<a href="print_general_ledger.php" target="_blank"><img src="images/print_icon.gif" title="Print"></a> &nbsp; 
<a href="print_general_ledger_csv.php"><img src="images/excel.png" title="Export to Excell"></a> &nbsp; 
<a href="print_general_ledger_word.php"><img src="images/word.png" title="Export to Word"></a>
...
$sql="select  general_ledger.transaction_id,general_ledger.transactions,general_ledger.amount,general_ledger.debit,general_ledger.credit,general_ledger.currency_code,general_ledger.curr_rate,general_ledger.date_recorded, currency.curr_initials 
from general_ledger,currency where general_ledger.currency_code=currency.curr_id order by general_ledger.transaction_id asc";
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
    ...
    <td colspan="9" height="30" align="right"><font size="+1">
<a href="print_general_ledger.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to;?>" target="_blank"><img src="images/print_icon.gif" title="Print"></a> &nbsp; 
<a href="print_general_ledger_csv.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to;?>"><img src="images/excel.png" title="Export to Excell"></a> &nbsp; 
<a href="print_general_ledger_word.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to;?>"><img src="images/word.png" title="Export to Word"></a>
...
$grnd_amount_out_kshs=0; 
$sql="select  general_ledger.transaction_id,general_ledger.transactions,general_ledger.amount,general_ledger.debit,general_ledger.credit,general_ledger.currency_code,general_ledger.curr_rate,general_ledger.date_recorded, currency.curr_initials 
from general_ledger,currency where general_ledger.currency_code=currency.curr_id AND date_recorded BETWEEN '$date_from' AND '$date_to' order by general_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
