...
$client=$_POST['client'];
	...
	<a href="print_invoices.php?client=<?php echo $client;?>&date_from=<?php echo $date_from;  ?>&date_to=<?php echo $date_to ?>" title="Export To Word"><img src="images/word.png" style="margin-right:30px;"/> </a>
