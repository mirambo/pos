...
quotations.client_id=clients.client_id AND quotations.status='2'  order by quotations.quotation_id desc";
...
{
$sql="select quotations.currency_code,quotations.quotation_id,quotations.quotation_no,quotations.user_id,clients.client_id ,clients.c_name,quotations.date_generated,quotations.quote_code from quotations,clients where 
quotations.client_id=clients.client_id AND quotations.status='2' and quotations.client_id='$client'  order by quotations.quotation_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
{
$sql="select quotations.currency_code,quotations.quotation_id,quotations.quotation_no,quotations.user_id,clients.client_id ,clients.c_name,quotations.date_generated,quotations.quote_code from quotations,clients where 
quotations.client_id=clients.client_id AND quotations.status='2' and quotations.date_generated BETWEEN '$date_from' AND '$date_to'  order by quotations.quotation_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
elseif($client!='0' && $date_from!='' && $date_to!='')
{
$sql="select quotations.currency_code,quotations.quotation_id,quotations.quotation_no,quotations.user_id,clients.client_id ,clients.c_name,quotations.date_generated,quotations.quote_code from quotations,clients where 
quotations.client_id=clients.client_id AND quotations.status='2' and quotations.date_generated BETWEEN '$date_from' AND '$date_to' and quotations.client_id='$client' order by quotations.quotation_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
else
{
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>
	...
	<td align="center">
	<?php
$quote_code=$rows->quote_code;
$sqlres="select reasons from cancelled_quotations where quote_code='$quote_code'";
$resultsres= mysql_query($sqlres) or die ("Error $sqlres.".mysql_error());
$rowsres=mysql_fetch_object($resultsres);
echo $reason=$rowsres->reasons;
