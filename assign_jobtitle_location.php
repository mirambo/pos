...
<form name="new_supplier" action="process_assign_jobtitle_location.php" method="post">			
...
?></td>
	...
	<tr height="20">
    <td>&nbsp;</td>
    <td>Select O&M Job Title<font color="#FF0000">*</font></td>
    <td><select name="omjob_title_id">
	<option value="0">Select..................................</option>
								  <?php
								  
								  $query1="select * from omjob_titles WHERE status='0' order by omjob_title_name asc";
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("omjob_title_id","dontselect=0",">>Please select job title");
 frmvalidator.addValidation("omlocation_id","dontselect=0",">>Please select location");
