...
$sql="select * from nrc_cc where cc_id='$cc_id'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
$rows=mysql_fetch_object($results);


?>
<form name="new_machine_category" action="process_edit_set_template_cc.php" method="post">			
...
?></td>
  ...
  <tr style="background:url(images/description.gif);" height="20" align="center">
	<td width="100">Select Core Competency</td>
	...
	<select name="cc_id"><option value="<?php echo $cc_id?>"><?php echo $rows->cc_code.' - '.$rows->cc_name;?></option>	
								  <?php
