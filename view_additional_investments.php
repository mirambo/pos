...
?>
	...
	<tr bgcolor="#FFFFCC">
	<td colspan="11" align="center"><strong>Search : By Shareholder Name:</strong>
	<select name="client">
	<option value="0">-------------------Select-----------------</option>
								  <?php
								  
								  $query1="select * from shares order by share_holder_name";
...
<strong>Or By Date</strong>
		...
		<input type="text" name="to" size="25" id="to" readonly="readonly" />
			<input type="submit" name="generate" value="Generate">
				...
				<a target="_blank" style="float:right; margin-right:100px; font-weight:bold; font-size:13px; color:#000000" href="print_list_additional_inv.php">Print</a>						  
<a  style="float:right; margin-right:50px; font-weight:bold; font-size:13px; color:#000000" href="print_list_additional_inv_excel.php">Export To Excel</a>						  
...
else
{
	...
	<td align="center"><a href="edit_additional_investments.php?additional_investments_id=<?php echo $rows->additional_investments_id;?>"><img src="images/edit.png"></a></td>
    <td align="center"><a href="delete_additional_investments.php?additional_investments_id=<?php echo $rows->additional_investments_id;?>"  onClick="return confirmDelete();"><img src="images/delete.png"></a></td>
