...
$sqlpd="select * from payroll where payroll_id='$payroll_id'";
$resultspd= mysql_query($sqlpd) or die ("Error $sqlpd.".mysql_error());
$rowspd=mysql_fetch_object($resultspd);
//$userid=$rowsuser->emp_id;

$id=$rowspd->emp_id;	
$current_month=$rowspd->payment_month;
//$current_month=$rowspd->payment_month;
...
$rowsnt=mysql_fetch_object($resultsnt);
 $net_sal=$rowsnt->net_pay;
 $id2=$rowsnt->payroll_id;
...
<div id="zone-bar" class="br-5">
		...
		<h3>:: Approve Pay Details for Employee : 
...
<form name="emp" id="emp" action="process_approve_payslip.php?employee_id=<?php echo $id;  ?>" method="post">
...
?></td>
  ...
  <tr height="25" bgcolor="#FFFFCC">
    <td width="5%">&nbsp;</td>
    <td width="1%">Basic Salary<font color="#FF0000"></font></td>
  ...
  <tr height="25" bgcolor="#FFFFCC">
    <td width="5%">&nbsp;</td>
    <td width="20%"><!--Unpaid Balance--><font color="#FF0000"></font></td>
	<td width="10%"><?php //echo number_format($unpaid_bal=$ttl_staff_bal,2);?>
	<input type="hidden" size="41" name="unpaid_bal" value="<?php //echo $ttl_staff_bal;?>">
	</td>	
	<td width="17%"></td>	
    <td bgcolor="" colspan="5">  
  ...
  <tr height="30" bgcolor="#FFFFCC">
	...
	<?php echo number_format($gross_pay=$basic_sal+$ttl_comm+$unpaid_bal,2); ?>
	...
	<td>&nbsp;</td>
	<td colspan="6" ><h4>Benefits Or Allowances</i> <a rel="facebox" href="add_benefit.php?emp_id=<?php echo $id ?>&current_month=<?php echo $current_month; ?>&payroll_id=<?php echo $payroll_id ?>&approve=1" style="margin-left:310px;">[Click here to add a benefit or allowance]</a></h4></td>
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>			  
	...
	<td colspan="5">[<a rel="facebox" href="edit_benefit.php?benefit_id=<?php echo $rows->benefit_id?>&emp_id=<?php echo $id ?>&current_month=<?php echo $current_month; ?>&payroll_id=<?php echo $payroll_id ?>&approve=1">Edit</a>] 
	[<a onClick="return confirmDeleteBenefit();" href="delete_benefit.php?benefit_id=<?php echo $rows->benefit_id?>&emp_id=<?php echo $id ?>&current_month=<?php echo $current_month; ?>&payroll_id=<?php echo $payroll_id ?>&approve=1">Delete</a>]</td>						  
...
<strong>
	...
	<td>&nbsp;</td>
	<td colspan="6" ><h4>Other Deductions eg. NHIF,NSSF, P.A.Y.E</i> <a rel="facebox" href="add_deduction.php?emp_id=<?php echo $id ?>&current_month=<?php echo $current_month; ?>&payroll_id=<?php echo $payroll_id ?>&approve=1 style="margin-left:170px;">[Click here to add other deductions]</a></h4></td>
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>			  
	...
	<td colspan="5">[<a rel="facebox" href="edit_deduction.php?deduction_id=<?php echo $rowsded->deduction_id?>&emp_id=<?php echo $id ?>&current_month=<?php echo $current_month; ?>&payroll_id=<?php echo $payroll_id ?>&approve=1">Edit</a>]
	
	[<a onClick="return confirmDeleteDeduction();" href="delete_deduction.php?deduction_id=<?php echo $rowsded->deduction_id?>&emp_id=<?php echo $id ?>&current_month=<?php echo $current_month; ?>&payroll_id=<?php echo $payroll_id ?>&approve=1">Delete</a>]</td>							  
...
$ttl_ded=$ttl_ded+$deduction_amount;
	...
	<td colspan="5">
<strong>
	<?php echo number_format($grnd_ded=$ttl_ded+$adv_amount_paid,2); ?>
	...
	<td ></td>
	<td colspan="8">
	<strong><font size="+1">Net Pay: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></strong><font size="+1"color="#ff0000"><strong><?php echo number_format($net_pay=$gross_pay+$ttl_benefits-$grnd_ded-$advance,2); ?></strong></font>
	...
	<td>&nbsp;</td>
	<td colspan="5" align="left"><input type="submit" name="submit" value="Approve Payroll And Print Payslip">&nbsp;&nbsp;<input type="reset" value="Cancel"></td>
