...
WHERE nrc_set_template.location_id=$location_id AND nrc_set_template.cc_id=$cc_id and nrc_project.project_id=$project_id AND nrc_project.status=2
...
INNER JOIN nrc_sub_project ON nrc_sub_project.sub_project_id = nrc_set_template.sub_project_id
INNER JOIN nrc_project ON nrc_project.project_id=nrc_set_template.project_id
WHERE nrc_set_template.location_id = $location_id and nrc_project.status=2
GROUP BY nrc_sub_project.sub_project_id
...
INNER JOIN nrc_sub_project ON nrc_sub_project.sub_project_id=nrc_set_template.sub_project_id
INNER JOIN nrc_project ON nrc_project.project_id=nrc_set_template.project_id
WHERE nrc_set_template.location_id=$location_id AND nrc_set_template.cc_id=$cc_id and nrc_project.status=2  GROUP BY nrc_sub_project.sub_project_id  ORDER BY nrc_sub_project.sub_project_id
";
$resultssp=mysql_query($sqlsp) or die ("Error $sqlsp.".mysql_error());
...
WHERE nrc_set_template.location_id=$location_id and nrc_project.project_id=$project_id AND nrc_project.status=2
GROUP BY nrc_sub_project.sub_project_id  ORDER BY nrc_sub_project.sub_project_id";
$resultssp=mysql_query($sqlsp) or die ("Error $sqlsp.".mysql_error());
...
WHERE nrc_set_template.location_id=$location_id AND nrc_set_template.cc_id=$cc_id  AND nrc_project.status=2
GROUP BY nrc_sub_project.sub_project_id  ORDER BY nrc_sub_project.sub_project_id";
$resultssp=mysql_query($sqlsp) or die ("Error $sqlsp.".mysql_error());
