...
header ("Location:cash_receiptword.php?cash_received=$cash_rec&receipt_no=$receipt_no&receipt_id=$latest_cash_payment_id&sales_code=$latest_sales_code&client_id=$get_prnt_client_id&curr_id=$get_prnt_currency");
//}
