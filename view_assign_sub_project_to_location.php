						...
						if (mysql_num_rows($resultslpdet) > 0)
						  {
							  ...
							  {?>
						<tr>
						<td><?php echo $task_name=$rowslpdet->task_name;?><input type="hidden" name="task_id[]" value="<?php echo $rowslpdet->task_id; ?>">
						
<input type="hidden" name="task_name[]" value="<?php echo $rowslpdet->task_name; ?>">						</td>
						<td><?php echo number_format($task_cost=$rowslpdet->task_cost,2);?><input type="hidden" name="task_cost[]" value="<?php echo $task_cost; ?>"></td>
