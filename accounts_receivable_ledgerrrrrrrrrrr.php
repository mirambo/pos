...
?>
   ...
   <tr style="background:url(images/description.gif);" height="30" >
	...
	<td width="70"><div align="center"><strong>Transaction Details</strong></td>
	<td width="400"><div align="center"><strong>Amount(Other Currencies)</strong></td>
...
$sql="select invoices.invoice_id,invoices.invoice_no,invoices.curr_rate,invoices.date_generated,invoices.invoice_ttl,invoices.sales_code,invoices.sales_rep,
currency.curr_name,clients.c_name from invoices,clients,currency where invoices.client_id=clients.client_id AND invoices.currency_code=currency.curr_id order by invoices.date_generated desc";
