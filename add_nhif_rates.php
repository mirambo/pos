...
<form name="new_supplier" action="processaddnhif.php" method="post">			
...
echo '<div align="center" style="background: #FFCC33; height:20px; width:400px; border:#ff0000 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#ff0000" >SIC Record Created Successfully!!</font></strong></p></div>';
?>
...
?></td>
 ...
 <!--<tr height="20">
  ...
  <tr height="20">
    ...
    <td width="15%"><input type="text" size="41" name="amount"></td>
