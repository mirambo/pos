...
temp_sales.discount_perc,temp_sales.discount_value,temp_sales.sales_code,products.product_name,products.pack_size,currency.curr_name from temp_sales, products,currency where 
