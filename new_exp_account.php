...
<form name="new_machine_category" action="process_add_more_exp_acc.php?type=<?php echo $type; ?>" method="post">			
...
?></td>
	...
	<td colspan="2"><strong>Record Details</strong></td>  
  </tr>
 <tr style="background:url(images/description.gif);" height="20" >
	<td width="100" align="right"><strong>EXpenses Account : </strong></td>
  ...
  <tr height="40">
    <td align="center" colspan="2"><input type="submit" name="submit" onClick="return confirmAdd()" value="Save Task Details"></td>    
  </tr>
