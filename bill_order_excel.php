...
header("Content-Disposition: attachment;Filename=Bill_Order_No-$lpo_no.xls");
header("Expires: 0");
...
$rowscont=mysql_fetch_object($resultscont);
 ...
 <td colspan="6" align="right"><?php echo $rowscont->cont_person?></td>
  ...
  <tr height="30">
    <td colspan="7" bgcolor="#000033" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">RECEIVE ITEM WITH BILL</span></td>
  </tr>
   
   <tr height="30">
    <td colspan="4"  align="left"><strong>BILL ORDER NO :  <?php 
	echo $lpo_no;
