...
header ("Location:word_invoice.php?invoice_id=$latest_invoice_id&sales_code=$latest_sales_code&client_id=$get_prnt_client_id&currency=$get_prnt_currency&cash_rec=$cash_rec&mop=$mop&invoice_no=$invoice_no&sales_rep=$sess_sales_rep");
