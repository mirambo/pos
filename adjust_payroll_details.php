...
<form name="emp" id="emp" action="process_approve_payslip.php?employee_id=<?php echo $id;  ?>" method="post">
 ...
 <tr height="20" bgcolor="#FFFFCC" style="display:none;">
    <td width="10%">&nbsp;</td>
...
?></td>
  ...
  <tr height="25" bgcolor="#FFFFCC" style="display:none;">
    <td width="50%">&nbsp;</td>
  ...
  <tr height="30" bgcolor="#FFFFCC">
	<td></td>
	<td><strong>Consolidated Payment: </strong></td>
	<td colspan="5"><strong>
...
<strong>
	...
	<td>&nbsp;</td>
	<td colspan="6" ><h4>Other Deductions eg. Days Off etc</i> <a rel="facebox" href="add_deduction.php?emp_id=<?php echo $id ?>&current_month=<?php echo $current_month; ?>&payroll_id=<?php echo $payroll_id ?> style="margin-left:170px;">[Click here to add other deductions]</a></h4></td>
...
$amnt_repaid=$install;
	...
	?>
	<input type="hidden" size="41" name="advance" value="<?php echo $amnt_repaid;?> ">
...
$ttl_ded=$ttl_ded+$deduction_amount;
	...
	<td colspan="5">
<strong>
	<?php echo number_format($grnd_ded=$ttl_ded+$amnt_repaid,2); ?>
	...
	<td>&nbsp;</td>
	<td colspan="5" align="left"><input type="submit" name="submit" value="Go to the next Employee>>">&nbsp;&nbsp;<a style="width:400px; color:#ffffff; font-weight:bold; background:#ff0000; padding:5px; border-radius:5px;" href="adjust_payroll_details.php?payroll_id=<?php echo $payroll_id-1;?>">Go Back</a></td>
