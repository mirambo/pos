...
$sql="select * from account where account_type_id='10' or account_type_id='2'";
...
//$numrowsprof=mysql_num_rows($resultsprof); 
  ...
  if (mysql_num_rows($results) > 0)
              ...
              onmouseout="ChangeColor(this, false);">
							 ...
							 <td width="30%" align="right" onClick="document.location.href='view_ledger.php?account_id=<?php echo $account_id=$rows->account_id;?>&report_date_id=<?php echo $report_date_id;?>'">
							 <?php
include ('bl_assets_balance.php');
...
/* 	$amount=$rows->amount;
 ...
 <td align="right"><strong><span style="float:right; margin-right:0px; font-size:16px;"><?php echo number_format($asset_bal,2); ?></span></strong></td>
