...
and ".$db_table.".amount!='0'  order by ".$db_table.".date_recorded asc";
...
$sql="select * from ".$db_table.",currency where ".$db_table.".currency_code=currency.curr_id AND ".$db_table.".amount!='' 
and ".$db_table.".amount!='0' AND ".$db_table.".date_recorded>='$date_from' and date_recorded<='$date_to' order by ".$db_table.".date_recorded asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
