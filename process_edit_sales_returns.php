...
where sales_returns_id='$order_code'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());



$sql= "update sales_returns_items set 
 	shop_id='$shop_id'
...
$sqlauditsav= "insert into audit_trail values('','$user_id',NOW(),'Updated an Sales Returns transaction trasaction')";
