...
<?php require_once('includes/sales_return_submenu.php');  ?>
		...
		<h3>::List of All Generated Sales Returns </h3>
...
?>
	...
	<tr bgcolor="#FFFFCC">
	<td colspan="10" align="center"><strong>Search Credit Note : By Customer Name:</strong>
...
<a target="_blank" style="float:right; margin-right:200px; font-weight:bold; font-size:13px; color:#000000" href="print_list_PR.php">Print</a>						  
   ...
   <tr style="background:url(images/description.gif);" height="30" >
    <td width="200"><div align="center"><strong>Credit Note Number</strong></td>
    <td width="300"><div align="center"><strong>Date Generated</strong></td>
	<td width="20%"><div align="center"><strong>Customer Name</strong></td>
...
$sql="select * FROM mop,currency,customer,sales_returns WHERE sales_returns.mop_id=mop.mop_id AND 
sales_returns.currency=currency.curr_id AND sales_returns.customer_id=customer.customer_id order by sales_returns.sales_returns_id desc";
...
{
$sql="select * FROM mop,currency,customer,sales_returns WHERE sales_returns.mop_id=mop.mop_id AND 
sales_returns.currency=currency.curr_id AND sales_returns.customer_id=customer.customer_id AND sales_returns.customer_id='$supplier' order 
by sales_returns.sales_returns_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
elseif($supplier=='0' && $date_from!='' && $date_to!='')
{
$sql="select * FROM mop,currency,customer,sales_returns WHERE sales_returns.mop_id=mop.mop_id AND 
sales_returns.currency=currency.curr_id AND sales_returns.customer_id=customer.customer_id AND sales_returns.date_generated BETWEEN '$date_from' AND '$date_to' order 
by sales_returns.sales_returns_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
sales_returns.date_generated BETWEEN '$date_from' AND '$date_to' AND sales_returns.customer_id='$supplier' order 
by sales_returns.sales_returns_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
$order_code=$rows->sales_returns_id;

 ?>
  
    <td><?php echo $rows->credit_note_no;?></td>
    <td align="center"><?php echo $rows->date_generated;?></td>
	<td><?php echo $rows->customer_name;?></td>
	<td align="right">
	<?php
	echo $rows->curr_name.' ';
	include ('sr_value.php');
	...
	?></strong></td>
	<td align="center"><a href="generate_sales_returns.php?order_code=<?php echo $order_code;?>">View Transactions</a></td>
