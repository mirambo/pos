...
$sql= "DELETE  FROM temp_cash_sales where temp_cash_sales_id='$id'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());

$sql1= "DELETE FROM cash_sales where temp_cash_sales_id='$id'";
$results1= mysql_query($sql1) or die ("Error $sql1.".mysql_error());


$sqlauditsav= "insert into audit_trail values('','$user_id',NOW(),'Deleted cash sales transaction')";
