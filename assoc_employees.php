...
<form name="form1" method="post" action="">	
	<div id="page-wrap">
		...
		<h3>:: Add Employees Allowances And Deductions</h3>
...
?> </span>
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
    ...
    <td align="center"><strong>Employee Status</strong></td>
	<td align="center"><strong>Process Payslip</strong></td>
    <!--<td width="150" align="center"><strong>View Pay Details</strong></td>-->
...
echo '<tr bgcolor="#FFFFCC" height="25"  onmouseover="ChangeColor(this, true);" 
 ...
 ?>
    ...
    <td align="center" ><?php echo $rows->employee_no;?></td>
    <td ><?php echo $rows->emp_firstname.' '.$rows->emp_middle_name.' '.$rows->emp_lastname;?></td>
	<td align="center"><?php echo $rows->job_title_id;?></td>
	<td align="center"><?php echo $rows->emp_status;?></td>
	<td align="center"><a href="add_pay_det.php?emp_id=<?php echo $rows->emp_id;  ?>">Process Payslip</a></td>
	<!--<td align="center">View Pay Details</td>-->
