...
<body>
	...
	<div id="page-wrap">
		...
		<h3>:: Adding New Expenses Account into the System</h3>
...
<form name="new_user_group" action="processaddterminology.php" method="post">			
...
?></td>
  ...
  <tr >
    <td bgcolor="">&nbsp;</td>
    <td width="19%">Expenses Category Name<font color="#FF0000">*</font></td>
    <td width="23%"><input type="text" size="41" name="accounting_term"></td>
  ...
  <tr height="40">
    ...
    <td><textarea name="term_desc" rows="3" cols="36"></textarea></td>
    </tr>
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("accounting_term","req",">>Please enter expenses category name");
