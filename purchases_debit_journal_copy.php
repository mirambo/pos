...
$queryop="select * FROM suppliers,purchases_debit_journal,currency where purchases_debit_journal.supplier_id=suppliers.supplier_id 
 and purchases_debit_journal.currency_code=currency.curr_id AND purchases_debit_journal.purchases_debit_journal_id='$id'";
...
<form name="gen_order" action="process_purchases_debit_journal.php?id=<?php echo $id; ?>" method="post">			
...
if (mysql_num_rows($resultscurr) > 0)
{
						...
						<span id="sub_cat12">Rate:<input type="text" required name="curr_rate" value="<?php echo $rows->curr_rate; ?>" size="10"></span>
								...
								VAT
								  ...
								  <select name='vat' required style="width:80px;">
