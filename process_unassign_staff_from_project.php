...
$sql= "delete from assigned_staffold where staff='$staff'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());


$sqldt="UPDATE employees SET status='0' where emp_id='$staff'";
...
header ("Location:home.php?deletestafftoprojects=deletestafftoprojects&project=$project&addconfirm=1");
