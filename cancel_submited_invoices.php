...
<form name="new_supplier" action="process_cancel_submited_invoice.php?invoice_id=<?php echo $invoice_id;?>&invoice_amnt=<?php echo $invoice_amnt?>" method="post">			
