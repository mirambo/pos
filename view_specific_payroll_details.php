...
<tr><td colspan="5"><h3>Basic Details</h3></td></tr>
 ...
 <td width="10%">Days Worked </td>
 

 
 
 
 <td width="25%" align=""><?php echo $days_worked=$rowsr->days_worked; ?> days  (Daily Rate : <?php echo number_format($daily_rate=$rowsr->specific_daily_rate_amount,2); ?>)</td>

 </tr>
 
  <tr  height="30" bgcolor="#ccc">
 <td width="10%"><strong></strong></td>
 <td width="10%">Basic Pay</td>
 

 
 
 
 <td width="25%" align=""><?php echo number_format($worked_amount=$daily_rate*$days_worked,2); ?></td>
 </tr>
...
if (mysql_num_rows($results) > 0)
 ...
 <td align="right"><strong><?php echo number_format($gross_pay=$worked_amount+$bonus+$ttl_ot+$ttl_benefits,2);?></strong></td>
...
<strong> Employer Contrib.: </strong><?php echo number_format($rowsr->employer_nssf_amount,2); ?>
 ...
 (<strong>Taxable Income : </strong><?php echo number_format($ti=$worked_amount+$bonus+$ttl_ot+$ttl_benefits-$staff_nssf_amount,2); ?>)
...
if (mysql_num_rows($results) > 0)
 ...
 <td align="right"><strong><?php echo number_format($all_deductions=$ttl_deductions+$nhif_amount+$paye+$staff_nssf_amount,2);?></strong></td>
