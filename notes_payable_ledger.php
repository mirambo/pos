...
<body>
	...
	<?php require_once('includes/notespayablesldgersubmenu.php');  ?>
		
		<h3>::Notes Payables Ledger</h3>
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
	...
	Notes Payables Ledger</strong></font>
	...
	<a href="print_loan_ledger.php" target="_blank">Print</a>|<a href="print_loan_ledger_word.php">Export to word </a>
...
from notes_payables_ledger,currency where notes_payables_ledger.currency_code=currency.curr_id order by notes_payables_ledger.transaction_id asc";
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
    ...
    <td colspan="9" height="30" align="right"><font size="+1">
	<a href="print_loan_ledger.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to; ?>" target="_blank">Print</a> | <a href="print_loan_ledger_word.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to; ?>">Export to word </a>
...
$grnd_amount_out_kshs=0; 
$sql="select  notes_payables_ledger.transaction_id,notes_payables_ledger.transactions,notes_payables_ledger.amount,notes_payables_ledger.debit,notes_payables_ledger.credit,notes_payables_ledger.currency_code,notes_payables_ledger.curr_rate,notes_payables_ledger.date_recorded, currency.curr_name 
from notes_payables_ledger,currency where notes_payables_ledger.currency_code=currency.curr_id AND date_recorded BETWEEN '$date_from' AND '$date_to' order by notes_payables_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
