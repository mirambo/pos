...
?>
	...
	<tr bgcolor="#FFFFCC">
	<td colspan="12" align="center"><strong>Search : By Supplier Name:</strong>
	<select name="client">
...
<a target="_blank" style="float:right; margin-right:100px; font-weight:bold; font-size:13px; color:#000000" href="print_list_supplier_payments.php?client=<?php echo $client?>&date_from=<?php echo $date_from ?>&date_to=<?php echo $date_to ?>&shop_id=<?php echo $shop_id ?>">Print</a>						  
...
$sql="select * FROM mop,suppliers,supplier_payments,currency where 
supplier_payments.mop=mop.mop_id and supplier_payments.supplier_id=suppliers.supplier_id AND 
supplier_payments.currency_code=currency.curr_id AND supplier_payments.shop_id='$incharge' ORDER BY supplier_payments.date_received desc";
$resultsdc= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
$querydc= "SELECT * FROM mop,suppliers,supplier_payments,currency";
    ...
    if (count($conditions) > 0) 
	{
      $querydc .= " WHERE " . implode(' AND ', $conditions)." AND supplier_payments.mop=mop.mop_id and 
	  supplier_payments.supplier_id=suppliers.supplier_id AND 
supplier_payments.currency_code=currency.curr_id AND supplier_payment.shop_id='$incharge' ORDER BY supplier_payments.date_received desc";
    }
	else
	{	
...
else
{
	...
	<td align="center"><a href="edit_supplier_payments.php?supplier_payments_id=<?php echo $rows->supplier_payments_id;?>"><img src="images/edit.png"></a></td>
    <td align="center"><a href="delete_supplier_payments.php?supplier_payments_id=<?php echo $rows->supplier_payments_id;?>"  onClick="return confirmDelete();"><img src="images/delete.png"></a></td>
