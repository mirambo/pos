...
header("Content-Disposition: attachment;Filename=Supplier_Balances.xls");
header("Expires: 0");
...
<H5>Suppliers Balance Report</H5>
	
	</td>
	
    </tr>
  <tr  style="background:url(images/description.gif);" height="30" >
  <td align="center" ><strong>Supplier No.</strong></td>    
...
if ($supp_name!='')
{
$sql="SELECT * FROM suppliers where supplier_name LIKE '%$supp_name%' order by supplier_name asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
else
{
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>
    <td><?php echo $supplier_id=$rows->supplier_id;?></td>
