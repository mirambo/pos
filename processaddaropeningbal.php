...
$queryprof="select * from  accounts_receivables_ledger where transactions='$transaction'";
...
header ("Location:add_ar_opening_balance.php? recordexist=1");
...
$sql= "insert into accounts_receivables_ledger values ('','$transaction','$amount','$amount','','6','1',NOW(),'')";
...
header ("Location:add_ar_opening_balance.php? addconfirm=1");
