...
<form name="new_supplier" action="processaddchequedeposit.php" method="post">			
...
echo '<div align="center" style="background: #FFCC33; height:20px; width:600px; border:#339900 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#339900" >Cheque Deposits Added Successfully!!</font></strong></p></div>';
?>
...
if (mysql_num_rows($resultscurr) > 0)
{
  ...
  <tr height="20">
    ...
    <td><input type="text" name="date_dep" size="40" id="date_dep" readonly="readonly" /><input name="DateFormats" id="DateFormats" disabled value="dd/mm/yyyy" type="hidden"></td>
    </tr>
  <tr height="20">
    <td bgcolor="">&nbsp;</td>
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("date_dep","req",">>Please enter date deposited");
 ...
 frmvalidator.addValidation("dep_bank","dontselect=0",">>Please select bank");
