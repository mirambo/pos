...
{
add_biweekly($project_id,$sub_project_id,$set_template_id,$settlement_id,$trans_date,$report_period_id,$bi_male,$bi_female,$narration,$user_id,$sess_country_id);
}*/
 ?>
...
?>
	...
	<option value="0">................All Core Competencies.............</option>	
								  ...
								  $query1="SELECT * from nrc_cc order by cc_name asc";
								  $results1=mysql_query($query1) or die ("Error: $query1.".mysql_error());
...
<strong>General Country Level Bi-Weekly Report</strong>
<?php
...
<td colspan="7">
<h3>
Panel To View The Biweekly Submited Report <span style="float:right;">
<a rel="facebox" title="View Progress Graph Per Sub Project" style="margin:10px;" href="print_country_report_graphsp.php?&project_id=<?php echo $project_id;?>&country_id=<?php echo $country_id;?>&cc_id=<?php echo $cc_id;?>&date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to;?>"><img src="images/sp.png" width="30" height="30"></a>
<a rel="facebox" title="View Progress Graph Per Activity" style="margin:10px;" href="print_country_report_graph.php?&project_id=<?php echo $project_id;?>&country_id=<?php echo $country_id;?>&cc_id=<?php echo $cc_id;?>&date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to;?>"><img src="images/report.png" width="30" height="30"></a>
<a title="Print" style="margin:10px;" href="print_country_report.php?&project_id=<?php echo $project_id;?>&country_id=<?php echo $country_id;?>&cc_id=<?php echo $cc_id;?>&date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to;?>" target="_blank"><img src="images/print_icon.gif"></a>
<a title="Export To Word" style="margin:10px;" href="print_country_report_word.php?&project_id=<?php echo $project_id;?>&country_id=<?php echo $country_id;?>&cc_id=<?php echo $cc_id;?>&date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to;?>"><img src="images/word.png"></a>
<a title="Export To Excel" style="margin:10px;" href="print_country_report_excel.php?&project_id=<?php echo $project_id;?>&country_id=<?php echo $country_id;?>&cc_id=<?php echo $cc_id;?>&date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to;?>" ><img src="images/excel.png"></a>
...
<td align="center" width="30%"><strong>Sub Project [<font color="#ff0000"><?php require_once('counter_country.php'); ?> Sub Projects</font>]</strong></td>
...
<td valign="top"><?php echo $rowsp->sub_project_name;
...
<td><strong>% Achievement</strong></td>
<td><strong>Cumulative Target</strong></td>
<td><strong>Cumulative Achieved</strong></td>
<td><strong>% Achievement</strong></td>
...
and country_id='$country_id' and project_id='$project_id' order by activity asc";
$resultsact=mysql_query($sqlsact) or die ("Error $sqlsact.".mysql_error());
...
elseif ( $country_id!=0 && $cc_id==0 && $project_id==0 && $date_from=='' && $date_to=='')
{
$sqlsact="SELECT * FROM nrc_set_template where sub_project_id='$sub_proj_id' and country_id='$country_id' order by activity asc";
$resultsact=mysql_query($sqlsact) or die ("Error $sqlsact.".mysql_error());
...
elseif ( $country_id!=0 && $cc_id!=0 && $project_id==0 && $date_from=='' && $date_to=='')
{
$sqlsact="SELECT * FROM nrc_set_template where sub_project_id='$sub_proj_id' AND nrc_set_template.cc_id='$cc_id' AND 
country_id='$country_id' order by activity asc";
$resultsact=mysql_query($sqlsact) or die ("Error $sqlsact.".mysql_error());
...
{
$sqlsact="SELECT * FROM nrc_set_template where sub_project_id='$sub_proj_id' AND nrc_set_template.cc_id='$cc_id'  
AND country_id='$country_id' order by activity asc";
$resultsact=mysql_query($sqlsact) or die ("Error $sqlsact.".mysql_error());
...
[<a rel="facebox" href="view_history_admin.php?set_template_id=<?php echo $set_template_id; ?>">View History</a>]
</td>
...
$color= randomColor();
 ...
 echo number_format($achieved_perc=$ttl_achieved/$target*100,2);

 //echo $rowsact->target_female; ?></td>
 <!--<td><div style="width:<?php echo $achieved_perc; ?>px; background:<?php echo $color; ?>; height:20px;"></td>-->
