...
$debit_amount=mysql_real_escape_string($_POST['debit_amount'][$row]);
...
$sql34="INSERT INTO received_supplier_invoice SET 
	    ...
	    debit_amount='$debit_amount'" or die(mysql_error());
    $results34= mysql_query($sql34) or die ("Error $sql34.".mysql_error());
	
	$received_supplier_invoice_id=mysql_insert_id();
	
	$dr_transaction_code="drsuprecinv".$received_supplier_invoice_id;
...
if ($bal_type2d=='D')
{
	...
	$acc_journal_amountd=$debit_amount;
...
$sql= "UPDATE received_supplier_invoice_code SET
supplier_id='$supplier_id',
order_code_id='$order_code_id',
supplier_invoice_no='$ref_no',
ttl_cost='$ttl_cost',
...
vat_account_id='$vat_account_id',
account_to_credit='$account_to_credit',
date_paid='$date_paid' WHERE received_supplier_invoice_code_id='$id'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
/* $sqld= "delete from received_supplier_invoice where received_supplier_invoice_code_id='$id'";
$resultsd= mysql_query($sqld) or die ("Error $sqld.".mysql_error());


$sqld2= "delete from chart_transactions where transaction_code LIKE '%drsuprecinv%'";
...
$debit_amount=mysql_real_escape_string($_POST['debit_amount'][$row]);
$debit_account_id=mysql_real_escape_string($_POST['debit_account_id'][$row]);
$post_receive_supplier_invoice_id=mysql_real_escape_string($_POST['received_supplier_invoice_id'][$row]);



 if ($post_receive_supplier_invoice_id!='')
{
///////////update the suppluer invoice payment table
$sql34="UPDATE received_supplier_invoice SET 
    	account_to_debit='$debit_account_id',
	    debit_amount='$debit_amount' WHERE received_supplier_invoice_id='$post_receive_supplier_invoice_id'" or die(mysql_error());
    $results34= mysql_query($sql34) or die ("Error $sql34.".mysql_error());
	$dr_transaction_code="drsuprecinv".$post_receive_supplier_invoice_id;
