...
<a target="_blank" style="float:right; margin-right:200px; font-weight:bold; font-size:13px; color:#000000" href="print_list_invoice_sales_approved.php?location_id=<?php echo $supplier; ?>&from=<?php echo $date_from ?>&to=<?php echo $date_to; ?>">Print</a>						  
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
    ...
    <td align="center" width="150"><strong>Employee No</strong></td>
...
$querydc="SELECT *,hs_hr_employee.employee_id as staff_no FROM payroll_code, 
hs_hr_employee where payroll_code.employee_id=hs_hr_employee.emp_number and payroll_type='S'
...
echo $rowst->f_name;
	?>
		...
		<td align="center"><a href="home.php?view_payroll_spec_details&payroll_code_id=<?php echo $payroll_code_id;?>">View Details</a></td>
		<td align="center"><a href="home.php?post_payroll_spec&payroll_code_id=<?php echo $payroll_code_id;?>"><img src="images/edit.png"></a></td>
