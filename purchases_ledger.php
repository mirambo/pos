...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
	...
	<a href="print_purchases_ledger.php" target="_blank">Print</a>|<a href="print_purchases_ledger_word.php">Export to word </a>
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
    ...
    <td colspan="9" height="30" align="right"><font size="+1">
	<a href="print_purchases_ledger.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to; ?>" target="_blank">Print</a> | <a href="print_purchases_ledger_word.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to; ?>">Export to word </a>
