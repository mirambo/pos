<?php $shares_id=$_GET['shares_id'];?>
<script language="p" src="gen_validatorv31.js" type="text/javascript"></script>
...
<form name="new_supplier" action="process_exit_shareholder.php?shares_id=<?php echo $shares_id; ?>" method="post">			
...
?></td>
  ...
  <tr height="20">
    <td bgcolor="">&nbsp;</td>
    <td width="19%" valign="top">Enter Reason for Exit</td>
    <td width="23%"><textarea name="reasons" cols="36" rows="3"></textarea></td>
