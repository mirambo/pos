...
prepaid_expenses.mop=mop.mop_id AND prepaid_expenses.currency_code=currency.curr_id 
 AND prepaid_expenses.prepaid_expenses_id='$invoice_payment_id'";
...
<?php require_once('includes/prepaidexpensessubmenu.php');  ?>
		...
		<h3>:: Update Prepaid Expenses Details</h3>
...
<form name="gen_order" action="processeditprepaidexp.php?invoice_payment_id=<?php echo $invoice_payment_id;?>" method="post">			
