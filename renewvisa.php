...
<form name="new_supplier" action="processrenewvisas.php?visa_details_id=<?php echo $visa_details_id;?>&emp_id=<?php echo $emp_id; ?>" method="post">			
			<table width="100%" border="0">
			  <tr >
    <td width="18%">&nbsp;</td>
	<td colspan="2" height="30" align="center"><strong><h4>Renew Visa for<?php
...
?></td>
	...
	<tr height="20">
    <td>&nbsp;</td>
    <td>New Visa Type<font color="#FF0000"></font></td>
    <td><input type="radio" name="visa_type" value="Single">Single &nbsp;&nbsp;<input type="radio" name="visa_type" value="Multiple">Multple</td>
