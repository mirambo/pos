...
<title>Delivery Note - <?php echo $invoice_no; ?></title>
...
$rowscont=mysql_fetch_object($resultscont);
 ...
 <!-- <tr>
  ...
  <tr height="30">
    <td colspan="7" bgcolor="#000033" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">DELIVERY NOTE</span></td>
  </tr>
  <tr height="30">
   ...
   <tr height="20">
    <td colspan="7"  align="right"><strong>DELIVERY NOTE NO : <?php 
	echo $invoice_no;
	?>
	<hr/>
	</strong></td>
...
<table width="700" border="0" align="center" class="table">
  <tr>
    ...
    <td colspan="3" width="20%"><div align="center"><strong>Item Name / Description</strong></div></td>
