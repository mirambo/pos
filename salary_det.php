...
<form name="emp" id="emp" action="processsalarydet.php?emp_id=<?php echo $emp_id; ?>" method="post">			
...
echo $rowslatelpo->emp_fname.' '.$rowslatelpo->emp_mname.' '.$rowslatelpo->emp_lname;
  ...
  <tr height="20">
    ...
    <td bgcolor="" width="20%"><input type="text" size="41" name="gross_salary"></td>
    <td width="15%">Grade<font color="#FF0000">*</font></td>
    <td width="5%"><input type="text" name="grade" size="41" /></td>
