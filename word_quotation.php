...
$rowscont=mysql_fetch_object($resultscont);
 ...
 <!-- <tr>
  ...
  <tr height="30">
    <td colspan="11" bgcolor="#000033" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">QUOTATION</span></td>
  </tr>
  <tr height="30">
 ...
 <tr bgcolor="#C0D7E5">
    ...
    <td width="50%" colspan="3"><strong>CLIENT'S DELIVERY ADDRESS </strong></td>
  

	<td width="10%" colspan="3" ALIGN="CENTER" width="30%"><strong>PAYMENT TERMS</strong></td>
	<td width="10%" ALIGN="CENTER" colspan="3"><strong>DELIVERY TERMS</strong></td>	
  </tr>
  <tr>
...
$rowsship=mysql_fetch_object($resultsship);
   ...
   <td width="20%" colspan="3" ALIGN="CENTER"><?php echo $payment_termsx ?></td>
	<td width="10%" ALIGN="CENTER" colspan="3"><?php echo $delivery_termsx ?></td>	
  </tr>
  <tr>
