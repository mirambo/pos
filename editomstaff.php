...
$sql="select omstaff.f_name,omstaff.l_name,omstaff.m_name,omstaff.l_name,omstaff.telephone,omstaff.email,omstaff.nationality,
...
omstaff.job_title_id=omjob_titles.omjob_title_id AND job_category.job_cat_id=omstaff.job_cat_id AND work_place.work_place_id=omstaff.work_place_id AND omstaff.omstaff_id='$omstaff_id'";
...
<form name="new_supplier" action="processeditomstaff.php?omstaff_id=<?php echo $omstaff_id; ?>" method="post">			
...
echo '<div align="center" style="background: #FFCC33; height:20px; width:400px; border:#ff0000 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#ff0000" >Subcontractor Staff Updated Successfully!!</font></strong></p></div>';
?>
...
?></td>
	...
	<option value="<?php echo $rows->consultant_id;?>"><?php echo $rows->cons_name?></option>
								  <?php
    ...
    <td><input type="text" size="41" name="f_name" value="<?php echo $rows->f_name;?>"></td>
	<td width="40%" rowspan="6" valign="top"><div id='new_supplier_errorloc' class='error_strings'></div></td>
    </tr>
	<tr height="20">
    <td>&nbsp;</td>
    <td>Middle Name</td>
    <td><input type="text" size="41" name="m_name" value="<?php echo $rows->m_name;?>"></td>
    </tr>
		<tr height="20">
    <td>&nbsp;</td>
    <td>Last Name<font color="#FF0000">*</font></td>
    <td><input type="text" size="41" name="l_name" value="<?php echo $rows->l_name;?>"></td>
    </tr>
	<tr height="20">
    <td>&nbsp;</td>
    ...
    <td><input type="text" name="telephone" size="41" value="<?php echo $rows->telephone;?>"/></td>
    </tr>
	<tr height="20">
    <td>&nbsp;</td>
	...
	<option value="<?php echo $rows->job_title_id;?>"><?php echo $rows->omjob_title_name;?></option>
								  <?php
	...
	<option value="<?php echo $rows->job_cat_id;?>"><?php echo $rows->job_cat_name;?></option>
								  <?php
	...
	<option value="<?php echo $rows->work_place_id;?>"><?php echo $rows->work_place_name;?></option>
								  <?php
