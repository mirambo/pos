...
$sqluprec_no="UPDATE fund_transfer set 
...
curr_rate='$curr_rate', 
memo='$memo2', 
date_transfered='$date_paid'
where fund_transfer_id='$fund_transfer_id'";
...
amount='$grand_ttl',
debit='$grand_ttl',
credit='$grand_ttlxxxxxx',
transaction_date='$date_dep',
l_day='$day',
l_month='$month',
l_year='$year'

where transaction_code='$transaction_code' and account_id='$transfer_to'";
$resultstrans=mysql_query($sqltrans) or die ("Error $sqltrans.".mysql_error());
...
$sqltrans="update ledger_transactions SET 
memo='$memo2',
shop_id='$transfer_from',
account_id='$transfer_to',
amount='-$grand_ttl',
debit='$grand_ttlxxxxxxx',
credit='$grand_ttl',
transaction_date='$date_dep',
l_day='$day',
l_month='$month',
...
where transaction_code='$transaction_code' and account_id='$transfer_from'";
$resultstrans=mysql_query($sqltrans) or die ("Error $sqltrans.".mysql_error());




header ("Location:edit_fund_transfer.php?fund_transfer_id=$latest_id2");
