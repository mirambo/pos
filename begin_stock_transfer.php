...
$(document).ready(function(){ 
	...
	if(counter>100){
 	...
 	newTextBoxDiv2.after().html('<tr class="txtMult"><td colspan="3">Item '+ counter + ' : ' +
	      '<select name="prod[]" style="width:150px;"><option value="0">Select...........................</option><?php $query1="select * from products order by product_name asc"; $results1=mysql_query($query1) or die ("Error: $query1.".mysql_error()); if (mysql_num_rows($results1)>0) { while ($rows1=mysql_fetch_object($results1)) { ?> <option value="<?php echo $rows1->product_id; ?>"><?php echo $rows1->product_name.'  ('.$rows1->prod_code.')'; ?> </option> <?php  } } ?></select> Quantity <input type="text" name="qnty[]" size="10" class="val1"> </td></tr>');
...
<body>
	...
	<div id="page-wrap">
		...
		<?php require_once('includes/stocktransfersubmenu.php');  ?>
		
		<h3>:: Start Stock Transfer</h3>
...
<form name="start_order" action="process_stock_transfer.php" method="post">	
<?php 
if ($order_code!=0)
{
include('view_stock_transfer_details.php');
?>
...
<tr bgcolor="#2E3192"><td colspan="2"  align="center"><img src="images/task_icon.png" align="left" width="20" height="20"><strong><font color="#ffffff">Stock Transfer Details</font></strong></td></tr>
<tr height="30">
<td align="left">
<div id='start_order_date_from_errorloc' class="error_strings"></div><div id='emp_date_to_errorloc' class="error_strings"></div>
Transfer Date<input type="text" name="date_from" size="20" id="date_from" readonly="readonly" />
<div id='start_order_source_errorloc' class="error_strings"></div>
Select Source 
...
<option value="0">Select..............................</option>
	...
	<div id='start_order_destination_errorloc' class="error_strings"></div>							  
								  Select Destination Shop
<select name="destination" style="width:150px;">
...
Releasing Person
<input type="textbox" size="10" name="release">
<div id='start_order_release_errorloc' class="error_strings"></div>
Receiving Person <input type="textbox" size="10" name="receive">
...
<td align="center">
<!--Freight Charges
<input name="freight_charge" type="text" size="20">-->
...
<input type="submit" name="submit" onClick="return confirmSave();" value="Save Details" style="background:#2E3192; font-size:14px; color:#ffffff; font-weight:bold; width:300px; height:30px; border-radius:5px;">
	</td></tr>
<?php 
}
?>	
...
//You should create the validator only after the definition of the HTML form
 ...
 frmvalidator.addValidation("source","dontselect=0",">>Please select source");
 frmvalidator.addValidation("destination","dontselect=0",">>Please select destination");
