...
reconciled_bank_balance.description,reconciled_bank_balance.effect,reconciled_bank_balance.amount,reconciled_bank_balance.currency,currency.curr_name,
reconciled_bank_balance.curr_rate,reconciled_bank_balance.date_done FROM reconciled_bank_balance,currency 
WHERE reconciled_bank_balance.currency=currency.curr_id AND reconciled_bank_balance.reconciled_bank_balance_id='$id'";
...
<body>
	...
	<?php require_once('includes/bank_reconcilliation_submenu.php');  ?>
		...
		<h3>:: Reconcile Bank Statement Balance For Account <?php echo $rowsemp_det->bank_name.' '.$rowsemp_det->account_name.''; ?></h3>
...
<form name="new_supplier" action="process_edit_reconbank.php?reconciled_bank_balance=<?php echo $id ?>" method="post">			
