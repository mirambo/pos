...
header("Content-Disposition: attachment;Filename=Sales_Revenue_Ledger.doc");
header("Expires: 0");
...
<title>Sales Revenue Ledger</title>
...
<tr>
  ...
  <tr height="30">
    <td colspan="7" bgcolor="#000033" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">SALES REVENUE LEDGER</span>
...
<?php 
$sqlbbd="select  sales_ledger.transaction_id,sales_ledger.transactions,sales_ledger.amount,sales_ledger.debit,sales_ledger.credit,sales_ledger.currency_code,sales_ledger.curr_rate,sales_ledger.date_recorded, currency.curr_name 
from sales_ledger,currency where sales_ledger.currency_code=currency.curr_id AND date_recorded <'$date_from' order by sales_ledger.transaction_id asc";
