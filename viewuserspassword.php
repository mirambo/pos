...
?>
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
	...
	<td width="100" align="center"><strong>Reset Password</strong></td>
    
    </tr>
  
  <?php 
 
$sql="SELECT users.user_id,users.f_name,users.phone,users.email,users.username,users.suspend,users.allow_add,users.allow_edit,users.allow_delete,user_group.user_group_name 
FROM users,user_group where users.user_group_id=user_group.user_group_id order by users.f_name";
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>
	...
	<td align="center"><a href="home.php?resetpass2=resetpass2&get_user_id=<?php echo $rows->user_id; ?>">Reset Password</a></td>
