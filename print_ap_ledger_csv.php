...
header("Content-Disposition: attachment;Filename=Accounts_Payable_Ledger.xlsx");
header("Expires: 0");
...
$rowscont=mysql_fetch_object($resultscont);*/
  ...
  <tr height="30">
    <td colspan="7" bgcolor="#67C6FE" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">ACCOUNTS PAYABLES LEDGER</span>
