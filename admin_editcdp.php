...
<form name="new_supplier" action="processadmineditcdp.php?cpd_id=<?php echo $cpd_id; ?>" method="post">			
...
?></td>
	...
	<?php 
$sql="SELECT * FROM cdp where cdp_id='$cpd_id'";
...
<option value="Zimbabwe">Zimbabwe</option>
    ...
    <td><input type="text" name="date" size="20" id="date" readonly="readonly" value="<?php echo $rows->date; ?>"/></td>
    </tr>
	
	<tr height="20">
    <td>&nbsp;</td>
    <td>Venue<font color="#FF0000">*</font></td> 
    <td><input type="text" size="41" name="venue" value="<?php echo $rows->vanue; ?>"></td>
    </tr>
	
	<tr height="20">
    <td>&nbsp;</td>
    <td>Topic<font color="#FF0000">*</font></td>
    <td><input type="text" size="41" name="topic" value="<?php echo $rows->topic; ?>"></td>
    </tr>

	<tr height="20">
    <td>&nbsp;</td>
    <td>Total Participants<font color="#FF0000">*</font></td>
    <td><input type="text" size="41" name="total_part" value="<?php echo $rows->total_part; ?>"></td>
    </tr>
	<tr height="20">
    <td>&nbsp;</td>
    <td>Male Participants</td>
    <td><input type="text" size="41" name="male_part" value="<?php echo $rows->male_part; ?>"></td>
    </tr>
	
	<tr height="20">
    <td>&nbsp;</td>
    <td>Female Participants</td>
    <td><input type="text" size="41" name="female_part" value="<?php echo $rows->female_part; ?>"></td>
    </tr>
	<tr height="20">
    <td>&nbsp;</td>
    <td>Facilitator(s)<font color="#FF0000">*</font></td>
    <td><input type="text" size="41" name="facillitator" value="<?php echo $rows->facillitator; ?>"></td>
    </tr>
