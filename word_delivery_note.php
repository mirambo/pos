...
$invoice_no='DLV'.$rowsrec->invoice_no;
$client_id=$rowsrec->client_id;
$date_generated=$rowsrec->date_generated;
$terms=$rowsrec->terms;

header("Content-Type: application/vnd.ms-word");
header("Content-Disposition: attachment;Filename=Delivery_Note-$invoice_no.doc");
header("Expires: 0");
...
<title>Delivery Note - <?php echo $invoice_no_top; ?></title>
...
$rowscont=mysql_fetch_object($resultscont);
  ...
  ?>
   <tr>
	...
	<tr><td><strong>Town</td><td><?php echo $rowssupp->c_town; ?></td></tr>
	<tr><td><strong>Telephone</td><td><?php echo $rowssupp->c_phone; ?></td></tr>
    ...
    <td colspan="7" align="right" valign="top"><img src="<?php echo $base_url;?>images/logolpo.png" /></td>
  </tr>
  <tr>
 ...
 <!-- <tr>
  ...
  <tr height="30">
    <td colspan="11" bgcolor="#000033" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">DELIVERY NOTE</span></td>
  </tr>
  <tr height="30">
   ...
   <tr height="20">
    <td colspan="11"  align="right"><strong>DELIVERY NOTE NO : <?php 
	echo $invoice_no;
	?>
	<hr/>
	</strong></td>
  ...
  <tr bgcolor="#C0D7E5">
    ...
    <td colspan="6" align="center"><strong><!--PAYMENT TERMS--></strong></td>
  ...
  <td colspan="2" align="center"><?php //echo $terms; ?></td>
...
echo '<tr bgcolor="#FFFFCC" height="10" >';
 ...
 ?>
    ...
    <td colspan="3"><?php echo $rowslpdet->product_name.'  '.$rowslpdet->prod_desc; ?></td>
 ...
 <td width="6%" colspan="5" align="right"><strong>Sub Totals</strong></td>
  ...
  <tr height="10">
    ...
    <td width="19%" colspan="5" align="right"><strong>Discount</strong></td>
