...
<form name="new_supplier" action="processaddsubmodule.php" method="post">			
...
?></td>
    ...
    <td width="12%">Select Module<font color="#FF0000">*</font></td>
  ...
  <tr height="20">
    <td bgcolor="" width="30%">&nbsp;</td>
    <td width="12%">Enter Sub Module Name<font color="#FF0000">*</font></td>
    <td width="23%"><input type="text" size="41" name="submodule_name"></td>
  ...
  <tr height="20">
   ...
   <tr height="20">
    ...
    <td width="23%"><textarea cols="36" rows="4" name="link"><li><a href="home.php?newsponsor=newsponsor">Currencies</a></li></textarea></td>
