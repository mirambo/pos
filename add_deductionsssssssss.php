...
<body>
	...
	<div id="page-wrap">
		...
		<h3>:: Adding New Deductions Type</h3>
...
<form name="new_machine_category" action="processaddbenefits.php" method="post">			
...
echo '<div align="center" style="background: #FFCC33; height:20px; width:600px; border:#339900 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#339900" >Deduction Type Added Successfully!!</font></strong></p></div>';
?>
...
?></td>
  ...
  <tr height="30">
    <td bgcolor="">&nbsp;</td>
    <td width="19%">Enter Deduction Type<font color="#FF0000">*</font></td>
    <td width="23%"><input type="text" size="41" name="deduction_type"></td>
  ...
  <tr height="30">
    ...
    <td width="23%"><input type="text" size="41" name="deduction_amount"></td>
