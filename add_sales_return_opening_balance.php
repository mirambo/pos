...
<body>
	...
	<div id="page-wrap">
		...
		<h3>:: Adding Sales Return Opening Balance Into the system </h3>
...
<form name="new_user" action="processaddsalesretopeningbal.php" method="post">			
...
<tr height="30">
    <td bgcolor="">&nbsp;</td>
    <td width="19%">Select The Client<font color="#FF0000">*</font></td>
    <td width="23%"><select name="client"><option value="0">Select.....................</option>
								  <?php
	...
	<tr height="20" >
    <td>&nbsp;</td>
    <td width="15%">Enter Amount (Kshs.)<font color="#FF0000">*</font></td>
