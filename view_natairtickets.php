...
$sql="SELECT natairtickets.dep_town,natairtickets.dep_date,natairtickets.dest_town,natairtickets.arrive_date ,natairtickets.ret_date,
natairtickets.flight_comp,natairtickets.flight_cost,natairtickets.remarks,employees.emp_id,employees.emp_fname,employees.emp_mname,employees.emp_lname,omjob_titles.omjob_title_name
 FROM employees,omjob_titles,natairtickets WHERE natairtickets.emp_id=employees.emp_id and omjob_titles.omjob_title_id=employees.title";
...
if ($sess_allow_edit==1)
{
	...
	<a href="edit_expenses.php?expense_id=<?php echo $rows->expense_id; ?>"><img src="images/edit.png"></a>
	<?php 
	}
	else
	{
