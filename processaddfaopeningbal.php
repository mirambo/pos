...
$queryprof="select * from  fixed_assets_ledger where transactions='$transaction'";
...
header ("Location:add_fa_opening_balance.php? recordexist=1");
...
$sql= "insert into fixed_assets_ledger values ('','$transaction','$amount','$amount','','6','1',NOW())";
...
header ("Location:add_fa_opening_balance.php? addconfirm=1");
