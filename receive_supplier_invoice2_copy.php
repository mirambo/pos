...
$querydc="select * FROM received_supplier_invoice,order_code_get,suppliers WHERE suppliers.supplier_id=order_code_get.supplier_id 
and received_supplier_invoice.order_code_id=order_code_get.order_code_id AND 
received_supplier_invoice.received_supplier_invoice_id='$id'";
...
<select name="debit_account_id"  id="account_from" required style="width:250px;"><option value="<?php echo $account_debited; ?>"><?php echo $account_debited_name; ?></option>
