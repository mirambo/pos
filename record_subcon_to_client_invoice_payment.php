...
<form name="rec_inv_pay" action="process_subcon_to_client_invoice_payment.php?invoice_id=<?php echo $invoice_id; ?>" method="post">	
<?php 
$sql="select subcon_invoices_to_client.invoice_id,subcon_invoices_to_client.invoice_no,subcon_invoices_to_client.date_generated,subcon_invoices_to_client.invoice_ttl,subcon_invoices_to_client.project_id,subcon_invoices_to_client.month_generated,
clients.c_name,projects.client_id from subcon_invoices_to_client,clients,projects where subcon_invoices_to_client.project_id=projects.project_id and projects.client_id=clients.client_id AND subcon_invoices_to_client.invoice_id='$invoice_id'";
