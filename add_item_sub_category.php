...
{
add_sub_project($cat_name,$cat_desc,$user_id);
}
 ?>
...
<form name="new_supplier" action="process_add_sub_category.php" method="post">			
...
?></td>
  ...
  <tr height="20">
    ...
    <td width="23%"><select name="cat_id" style="width:200px;"><option value="0">Select-------------------------------</option>
								  <?php
    ...
    <td width="23%"><input type="text" size="29" name="sub_cat_name"></td>
    <td width="40%" rowspan="6" valign="top"><div id='new_supplier_errorloc' class='error_strings'></div></td>
  </tr>
