...
<a target="_blank" style="float:right; margin-right:200px; font-weight:bold; font-size:13px; color:#000000" href="print_list_cash_sales_approved.php?customer_id=<?php echo $location_id;?>&date_from=<?php echo $date_from ?>&date_to=<?php echo $date_to ?>">Print</a>						  
<a  style="float:right; margin-right:100px; font-weight:bold; font-size:13px; color:#000000" href="print_list_cash_sales_approved_excel.php">Export To Excel</a>						  
