...
<form name="new_machine_category" action="processeditnhif.php?nhif_block_id=<?php echo $id; ?>" method="post">			
...
echo '<div align="center" style="background: #FFCC33; height:20px; width:600px; border:#339900 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#339900" >NHIF Rates Updated Successfully!!</font></strong></p></div>';
...
$sql="select * from nhif_block  where nhif_block_id='$id'";
...
?></td>
  ...
  <tr height="30">
    ...
    <td width="23%"><input type="text" size="41" name="income_from" value="<?php echo $rows->nhif_min;?>"></td>
  ...
  <tr height="30">
    ...
    <td width="23%"><input type="text" size="41" name="income_to" value="<?php echo $rows->nhif_max;?>"></td>
  
  <tr>
  
  <tr height="30">
    <td>&nbsp;</td>
    <td>Contribution Amount<font color="#FF0000">*</font></td>
    <td width="23%"><input type="text" size="41" name="contribution_amount" value="<?php echo $rows->nhif_amount;?>"></td>
