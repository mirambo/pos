...
$sql="select * FROM expenses_code,currency WHERE expenses_code.currency=currency.curr_id order by expense_code_id desc";
...
$journal_code_id=$rows->expense_code_id;
...
echo $count=$count+1;
	...
	<td align="right"><?php echo $rows->expense_receipt_no;?></td>
	<td align="right"><?php echo $rows->expense_description;?></td>
...
<table align="right">
   <?php 
   $amnt_rec=0;
$sqlemp_det2="select * from expenses,account_type where expenses.account_to_debit=account_type.account_type_id AND 
expenses.expense_code_id='$journal_code_id'";
...
while ($rowsemp_det2=mysql_fetch_object($resultsemp_det2))
   ...
   <tr>
   <td><?php echo $rowsemp_det2->account_type_name;?></td>
   <td align="right"><?php echo $amount_received=$rowsemp_det2->amount_received;
...
<?php 	
	...
	<td align="center">
	<?php 
	$recorded_by=$rows->expense_recorded_by;
...
echo $rowsemp_det2->f_name;
    ...
    <td align="center"><a href="add_expenses.php?sales_id=<?php echo $rows->expense_code_id;?>">View Details</a></td>
