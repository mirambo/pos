...
$sqlfr="select * from received_stock where received_stock_id='$received_stock_id'";
...
?>
<form name="new_machine_category" action="process_edit_advance_margin.php" method="post">			
<table width="100%" border="0" class="table1" id="tbl1">

  
	<input type="hidden" size="41" name="order_code" value="<?php echo $order_code_id;?>">
	<input type="hidden" size="41" name="received_stock_id" value="<?php echo $received_stock_id;?>">
	<input type="hidden" size="41" name="item_id" value="<?php echo $item_id;?>">
...
?></td>
	...
	<td colspan="2"><strong>Advance Margin Details </strong></td>  
  </tr>
 <!-- <tr style="background:url(images/description.gif);" height="20" >
  ...
  <tr style="background:url(images/description.gif);" height="20" >
	<td width="100" align="right"><strong>Advance Profit / Loss: </strong></td>
	<td width="100"><strong><input type="text" name="advance_margin" value="<?php echo $rowsfr->advance_margin;?>" size="50"></strong></td>
