...
header("Content-Disposition: attachment;Filename=NRC_Bi-Weekly_Area_Level_Reports.doc");
header("Expires: 0");
...
<td colspan="7" align="center"><img src="<?php echo $base_url?>images/nrclogo.png"></td></tr>
...
General Area Level Bi-Weekly Report
<?php
...
echo "<font color='#009900'><i><strong>".$area_name=$rowsccn['area_name'].'</strong></i></font>';
}
 ?>
