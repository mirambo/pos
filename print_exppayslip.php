...
<td align="center" width="20%"><strong>Earnings</strong></td>
	<td align="center" width="30%"><strong>Amount (USD)</strong></td><td><strong>Deductions</strong></td><td><strong>Amount(USD)</strong></td>

</tr>
<tr height="25" align="center"> 
<td align="center" colspan="2" valign="top">
<table width="100%" style="border:0px;" class="table">
	<tr><td>Standard Net Pay</td><td align="right"><?php echo number_format($rowslpdet->net_pay_stnd,2);
	$ttl_bas_pay=$rowslpdet->basic_pay;?></td></tr>
	<tr><td>Basic Salary</td><td align="right"><?php echo number_format($gross_pay=$rowslpdet->basic_salary,2);
	...
	<tr><td>Safety Allowances</td><td align="right"><?php 
	 ...
	 echo number_format($safety_allowance=$rowslpdet->safety_allowance,2);
	
	?></td></tr>
	<tr><td>Regional Allowances</td><td align="right"><?php 
	
	 echo number_format($regional_allowance=$rowslpdet->regional_allowance,2);
	
	?></td></tr>
	<tr><td>Vacation Allowances(<?php echo $rowslpdet->vacation_days;?> Days)</td><td align="right"><?php 
	
	 echo number_format($vacation_amount=$rowslpdet->vacation_amount,2);
	
	?></td></tr>
	
	<tr><td>Overtime Amount(<?php echo $rowslpdet->overtime1; ?> Hrs)</td><td align="right"><?php echo number_format($overtime_amnt1=$rowslpdet->overtime_amnt1,2);
	...
	<tr><td>Other Payment</td><td align="right"><?php 
	 ...
	 echo number_format($otherpayment=$rowslpdet->otherpayment,2);
	...
	<tr><td>Other Deductions</td><td align="right"><?php echo number_format($other_deduction=$rowslpdet->other_deductions,2); ?></td></tr>
...
<tr height="25" align="center"> 
<td align="right" colspan="3"><font size="+1"><strong>Net Salary Transfered (USD)</strong></font></td>
