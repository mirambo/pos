...
$date_generated=$rowsj->invoice_date;
$jb_user_id=$rowsj->user_id;
$invoice_no=$rowsj->invoice_id;
$discount_perc=$rowsj->discount_perc;
$job_card_noinv=$rowsj->job_card_id;
...
INVOICE
  ...
  <tr height="30">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span align="center">JOB CARD NO : <?php echo $job_card_noinv; ?></span><span style="float:right;">DATE : <?php echo $date_generated;
...
?>
<td ><?php echo $rowsts->task_name .' ('.$rowsts->task_remarks.')';
...
<td >
<strong><strong>Total Task/Labour Cost :</strong></strong>
</td>
<td  align="right"><strong><strong>
<?php
//$consumables=$task_totals*0.15;
...
{
?>
<tr><td align="center" colspan="5"><font color="#ff0000">No task/labour assigned to this invoice created!!</font></td></tr>
<?php
}
...
<table width="700" border="0" align="center">
  <tr height="30">
    <td colspan="6" >Service Manager-----------------------------------Finance Manager------------------------------General Manager--------------------------------</td>
  </tr>
...
<tr>
    <td colspan="6">Terms of payment are the net amount of the invoice in Kenya Shillings
