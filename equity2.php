...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
    ...
    <td colspan="9" height="30" align="center"><font size="+1"><strong>
	 Statement Of  Owners Equity For : </font> <font size="+1" color="#FF6600"><?php 
...
<a target="_blank" style="float:right; margin-right:50px; font-weight:bold; font-size:13px; color:#000000" href="print_owners_equity.php?shares_id=<?php echo $shareholderid; ?>">Print</a>						  
<a  style="float:right; margin-right:30px; font-weight:bold; font-size:13px; color:#000000" href="print_owners_equityword.php?shares_id=<?php echo $shareholderid; ?>">Export To Excel</a>						  
  ...
  <?php 
  $bal=0;
$sql="select * from shareholder_transactions where shareholder_id='$shareholderid' order by transaction_id asc";
