...
header("Content-Disposition: attachment;Filename=Sales_Return_Ledger.doc");
header("Expires: 0");
...
<title>Sales Return Ledger</title>
...
<tr>
  ...
  <tr height="30">
    <td colspan="7" bgcolor="#000033" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">SALES RETURNS LEDGER</span>
...
<div style="float:left; height:30px; "><strong><font size="+1"> All Transactions</font></strong></div>
...
$sql="select  sales_return_ledger.transaction_id,sales_return_ledger.transactions,sales_return_ledger.amount,sales_return_ledger.debit,sales_return_ledger.credit,sales_return_ledger.currency_code,sales_return_ledger.curr_rate,sales_return_ledger.date_recorded, currency.curr_name 
from sales_return_ledger,currency where sales_return_ledger.currency_code=currency.curr_id order by sales_return_ledger.transaction_id asc";
...
<!--<strong>Period From : <font color="#ff0000"><?php echo $date_from; ?></font> To :  <font color="#ff0000"><?php echo $date_to; ?></font> </strong>-->
<div style="float:left; height:30px; "><strong><font size="+1">Transactions From : <?php echo $date_from ?> To: <?php echo $date_to ?>  </font></strong></div>
...
<td><strong>Balance (Bal b/f)</strong></td>



<td colspan="5" align="right"><strong>
<?php 
$sqlbbd="select  sales_return_ledger.transaction_id,sales_return_ledger.transactions,sales_return_ledger.amount,sales_return_ledger.debit,sales_return_ledger.credit,sales_return_ledger.currency_code,sales_return_ledger.curr_rate,sales_return_ledger.date_recorded, currency.curr_name 
from sales_return_ledger,currency where sales_return_ledger.currency_code=currency.curr_id AND date_recorded <'$date_from' order by sales_return_ledger.transaction_id asc";
...
$grnd_amount_out_kshs=0; 
$sql="select  sales_return_ledger.transaction_id,sales_return_ledger.transactions,sales_return_ledger.amount,sales_return_ledger.debit,sales_return_ledger.credit,sales_return_ledger.currency_code,sales_return_ledger.curr_rate,sales_return_ledger.date_recorded, currency.curr_name 
from sales_return_ledger,currency where sales_return_ledger.currency_code=currency.curr_id AND date_recorded BETWEEN '$date_from' AND '$date_to' order by sales_return_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
