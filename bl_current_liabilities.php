...
$sql="select * from account where account_type_id='3'";
...
//$numrowsprof=mysql_num_rows($resultsprof); 
  ...
  if (mysql_num_rows($results) > 0)
              ...
              onmouseout="ChangeColor(this, false);">
							 ...
							 <?php
include ('bl_current_liability_balance.php');
...
/* 	$amount=$rows->amount;
 ...
 <td align="right"><strong><?php echo number_format($current_liab_bal,2); ?></strong></td>
