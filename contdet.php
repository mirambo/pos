...
<form name="emp" id="emp" action="processaddcontacts.php?emp_id=<?php echo $emp_id; ?>" method="post">			
...
echo $rowslatelpo->emp_fname.' '.$rowslatelpo->emp_mname.' '.$rowslatelpo->emp_lname;
  ...
  <tr height="20">
    ...
    <td bgcolor="" width="20%"><input type="text" size="41" name="ssmob1"></td>
    <td width="15%">Southern Sudan 2.</td>
    <td width="5%"><input type="text" name="ssmob2" size="41" /></td>
    <td width="100%" rowspan="10" valign="top"></td>
  </tr>
   <tr height="20">
    
    <td width="10%">Country Of Origin 1.<font color="#FF0000">*</font></td>
    <td bgcolor="" width="20%"><input type="text" size="41" name="comob1"></td>
    <td width="15%">Country Of Origin 2.</td>
    <td width="5%"><input type="text" name="comob2" size="41"  /></td>
    <td width="100%" rowspan="10" valign="top"></td>
  </tr>
  <tr>
   ...
   <tr height="20">
    ...
    <td bgcolor="" width="20%"><input type="text" size="41" name="sstel1"></td>
    <td width="15%">Southern Sudan 2.</td>
    <td width="5%"><input type="text" name="sstel2" size="41" /></td>
    <td width="100%" rowspan="10" valign="top"></td>
  </tr>
   ...
   <tr height="20">
    ...
    <td width="10%">Country Of Origin 1.<font color="#FF0000">*</font></td>
    <td bgcolor="" width="20%"><input type="text" size="41" name="cotel1"></td>
    <td width="15%">Country Of Origin 2.</td>
    <td width="5%"><input type="text" name="cotel2" size="41" /></td>
    <td width="100%" rowspan="10" valign="top"></td>
  </tr> <tr>
  ...
  <tr height="20">
    ...
    <td bgcolor="" width="20%"><input type="text" size="41" name="office_email1"></td>
    <td width="15%">Office 2.</td>
    <td width="5%"><input type="text" name="office_email2" size="41" /></td>
    <td width="100%" rowspan="10" valign="top"></td>
  </tr>
   ...
   <tr height="20">
    ...
    <td bgcolor="" width="20%"><input type="text" size="41" name="private_email1"></td>
    <td width="15%">Private 2.</td>
    <td width="5%"><input type="text" name="private_email2" size="41" /></td>
    <td width="100%" rowspan="10" valign="top"></td>
  </tr>
