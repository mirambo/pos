...
<form name="new_supplier" action="processaddpeter.php" method="post">			
...
?></td>
  ...
  <tr height="20">
    <td bgcolor="">&nbsp;</td>
    <td width="19%">Enter Deduction Name<font color="#FF0000">*</font></td>
    <td width="23%"><input type="text" size="41" name="ded_name"></td>
    <td width="40%" rowspan="6" valign="top"><div id='new_supplier_errorloc' class='error_strings'></div></td>
  </tr>
  
  <tr height="20">
    <td bgcolor="">&nbsp;</td>
    <td width="19%">Enter Rate (%)<font color="#FF0000">*</font></td>
    <td width="23%"><input type="text" size="41" name="ded_amount"></td>
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("ded_name","req",">>Please enter deduction name");
 frmvalidator.addValidation("ded_amount","req",">>Please enter default deduction amount");
