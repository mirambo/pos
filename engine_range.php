...
{
add_engine_range($min_capacity,$max_capacity,$user_id);
}
 ?>
...
?></td>
  ...
  <tr height="20">
    ...
    <td width="23%"><input type="text" size="29" name="min_capacity"></td>
  ...
  <tr height="20">
    ...
    <td><input type="text" size="29" name="max_capacity"></td>
    </tr>
