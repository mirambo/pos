...
<form name="gen_order" action="process_supplier_refund.php" method="post">			
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("client","dontselect=0",">>Please select supplier");
