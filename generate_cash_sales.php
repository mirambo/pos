...
<form name="start_order" action="process_sales.php?cash=1" method="post">	
<?php 
if ($sales_id!=0)
{
...
<h3 align="center">Enter Cash Sales Details</h3>
...
Sales Date<input type="text" name="date_from" size="20" id="date_from" value="<?php echo date('Y-m-d'); ?>" readonly="readonly" />
...
<span style="margin-left:650px;">Delivery Done By : <input type="text" name="delivered_by" size="20" /></span>
...
else
{
 ?>
  ...
  <p align="center"><input type="submit" name="submit" value="Save Sales" style="background:#2E3192; font-size:14px; color:#ffffff; font-weight:bold; width:300px; height:30px; border-radius:5px;"></p>
