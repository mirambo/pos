...
<?php require_once('includes/payslipsubmenu.php');  ?>
		...
		<h3>::List Of All Salary Payments Paid To :
...
salary_payments.mop=mop.mop_id AND salary_payments.currency_code=currency.curr_id AND salary_payments.emp_id='$emp_id'  ORDER BY salary_payments.date_received desc";
...
salary_payments.our_bank,salary_payments.date_paid,salary_payments.receipt_no,salary_payments.date_received,salary_payments.status,currency.curr_name,
salary_payments.currency_code,salary_payments.curr_rate,salary_payments.amount_received FROM mop,salary_payments,currency where 
salary_payments.mop=mop.mop_id AND salary_payments.currency_code=currency.curr_id AND salary_payments.emp_id='$emp_id' AND salary_payments.mop='$client' order by salary_payments.date_paid  desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
...
salary_payments.our_bank,salary_payments.date_paid,salary_payments.receipt_no,salary_payments.date_received,salary_payments.status,currency.curr_name,
salary_payments.currency_code,salary_payments.curr_rate,salary_payments.amount_received FROM mop,salary_payments,currency where 
salary_payments.mop=mop.mop_id AND salary_payments.currency_code=currency.curr_id AND salary_payments.emp_id='$emp_id' and salary_payments.date_paid BETWEEN '$date_from' AND '$date_to' order by salary_payments.date_paid  desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
elseif($client!='0' && $date_from!='' && $date_to!='')
{
...
salary_payments.our_bank,salary_payments.date_paid,salary_payments.receipt_no,salary_payments.date_received,salary_payments.status,currency.curr_name,
salary_payments.currency_code,salary_payments.curr_rate,salary_payments.amount_received FROM mop,salary_payments,currency where 
salary_payments.mop=mop.mop_id AND salary_payments.currency_code=currency.curr_id AND salary_payments.emp_id='$emp_id' and 
salary_payments.date_paid BETWEEN '$date_from' AND '$date_to' and salary_payments.mop='$client' order by salary_payments.date_paid  desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
else
{
	...
	<td align="center"><a href="edit_salary_payments.php?salary_payment_id=<?php echo $salary_payment_id=$rows->salary_payment_id;?>"><img src="images/edit.png"></a></td>
    <td align="center"><a href="delete_salary_payments.php?salary_payment_id=<?php echo $salary_payment_id=$rows->salary_payment_id;?>&emp_id=<?php echo $emp_id; ?>"  onClick="return confirmDelete();"><img src="images/delete.png"></a></td>
