...
$sql3="INSERT INTO temp_assigned_staffold VALUES('', '$project', ' $project_manager','$start_date','$end_date', '$staff', '$job_loc','$segment','0')" or die(mysql_error());
...
//mark the employee is replaced
$sqldt="UPDATE assigned_staffold SET status='5' where project_id='$project'";
$resultsdt= mysql_query($sqldt) or die ("Error $sqldt.".mysql_error());
...
header ("Location:home.php?rotatestaff=rotatestaff&addconfirm=1");
