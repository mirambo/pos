...
$sql="select sales_receipt.sales_rep_id,sales_receipt.receipt_no,sales_receipt.curr_rate,sales_receipt.currency_code,sales_receipt.date_generated,
...
where sales_receipt.client_id=clients.client_id AND sales_receipt.currency_code=currency.curr_id AND sales_receipt.sales_code=invoices.sales_code order by sales_receipt.date_generated desc";
