...
<H2>List Of All Customer Payments (Unapproved)</H2>
...
$sql="select mop.mop_name,clients.c_name,invoice_payments.amount_received,invoice_payments.decription,invoice_payments.status,invoice_payments.receipt_no,invoice_payments.invoice_payment_id,
...
currency where invoice_payments.mop=mop.mop_id and invoice_payments.status='0' AND  invoice_payments.client_id=clients.client_id and  invoice_payments.currency_code=currency.curr_id ORDER BY invoice_payments.date_received desc ";
...
{
//echo "client only";
$sql="select mop.mop_name,clients.c_name,invoice_payments.amount_received,invoice_payments.status,invoice_payments.receipt_no,invoice_payments.invoice_payment_id,
invoice_payments.mop,invoice_payments.ref_no,invoice_payments.sales_rep,invoice_payments.client_bank,invoice_payments.our_bank,invoice_payments.date_paid,
invoice_payments.sales_code_id,invoice_payments.receipt_no,invoice_payments.date_received,invoice_payments.status,currency.curr_name,
invoice_payments.currency_code,invoice_payments.curr_rate,invoice_payments.amount_received FROM clients,mop,invoice_payments,
currency where invoice_payments.mop=mop.mop_id and invoice_payments.client_id=clients.client_id 
AND  invoice_payments.currency_code=currency.curr_id and invoice_payments.status='0' AND invoice_payments.client_id='$client' order by invoice_payments.invoice_payment_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
...
invoice_payments.sales_code_id,invoice_payments.receipt_no,invoice_payments.date_received,invoice_payments.status,currency.curr_name,
invoice_payments.currency_code,invoice_payments.curr_rate,invoice_payments.amount_received FROM clients,mop,invoice_payments,
currency where invoice_payments.mop=mop.mop_id and invoice_payments.status='0' and invoice_payments.client_id=clients.client_id AND  invoice_payments.currency_code=currency.curr_id and invoice_payments.date_received BETWEEN '$date_from' AND '$date_to' order by invoice_payments.invoice_payment_id  desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
elseif($client!='0' && $date_from!='' && $date_to!='')
{
...
invoice_payments.sales_code_id,invoice_payments.receipt_no,invoice_payments.date_received,invoice_payments.status,currency.curr_name,
invoice_payments.currency_code,invoice_payments.curr_rate,invoice_payments.amount_received FROM clients,mop,invoice_payments,
currency where invoice_payments.mop=mop.mop_id and invoice_payments.status='0' and invoice_payments.status='0' and invoice_payments.client_id=clients.client_id AND  invoice_payments.currency_code=currency.curr_id and invoice_payments.date_received BETWEEN '$date_from' AND '$date_to' and invoice_payments.client_id='$client' order by invoice_payments.invoice_payment_id  desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
invoice_payments.sales_code_id,invoice_payments.receipt_no,invoice_payments.date_received,invoice_payments.status,currency.curr_name,
invoice_payments.currency_code,invoice_payments.curr_rate,invoice_payments.amount_received FROM clients,mop,invoice_payments,
currency where invoice_payments.mop=mop.mop_id and invoice_payments.status='0' and invoice_payments.client_id=clients.client_id and invoice_payments.status='0' 
