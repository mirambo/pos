...
<form name="emp" id="emp" action="processeditvisa.php?emp_id=<?php echo $emp_id; ?>" method="post">			
...
$sql="SELECT * FROM staff_visas WHERE emp_id='$emp_id'";
...
echo $rowslatelpo->emp_fname.' '.$rowslatelpo->emp_mname.' '.$rowslatelpo->emp_lname;
  ...
  <tr height="20">
	...
	<input type="radio" name="visa_type" value="Single" checked>Single &nbsp;&nbsp;<input type="radio" name="visa_type" value="Multiple">Multple
	<?php
	}
	elseif ($visa_type=='Multiple')
	{
	?>
	<input type="radio" name="visa_type" value="Single">Single &nbsp;&nbsp;<input type="radio" name="visa_type" value="Multiple" checked>Multple
	<?php
   }
   else
   {?>
   <input type="radio" name="visa_type" value="Single">Single &nbsp;&nbsp;<input type="radio" name="visa_type" value="Multiple">Multple
   <?php 
   }
	?>
	</td>
  ...
  <tr height="20">
    ...
    <td><textarea name="visa_remarks" rows="5" cols="35"><?php echo $rows->visa_remarks; ?></textarea>
