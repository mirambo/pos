...
header("Content-Disposition: attachment;Filename=Cash_Ledger.xlsx");
header("Expires: 0");
...
$rowscont=mysql_fetch_object($resultscont);*/
  ...
  <tr height="30">
    <td colspan="7" bgcolor="#67C6FE" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">CASH LEDGER</span>
...
$sql="select  cash_ledger.transaction_id,cash_ledger.transactions,cash_ledger.amount,cash_ledger.debit,cash_ledger.credit,cash_ledger.currency_code,cash_ledger.curr_rate,cash_ledger.date_recorded, currency.curr_initials 
...
$sql="select cash_ledger.transaction_id,cash_ledger.transactions,cash_ledger.amount,cash_ledger.debit,cash_ledger.credit,cash_ledger.currency_code,cash_ledger.curr_rate,cash_ledger.date_recorded, currency.curr_initials 
from cash_ledger,currency where cash_ledger.currency_code=currency.curr_id and cash_ledger.date_recorded BETWEEN '$date_from' AND '$date_to' order by cash_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
