...
<?php require_once('includes/employeessubmenu.php');  ?>
		...
		<h3>:: Statement Of Account for Staff : <?php 
		$sqlclient="select * from employees where emp_id='$id'";
		$resultsclient= mysql_query($sqlclient) or die ("Error: $sqlclient.".mysql_error());
        $rowsclient=mysql_fetch_object($resultsclient);
		
		echo $rowsclient->emp_firstname.' '.$rowsclient->emp_lastname;
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
	...
	Statement Of Account for Staff: </font> <font size="+1" color="#FF6600"><?php 
	...
	<a href="print_staff_statement.php?emp_id=<?php echo $id; ?>" target="_blank">Print</a> | <a href="print_staff_statement_word.php?emp_id=<?php echo $id; ?>">Export to word </a>
...
/*$sqlob="select opening_balance from employees where emp_id='$id'";
...
echo $transaction=$rows->transaction; 
	...
	<td>KSHS <?php echo number_format($amountxx=$rows->amount,2); ?></td>
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
	...
	<a href="print_staff_statement.php?emp_id=<?php echo $id; ?>&date_from=<?php echo $date_from; ?>&date_to=<?php echo $date_to;?>" target="_blank">Print</a> | <a href="print_staff_statement_word.php?emp_id=<?php echo $id; ?>&date_from=<?php echo $date_from; ?>&date_to=<?php echo $date_to;?>">Export to word </a>
...
$sqlbd="select * from client_transactions where emp_id='$id' and amount!='0' and amount!='-0' and amount!='-' AND date_recorded <'$date_from'";
...
$sql="select * from client_transactions where emp_id='$id' and amount!='0' and amount!='-0' and amount!='-' AND date_recorded BETWEEN '$date_from' AND '$date_to'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
$sql="select * from client_transactions where emp_id='$id' and amount!='0' and amount!='-0' and amount!='-'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
