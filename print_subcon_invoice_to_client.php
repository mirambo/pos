...
$sub_contractor=$_GET['sub_contractor'];;
...
$querysubcon="select * from omconsultants where consultant_id ='$sub_contractor'";
$resultssubcon=mysql_query($querysubcon) or die ("Error: $querysubcon.".mysql_error());
$rowssubcon=mysql_fetch_object($resultssubcon);
  ...
  <tr>
	...
	Department For Month of <?php echo $current_month;?> By <strong><?php echo $rowssubcon->cons_name;?></strong> Subcontractor
...
<table width="700" border="0" align="center" class="table">
   <tr  style="background:url(images/description.gif);" height="30">
	...
	<td  width="30%">Other Charges</td>
	<td align="center" width="20%"></td>
	  
	<td align="right" width="100"><strong><?php echo number_format($other_charges,2);?></strong></td>
	...
	<td align="right" width="100"><font size="+1"><strong><?php $grnd_ttl=$manhours_charges+$per_dm+$visa_charges+$flight_charges+$other_charges; 
	...
	<td  width="30%" colspan="4"><strong>Remarks:</strong><br/><br/>
	
	  
	<?php echo $remarks;?></strong></td>
...
<table width="700" border="1" align="center" class="table">
  ...
  <tr height="40" align="right">
    <td colspan="6" ><i>Generated By :<?php 
