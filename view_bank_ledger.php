...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
	...
	<a href="print_bank_ledger.php" target="_blank">Print</a>|<a href="print_bank_ledger_word.php">Export to word </a>
...
from bank_ledger,currency where bank_ledger.currency_code=currency.curr_id AND bank_ledger.amount!='' and bank_ledger.amount!='0'  order by bank_ledger.transaction_id asc";
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
    ...
    <td colspan="9" height="30" align="right"><font size="+1">
	<a href="print_bank_ledger.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to; ?>" target="_blank">Print</a> | <a href="print_bank_ledger_word.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to; ?>">Export to word </a>
...
<?php 
$sqlbbd="select  bank_ledger.transaction_id,bank_ledger.transactions,bank_ledger.amount,bank_ledger.debit,bank_ledger.credit,bank_ledger.currency_code,bank_ledger.curr_rate,bank_ledger.date_recorded, currency.curr_name 
from bank_ledger,currency where bank_ledger.currency_code=currency.curr_id AND date_recorded <'$date_from' order by bank_ledger.transaction_id asc";
...
$grnd_amount_out_kshs=0; 
$sql="select  bank_ledger.transaction_id,bank_ledger.transactions,bank_ledger.amount,bank_ledger.debit,bank_ledger.credit,bank_ledger.currency_code,bank_ledger.curr_rate,bank_ledger.date_recorded, currency.curr_name 
from bank_ledger,currency where bank_ledger.currency_code=currency.curr_id AND date_recorded BETWEEN '$date_from' AND '$date_to' order by bank_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
$grnd_amount_out_kshs=0; 
$sql="select  bank_ledger.transaction_id,bank_ledger.transactions,bank_ledger.amount,bank_ledger.debit,bank_ledger.credit,bank_ledger.currency_code,bank_ledger.curr_rate,bank_ledger.date_recorded, currency.curr_name 
from bank_ledger,currency where bank_ledger.currency_code=currency.curr_id order by bank_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
