...
<?php require_once('includes/supplier_payment_submenu.php');  ?>
		...
		<h3>::List of All Payments Made To Suppliers</h3>
...
$queryop="select * FROM suppliers,mop,supplier_payments,currency where supplier_payments.mop=mop.mop_id and supplier_payments.supplier_id=suppliers.supplier_id and supplier_payments.currency_code=currency.curr_id  ORDER BY supplier_payments.date_received desc ";
...
echo $date_received=$rows->date_paid; 
	...
	<td><a style="font-weight:bold; color:#000;" href="begin_order.php?order_code=<?php echo $invoice_id;?>">
...
?>
	...
	<td align="center"><a href="pay_supplier.php?invoice_payment_id=<?php echo $rows->supplier_payment_id; ?>"><img src="images/edit.png"></a></td>
