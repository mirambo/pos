...
$sql1= "INSERT INTO items SELECT * FROM suspended_items where item_id='$sales_id'";
...
$sql2= "delete from suspended_items where item_id='$sales_id'";
...
$sqlauditsav= "insert into audit_trail values('','$user_id',NOW(),'Activated an item from the system')";
