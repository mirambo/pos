...
$return_quant=$_GET['return_quant'];
?>
...
<body>
	...
	<div id="page-wrap">
		...
		<h3>:: Return Product to the Supplier</h3>
...
<form name="rec_prod" action="processreturnprod.php" method="post">	
<?php 
...
if ($_GET['abnormal']==1)
echo '<div align="center" style="background: #FFCC33; height:20px; width:600px; border:#FF0000 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#FF0000" >Sorry!! quantity to be returned cannot be more than received one or quanity order</font></strong></p></div>';
...
?></td>
  ...
  <tr height="30" bgcolor="#ffff99">
    <td bgcolor="">&nbsp;</td>
    <td width="19%">Enter Quantity To be Returned<font color="#FF0000">*</font></td>
    <td width="23%"><input type="text" size="41" name="return_quant" value="<?php echo $return_quant; ?>"></td>
    </tr>
