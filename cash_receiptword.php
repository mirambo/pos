...
$rowscont=mysql_fetch_object($resultscont);
  ...
  <tr>
    <td colspan="7" align="right"><a href="begin_cash_sales.php"><div style="background-image:url(images/generate_another.jpg); width:201px; height:32px; float:left;"></div></a><img src="http://localhost/brisk_sys/images/logolpo.png" /></td>
  </tr>
  <tr>
...
$transaction_desc='Cash Sales Receipt No:'.$receipt_no;
...
$sqltrans= "insert into client_transactions values('','$client_id','$sales_code','Contra Cash Sales Receipt No:$receipt_no','-$client_amnt_kshs',NOW())";
$resultstrans=mysql_query($sqltrans) or die ("Error $sqltrans.".mysql_error());
