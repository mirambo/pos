...
{
    return confirm("Are you sure you want to procees with reconcilliation");
}
...
<body>
	...
	<?php require_once('includes/bank_reconcilliation_submenu.php');  ?>
		...
		<h3>:: Reconcile  System Bank Statement</h3>
...
<form name="emp" id="emp" action="process_reconcile_system_statement.php" method="post">			
...
if (mysql_num_rows($resultscurr) > 0)
{
    ...
    <td width="30%" rowspan="3" align="left" valign="top"><div id='emp_errorloc' class='error_strings'></div></td>
	<td></td>
  </tr>
   <tr height="20">
    <td>&nbsp;</td>
...
<tr height="50">
    <td>&nbsp;</td>
    <td></td>
    <td><input type="submit" name="submit" onClick="return confirmDelete();" Value="Proceed!!">&nbsp;&nbsp;&nbsp;<input type="reset"  Value="Cancel"></td>
    </tr>
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("date_from","req",">>Please enter period from");
 frmvalidator.addValidation("date_to","req",">>Please enter period to");
