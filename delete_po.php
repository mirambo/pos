...
$sql= "delete from temp_purchase_order where temp_purchase_order_id='$id'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());

$sql= "delete from purchase_order where temp_purchase_order_id='$id'";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());



header ("Location:generate_order.php? deletepoconfirm=1");
