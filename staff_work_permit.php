...
<form name="emp" id="emp" action="processaddworkpermit.php?emp_id=<?php echo $emp_id; ?>" method="post">			
...
echo $rowslatelpo->emp_fname.' '.$rowslatelpo->emp_mname.' '.$rowslatelpo->emp_lname;
  ...
  <tr height="20">
    ...
    <td bgcolor="" width="20%"><input type="text" size="41" name="work_permit_no"></td>
  ...
  <tr height="20">
    ...
    <td><textarea name="work_permit_remarks" rows="5" cols="35"></textarea>
