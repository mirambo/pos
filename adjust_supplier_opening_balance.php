...
{
    return confirm("Are you sure you want to adjust supplier balance?");
}
</script>
...
<body>
	...
	<div id="page-wrap">
		...
		<h3>:: Adjust Supplier Statement Balance Into the system </h3>
...
<form name="new_user" action="processadjustsupplierbal.php" method="post">			
