...
if ($user_id==526 || $user_id==91)
{
$sql="select modules.module_name,modules.link,modules.module_id from modules,user_group_module where 
modules.module_id=user_group_module.module_id and user_group_id='$user_group_id' AND modules.status='0' 
order by modules.sort_order asc";	
...
$sql="select modules.module_name,modules.link,modules.module_id from modules,user_group_module where 
modules.module_id=user_group_module.module_id and user_group_id='$user_group_id' AND modules.status='0' 
and modules.module_id!='37' order by modules.sort_order asc";
