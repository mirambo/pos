...
$sql="SELECT * FROM banks,cheque_withdrawals,currency where cheque_withdrawals.bank_withdrawn=banks.bank_id AND currency.curr_id=cheque_withdrawals.curr_id order by cheque_withdrawals.cheque_withdrawal_id desc";
...
<body>
	...
	<div id="page-wrap">
		...
		<h3>:: Update  Cheque Withdrawal Details </h3>
...
<form name="new_supplier" action="processeditchequewithdrawal.php?cheque_withdrawal_id=<?php echo $id;?>" method="post">			
...
echo '<div align="center" style="background: #FFCC33; height:20px; width:600px; border:#339900 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#339900" >Cheque Withdrawal Updated Successfully!!</font></strong></p></div>';
?>
...
if (mysql_num_rows($resultscurr) > 0)
{
	...
	<tr height="20">
    <td bgcolor="">&nbsp;</td>
    <td width="19%" valign="top">Account Withdrawn From<font color="#FF0000">*</font></td>
...
if (mysql_num_rows($resultscurr) > 0)
{
   ...
   <!--<tr height="20">
	...
	<tr height="20">
    <td>&nbsp;</td>
    <td>Cheque Date<font color="#FF0000">*</font></td>
  ...
  <tr height="20">
    ...
    <td><input type="text" name="date_deposited" size="40" id="date_deposited" readonly="readonly" value="<?php echo $rows->date_withdrawn;?>"/><input name="DateFormats" id="DateFormats" disabled value="dd/mm/yyyy" type="hidden"></td>
    </tr>
  <tr height="20">
    <td bgcolor="">&nbsp;</td>
