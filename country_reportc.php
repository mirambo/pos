...
<a target="_blank" style="float:right; margin-right:200px; font-weight:bold; font-size:13px; color:#000000" href="print_list_proforma.php">Print</a>						  
...
echo $rowst->f_name;
	...
	<td align="center"><a href="generate_proforma_invoice.php?sales_id=<?php echo $rows->sales_id;?>">View invoice Details</a></td>
<!--
