...
<table width="65%" border="0" align="center" style="margin:auto">
<?php 
...
<div style="float:right;"><strong> Date Printed : <?php echo date('d F, Y')?></strong></div></td>
	...
	<td width="2%"><div align="center"><strong>Amount (Tshs)</strong></div></td>
    <td width="2%" colspan="2"><div align="center"><strong>Amount (Tshs)</strong></div></td>
  ...
  <tr  height="30"  bgcolor="#FFFFCC">
    <td width="5%" colspan="6"><div align="left"><strong><font size="">ASSETS</font></strong></div></td>
  </tr>
...
<tr height="10" bgcolor="#FFFFCC">
	...
	<td></td>
	<td align="right"N colspan="2"><?php echo number_format($net_acc_rec=$accounts_receivables+$notes_receivables+$ledger_bal_prepaid_exp+$ledger_bal_prepaid_sal,2); ?></td>
...
<tr height="10" bgcolor="#FFFFCC">
    <td width="10%" colspan="4"><strong><font size="">Total Assets</font></strong></td>
    
	
    <td width="2%" colspan="2" align="right"><strong><font size=""><?php echo number_format($ttl_assets=$grnd_curr_value+$ttl_curr_assets,2) ?></font></strong><hr/><hr/></td>
...
<tr  height="30"  bgcolor="#FFFFCC">
    <td width="5%" colspan="6"><div align="left"><strong><font size="">EQUITY AND LIABILITIES</font></strong></div></td>
...
<tr height="10" bgcolor="#FFFFCC">
    <td width="10%" colspan="4"><strong><font size="">Total Liabilities and Owner's Equity </font></strong></td>
    
	
    <td width="2%" colspan="2" align="right"><strong><font size=""><?php echo number_format($ttl_liablities=$capbal+$ttl_long_term_loans+$ttl_current_liability,2) ?></font></strong><hr/><hr/></td>
