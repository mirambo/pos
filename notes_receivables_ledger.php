...
<body>
	...
	<?php require_once('includes/notesreceivableledgersubmenu.php');  ?>
		
		<h3>::Notes Receivables Legder Ledger</h3>
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
	...
	Notes Receivables Legder</strong></font>
...
from notes_receivables_ledger,currency where notes_receivables_ledger.currency_code=currency.curr_id order by notes_receivables_ledger.transaction_id asc";
...
<?php 
$sqlbbd="select  notes_receivables_ledger.transaction_id,notes_receivables_ledger.transactions,notes_receivables_ledger.amount,notes_receivables_ledger.debit,notes_receivables_ledger.credit,notes_receivables_ledger.currency_code,notes_receivables_ledger.curr_rate,notes_receivables_ledger.date_recorded, currency.curr_name 
from notes_receivables_ledger,currency where notes_receivables_ledger.currency_code=currency.curr_id AND date_recorded <'$date_from' order by notes_receivables_ledger.transaction_id asc";
...
$grnd_amount_out_kshs=0; 
$sql="select  notes_receivables_ledger.transaction_id,notes_receivables_ledger.transactions,notes_receivables_ledger.amount,notes_receivables_ledger.debit,notes_receivables_ledger.credit,notes_receivables_ledger.currency_code,notes_receivables_ledger.curr_rate,notes_receivables_ledger.date_recorded, currency.curr_name 
from notes_receivables_ledger,currency where notes_receivables_ledger.currency_code=currency.curr_id AND date_recorded BETWEEN '$date_from' AND '$date_to' order by notes_receivables_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
