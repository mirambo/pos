...
AND order_code_get.supplier_id=suppliers.supplier_id and order_code_get.status='2' and mop_id!='dr' order by order_code_get.order_code_id 
desc";
...
{
$sql="select * FROM currency,suppliers,order_code_get WHERE order_code_get.currency=currency.curr_id 
AND order_code_get.supplier_id=suppliers.supplier_id and order_code_get.status='2' and mop_id!='dr' and 
order_code_get.supplier_id='$supplier' 
...
$sql="select * FROM currency,suppliers,order_code_get WHERE order_code_get.currency=currency.curr_id 
AND order_code_get.supplier_id=suppliers.supplier_id and order_code_get.status='2' and mop_id!='dr' AND 
order_code_get.date_generated BETWEEN '$date_from' AND '$date_to' order by order_code_get.order_code_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
AND order_code_get.date_generated BETWEEN '$date_from' AND '$date_to' AND order_code_get.supplier_id='$supplier' 
order by order_code_get.order_code_id desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
