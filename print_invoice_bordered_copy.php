...
<body onloadff="window.print();" style="background:none;">
...
<table width="650" class="table" border="1" height="50" align="center">
...
<div style="width:646px; height:450px; background:#fff; border-top:none; margin:auto; border-right:2px solid #000; border-left:2px solid #000;">
<table width="650"  border="0" align="center" style="margin:auto;">
<?php
$task_totals=0;
...
<td width="60%"><?php echo $rowsts->item_name;?></td>
...
<td width="10%" align="right"><?php echo number_format($discount,2);?></td>
