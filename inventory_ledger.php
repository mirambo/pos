...
<body>
	...
	<?php require_once('includes/inventortledgersubmenu.php');  ?>
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
	...
	Stock /Inventory Ledger </strong></font>
	...
	<a href="print_inventory_ledger.php" target="_blank">Print</a>|<a href="print_inventory_ledger_word.php">Export to word </a>
...
$sql="select  inventory_ledger.transaction_id,inventory_ledger.transactions,inventory_ledger.amount,inventory_ledger.debit,inventory_ledger.credit,inventory_ledger.currency_code,inventory_ledger.curr_rate,inventory_ledger.date_recorded, currency.curr_name 
from inventory_ledger,currency where inventory_ledger.currency_code=currency.curr_id order by inventory_ledger.transaction_id asc";
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
    ...
    <td colspan="9" height="30" align="right"><font size="+1">
	<a href="print_inventory_ledger.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to; ?>" target="_blank">Print</a> | <a href="print_inventory_ledger_word.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to; ?>">Export to word </a>
...
<?php 
$sqlbbd="select  inventory_ledger.transaction_id,inventory_ledger.transactions,inventory_ledger.amount,inventory_ledger.debit,inventory_ledger.credit,inventory_ledger.currency_code,inventory_ledger.curr_rate,inventory_ledger.date_recorded, currency.curr_name 
from inventory_ledger,currency where inventory_ledger.currency_code=currency.curr_id AND date_recorded <'$date_from'order by inventory_ledger.transaction_id asc";
...
$grnd_amount_out_kshs=0; 
$sql="select  inventory_ledger.transaction_id,inventory_ledger.transactions,inventory_ledger.amount,inventory_ledger.debit,inventory_ledger.credit,inventory_ledger.currency_code,inventory_ledger.curr_rate,inventory_ledger.date_recorded, currency.curr_name 
from inventory_ledger,currency where inventory_ledger.currency_code=currency.curr_id AND date_recorded BETWEEN '$date_from' AND '$date_to' order by inventory_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
