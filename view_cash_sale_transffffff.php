...
<body>
	...
	<div id="page-wrap">
		...
		<h3>:: Cash Sales Generated to Client : <?php
...
?> <span style="color:#000066"><?php echo $rows->c_name;
		 ...
		 ?>  </span>Cash Sales Receipt Number : <span style="color:#000066"><?php echo $receipt_no;
...
?></td>
  ...
  <tr bgcolor="#000033" height="30">
	...
	<span style="color:#FFFFFF; float:right;"><a target="_blank" href="cash_receipt2.php?client_id=<?php echo $get_client_id; ?>
	&sales_code=<?php echo $get_sales_code; ?>&receipt_no=<?php echo $receipt_no; ?>&currency=<?php echo $currency;?>&curr_rate=<?php echo $curr_rate;?>&inv_bal=
	<?php echo $inv_bal ?>&date_generated=<?php echo $date_generated;?>&user=<?php echo $user; ?> "style="color:#FFFFFF;">Print Cash Sale Receipt</a> | 

	<span style="color:#FFFFFF; float:right;"><a href="cash_receiptword2.php?client_id=<?php echo $get_client_id; ?>
	&sales_code=<?php echo $get_sales_code; ?>&receipt_no=<?php echo $receipt_no; ?>&currency=<?php echo $currency;?>&curr_rate=<?php echo $curr_rate;?>&inv_bal=
	<?php echo $inv_bal ?>&date_generated=<?php echo $date_generated;?>&user=<?php echo $user; ?> "style="color:#FFFFFF;"> Export Cash Sale Receipt to Word</a> | </td>
...
$grnddisc=0;
$grndttl=0;
$sqllpdet="select cash_sales.cash_sales_id,cash_sales.temp_cash_sales_id,cash_sales.quantity,cash_sales.selling_price,cash_sales.product_code,cash_sales.vat_value,cash_sales.discount_perc,
cash_sales.discount_value,products.product_name,products.pack_size from cash_sales, products where cash_sales.product_id=products.product_id and cash_sales.sales_code='$get_sales_code' order by cash_sales.cash_sales_id asc";
