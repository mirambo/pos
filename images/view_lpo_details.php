...
<script src="js/application.js" type="text/javascript" charset="utf-8"></script>
	...
	Print LPO	
		...
		<a style="float:right; margin-right:50px;"  href="email_lpo.php?order_code=<?php echo $order_code; ?>">
...
<strong>Supplier : </strong><i><?php echo $supplier_name=$rowsrec->supplier_name;  ?></i>
	...
	<strong>Expiry Date : </strong><i><?php echo $rowsrec->lpo_expiry_date;  ?></i> 
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>
<td ><?php echo $rowslpdet->item_name.' ('.$rowslpdet->pack_size.')'; ?></td>
...
<td align="center"><?php 
	...
	<a  href="#" onClick="window.open('edit_lpo_trans.php?purchase_order_id=<?php echo $rowslpdet->purchase_order_id; ?>&order_code=<?php echo $order_code; ?>&approved=1','','scrollbars=no,menubar=no,height=300,width=800,resizable=yes,toolbar=no,location=no,status=no')"><img src="images/edit.png"></a>
