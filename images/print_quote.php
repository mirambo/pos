...
$sqlj= "SELECT * FROM quote WHERE sales_id='$sales_id'";
...
$customer_name=$rowsj->customer_name;
$customer_phone=$rowsj->phone;
$customer_email=$rowsj->email;
...
<strong>Website : </strong><?php echo $rowscont->fax; ?></br>
  ...
  <strong></strong> <?php echo $customer_name; ?>gg</br>
  <strong> </strong><?php echo $customer_phone; ?></br>
   <strong></strong><?php echo $customer_email; ?></br>
...
<?php
$task_totals=0;
$sqlts="select * FROM quote_item,items WHERE quote_item.item_id=items.item_id AND 
...
?>
		...
		<?php echo $rowsts->item_name; ?></td>

  

		<td align="right"><?php echo number_format($unit_cost=$rowsts->item_cost,2);?></td>
...
?>		
  ...
  <tr>
    <td colspan="3" align="right"><strong><em>Created by :
         <?php 
