...
$transaction_descbs='Expenses Payment ('.$exp_cat_name.') through Bank Transfer. Ref No : '.$transaction_code;
$transaction_descch='Expenses Payment ('.$exp_cat_name.') through Cheque. Ref No : '.$cheque_no;
