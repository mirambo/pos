...
<?php require_once('includes/expensessubmenu.php');  ?>
		...
		<h3>::List Of All Expenses Recorded</h3>
...
<a target="_blank" style="float:right; margin-right:100px; font-weight:bold; font-size:13px; color:#000000" href="print_list_expenses.php?client=<?php echo $client?>&date_from=<?php echo $date_from ?>&date_to=<?php echo $date_to ?>">Print</a>						  
   ...
   <tr style="background:url(images/description.gif);" height="30" >
	...
	<td width="300"><div align="center"><strong>Amount Received (Kshs)</strong></td>
	 ...
	 <td width="300" ><div align="center"><strong>Client Bank</strong></td>
	<td width="300"><div align="center"><strong>Our Bank</strong></td>
...
$sql="select * FROM mop,expenses,currency where 
expenses.mop=mop.mop_id AND expenses.currency_code=currency.curr_id ORDER BY expenses.date_received desc";
...
//echo "client only";
$sql="select * FROM mop,expenses,currency where 
expenses.mop=mop.mop_id AND expenses.currency_code=currency.curr_id and expenses.exp_cat_id='$client' order by expenses.date_paid  desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
...
//echo "Dea only";
$sql="SELECT * FROM mop,expenses,currency where 
expenses.mop=mop.mop_id AND expenses.currency_code=currency.curr_id and expenses.date_paid BETWEEN '$date_from' AND '$date_to' order by expenses.date_paid  desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
elseif($client!=0 && $date_from!='' && $date_to!='')
{
...
$sql="SELECT * FROM mop,expenses,currency where 
expenses.mop=mop.mop_id AND expenses.currency_code=currency.curr_id and 
expenses.date_paid BETWEEN '$date_from' AND '$date_to' and expenses.exp_cat_id='$client' order by expenses.date_paid  desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
else
{
	...
	<td align="center"><a href="edit_expenses.php?expenses_id=<?php echo $rows->expenses_id;?>"><img src="images/edit.png"></a></td>
