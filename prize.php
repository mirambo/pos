...
<form name="emp" id="emp" action="processprize.php?emp_id=<?php echo $emp_id; ?>" method="post">			
...
if ($_GET['success']==1)
echo '<div align="center" style="background: #FFCC33; height:20px; width:400px; border:#ff0000 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#ff0000" >Record Saved Successfully!!</font></strong></p></div>';
...
?></td>
  ...
  <tr height="20">
	...
	<td colspan="4" ><h3>Prize And Honours Details - Prize And Honours Details for (<?php 
...
echo $rowslatelpo->emp_fname.' '.$rowslatelpo->emp_mname.' '.$rowslatelpo->emp_lname;
    ...
    <td valign="top" width="18%">Describe Prize and Honours Received</td>
    <td><textarea name="prize" rows="8" cols="55"></textarea>
