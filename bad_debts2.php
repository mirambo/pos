...
?>
  ...
  <?php  
$sql="select doubtful_debts.doubtful_debt_id,doubtful_debts.client_id,doubtful_debts.curr_rate,doubtful_debts.date_received,invoices.invoice_no,invoices.invoice_id,
doubtful_debts.amount,doubtful_debts.sales_code, currency.curr_name,clients.c_name from doubtful_debts,clients,invoices,
currency where doubtful_debts.client_id=clients.client_id AND doubtful_debts.sales_code=invoices.sales_code AND 
...
$sqldc="SELECT sales_code from bad_debts where sales_code='$sales_code1'";
...
<a href="declare_bad_debts.php?doubtful_debt_id=<?php echo $rows->doubtful_debt_id;?>" style="color:#000099;">Write Off Bad Debts</a>
