...
/*$sqlsp="SELECT nrc_project.project_id, nrc_sub_project.sub_project_name, nrc_sub_project.sub_project_code, nrc_subprojectvsarea.sub_project_id, nrc_area.area_id, nrc_area.area_id
FROM nrc_set_template,nrc_cc,nrc_project, nrc_sub_project, nrc_subprojectvsarea, nrc_area
...
AND nrc_subprojectvsarea.sub_project_id = nrc_sub_project.sub_project_id
AND nrc_subprojectvsarea.area_id = nrc_area.area_id
AND nrc_area.area_id=$area_id
...
//filter subprojects when area only is selected
...
//filter subprojects when area and core competency is selected
elseif ( $area_id!=0 && $cc_id!=0 && $project_id==0 && $date_from=='' && $date_to=='')
{
...
//filter subprojects when area and project is selected
elseif ( $area_id!=0 && $cc_id==0 && $project_id!=0 && $date_from=='' && $date_to=='')
{
$sqlsp="SELECT nrc_set_template.set_template_id,nrc_sub_project.sub_project_id,nrc_cc.cc_name,nrc_project.status,nrc_sub_project.sub_project_name,nrc_sub_project.sub_project_code FROM nrc_set_template
INNER JOIN nrc_cc ON nrc_cc.cc_id=nrc_set_template.cc_id
...
//filter subprojects when area and period is selected
elseif ( $area_id!=0 && $cc_id==0 && $project_id==0 && $date_from!='' && $date_to!='')
{
...
//filter subprojects when area and project and competency is selected
elseif ( $area_id!=0 && $cc_id!=0 && $project_id!=0 && $date_from=='' && $date_to=='')
{
$sqlsp="SELECT nrc_set_template.set_template_id,nrc_sub_project.sub_project_id,nrc_cc.cc_name,nrc_project.status,nrc_sub_project.sub_project_name,nrc_sub_project.sub_project_code FROM nrc_set_template
INNER JOIN nrc_cc ON nrc_cc.cc_id=nrc_set_template.cc_id
...
//filter subprojects when area  and competency and period is selected
elseif ( $area_id!=0 && $cc_id!=0 && $project_id==0 && $date_from!='' && $date_to!='')
{
$sqlsp="SELECT nrc_set_template.set_template_id,nrc_sub_project.sub_project_id,nrc_cc.cc_name,nrc_project.status,nrc_sub_project.sub_project_name,nrc_sub_project.sub_project_code FROM nrc_set_template
INNER JOIN nrc_cc ON nrc_cc.cc_id=nrc_set_template.cc_id
...
//filter subprojects when area  and project and period is selected
elseif ( $area_id!=0 && $cc_id==0 && $project_id!=0 && $date_from!='' && $date_to!='')
{
$sqlsp="SELECT nrc_set_template.set_template_id,nrc_sub_project.sub_project_id,nrc_cc.cc_name,nrc_project.status,nrc_sub_project.sub_project_name,nrc_sub_project.sub_project_code FROM nrc_set_template
INNER JOIN nrc_cc ON nrc_cc.cc_id=nrc_set_template.cc_id
