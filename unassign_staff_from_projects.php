...
self.location='home.php?deletestafftoprojects=deletestafftoprojects&project=' + val ;
...
<form name="emp" id="emp" onsubmit="return checkTheBox();" action="process_unassign_staff_from_project.php?original_bunch_id=<?php echo $original_bunch_id;?>&period_to=<?php echo $period_to; ?>&job_cat_id=<?php echo $job_cat_id;?>" method="post">			
...
?></td>
    ...
    <td width="15%">
	<select name="project" id="project" onChange="reload(this.form)">
	<?php
...
<?php  
  ...
  <tr bgcolor="#FF9900"><td colspan='5'><strong><font size="+1">National Staff</font></strong></td></tr> 
	...
	<?php
								  ...
								  $queryst="SELECT projects.project_id,assigned_staffold.project_manager,operations.operation_name,clients.c_name,employees.emp_id,employees.staff_type,employees.emp_fname,employees.emp_mname,
...
and assigned_staffold.status!='3' and employees.staff_type='1' and projects.project_id='$project' AND employees.emp_id=assigned_staffold.staff order by clients.c_name asc";
...
echo '<tr bgcolor="#FFFFCC" height="10" >';
	  ...
	  <td><input type="checkbox" name="staff[]" value="<?php echo $rowsst->emp_id;?>"></td>
	   ...
	   <td align="center">
	   <?php echo $work_place=$rowsst->work_place; 
	   
	   if ($work_place=='Office')
	   {
	   ?>
	   <!--<input type="checkbox" name="job_loc[]" value="Office" checked>Office &nbsp;&nbsp;
	   <input type="checkbox" name="job_loc[]" value="Field" readonly>Field-->
	   <?php
		}
		elseif ($work_place=='Field')
		{
	   ?>
	   <!--<input type="checkbox" name="job_loc[]" value="Office">Office &nbsp;&nbsp;
	   <input type="checkbox" name="job_loc[]" value="Field" checked>Field--></td>
	   <?php 
	   }
	...
	&nbsp;&nbsp;<input type="checkbox" name="segment[]" value="PP">Power Plant-->
									  ...
									  {
									  ?>
								<tr bgcolor="#FFFFCC"><td colspan='5' align="center" height="40"><font color="#ff0000"><strong>
								<?php
if ($project=='')
{
?>
Select the project to load assigned national staff here!!
<?php
}
else
{
?>
Sorry!! No national staff allocated on this project
<?php
} 
?>		
</strong></td></tr> 	  
...
employees.emp_lname,omjob_titles.omjob_title_name,job_category.job_cat_name,assigned_staffold.assigned_staff_id,assigned_staffold.entry_date,assigned_staffold.exit_date,assigned_staffold.work_place,assigned_staffold.status,assigned_staffold.segment,assigned_staffold.staff FROM operations, projects,
assigned_staffold,employees,clients,omjob_titles,job_category WHERE job_category.job_cat_id=employees.staff_type AND omjob_titles.omjob_title_id=employees.title AND projects.client_id=clients.client_id AND assigned_staffold.project_id=projects.project_id AND  operations.operation_id=projects.operation_id AND assigned_staffold.project_id=projects.project_id 
and assigned_staffold.status!='3' and employees.staff_type='2' and projects.project_id='$project' AND employees.emp_id=assigned_staffold.staff order by clients.c_name asc";
								  $resultsst=mysql_query($queryst) or die ("Error: $queryst.".mysql_error());
...
echo '<tr bgcolor="#FFFFCC" height="10" >';
	   ...
	   {
	   ?>
	  <!-- <input type="checkbox" name="job_loc[]" value="Office" readonly="readonly" checked >Office &nbsp;&nbsp;
	   <input type="checkbox" name="job_loc[]" value="Field" readonly="readonly">Field--></td>
	   <?php
		}
		elseif ($work_place=='Field')
		{
...
{
?>
Select the project to load assigned expertriate staff here!!
<?php
}
else
{
?>
Sorry!! No expertriate staff allocated on this project
<?php
} 
?>		
    ...
    <td align="center" colspan="5"><input type="submit" name="submit" value="Unassign From Projects">&nbsp;&nbsp;<input type="reset" value="Cancel"></td>
