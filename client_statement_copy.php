...
$sql="select * from client_transactions where client_id='$id' order by date_recorded asc";
...
echo $balpn=$grnd_inv_bal-$grnd_payment;
			}
//echo number_format($grnd_inv_bal,2);
...
$sqlpaidinv="select amount_received from invoice_payments where client_id='$id' AND date_received BETWEEN '$date_back1' AND '$current_date2'";
$resultspaidinv= mysql_query($sqlpaidinv) or die ("Error $sqlinv.".mysql_error());

if ($numrowspaidinv=mysql_num_rows($resultspaidinv)>0)
{
while ($rowspaidinv=mysql_fetch_object($resultspaidinv))
			{
$amnt_paid=$rowspaidinv->amount_received;

$grnd_amount_paid=$grnd_amount_paid+$amnt_paid;
			}
//echo number_format($grnd_amount_paid,2);

}

//echo number_format($inv_bal=$grnd_inv_bal-$grnd_amount_paid,2);
/*$rowspaidinv=mysql_fetch_object($resultspaidinv);
$ttl_amnt_rec*/
...
$grnd_inv_balx=$grnd_inv_balx+$inv_balx;
 ...
 echo number_format($grnd_inv_balx,2);
...
$sqlpaidinvx="select amount_received from invoice_payments where client_id='$id' AND date_received BETWEEN '$date_back1x' AND '$current_date2x'";
$resultspaidinvx= mysql_query($sqlpaidinvx) or die ("Error $sqlinvx.".mysql_error());

if ($numrowspaidinvx=mysql_num_rows($resultspaidinvx)>0)
{
while ($rowspaidinvx=mysql_fetch_object($resultspaidinvx))
			{
$amnt_paidx=$rowspaidinvx->amount_received;

$grnd_amount_paidx=$grnd_amount_paidx+$amnt_paidx;
			}
number_format($grnd_amount_paidx,2);

}

number_format($inv_balx=$grnd_inv_balx-$grnd_amount_paidx,2);
?>
</td>
<td><?php 
...
$sqlinvx2="select * from invoices where client_id='$id' and date_generated BETWEEN '$date_back2x' AND '$current_date3x' AND status='1'";
$resultsinvx2= mysql_query($sqlinvx2) or die ("Error $sqlinvx2.".mysql_error());

if ($numrowsinvx2=mysql_num_rows($resultsinvx2)>0)
{
while ($rowsinvx2=mysql_fetch_object($resultsinvx2))
			{
 $inv_balx2=$rowsinvx2->invoice_ttl;

$grnd_inv_balx2=$grnd_inv_balx2+$inv_balx2;
			}
 echo number_format($grnd_inv_balx2,2);
...
$sqlpaidinvx2="select amount_received from invoice_payments where client_id='$id' AND date_received BETWEEN '$date_back2x' AND '$current_date3x'";
$resultspaidinvx2= mysql_query($sqlpaidinvx2) or die ("Error $sqlinvx2.".mysql_error());

if ($numrowspaidinvx2=mysql_num_rows($resultspaidinvx2)>0)
{
while ($rowspaidinvx2=mysql_fetch_object($resultspaidinvx2))
			{
$amnt_paidx2=$rowspaidinvx2->amount_received;

$grnd_amount_paidx2=$grnd_amount_paidx2+$amnt_paidx2;
			}
number_format($grnd_amount_paidx2,2);

}

number_format($inv_balx2=$grnd_inv_balx2-$grnd_amount_paidx2,2);
?></td>
<td><?php 
...
$sqlinvx23="select * from invoices where client_id='$id' and date_generated BETWEEN '$date_back3x' AND '$current_date4x' AND status='1'";
$resultsinvx23= mysql_query($sqlinvx23) or die ("Error $sqlinvx23.".mysql_error());

if ($numrowsinvx23=mysql_num_rows($resultsinvx23)>0)
{
while ($rowsinvx23=mysql_fetch_object($resultsinvx23))
			{
//$inv_balx23=$rowsinvx23->inv_bal;
 $inv_balx23=$rowsinvx23->invoice_ttl;

$grnd_inv_balx23=$grnd_inv_balx23+$inv_balx23;
			}
 echo number_format($grnd_inv_balx23,2);
...
$sqlpaidinvx23="select amount_received from invoice_payments where client_id='$id' AND date_received BETWEEN '$date_back2x' AND '$current_date3x'";
$resultspaidinvx23= mysql_query($sqlpaidinvx23) or die ("Error $sqlinvx23.".mysql_error());

if ($numrowspaidinvx23=mysql_num_rows($resultspaidinvx23)>0)
{
while ($rowspaidinvx23=mysql_fetch_object($resultspaidinvx23))
			{
$amnt_paidx23=$rowspaidinvx23->amount_received;

$grnd_amount_paidx23=$grnd_amount_paidx23+$amnt_paidx23;
			}
number_format($grnd_amount_paidx23,2);

}

number_format($inv_balx23=$grnd_inv_balx23-$grnd_amount_paidx23,2);
?></td>
  </tr>
