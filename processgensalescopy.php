...
//product code
/*$sqlprodpoi="select received_stock.purchase_order_id from received_stock where received_stock.product_id='2' order by received_stock.purchase_order_id desc limit 1";
$resultsprodpoi= mysql_query($sqlprodpoi) or die ("Error: $sqlprodpoi.".mysql_error());
$rowsprodpoi=mysql_fetch_object($resultsprodpoi);
echo $purchase_order_id=$rowsprodpoi->purchase_order_id;*/
...
if ($foc=='1' && $lease=='1')
{
$sql= "insert into temp_sales values('','$client_id','$user_id','$sales_rep','$currency','$curr_rate','$purchase_order_id','$prod','$prod_code','$sales_code','$qnty','F.O.C&Lease','0','0','0', NOW(),'1')";
...
$sql= "insert into sales values('','$lat_temp_sales_id','$client_id','$user_id','$sales_rep','$currency','$curr_rate','$purchase_order_id','$prod','$prod_code','$sales_code','$qnty','F.O.C&Lease','0','0','0', NOW(),'1')";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
{
$sql= "insert into temp_sales values('','$client_id','$user_id','$sales_rep','$currency','$curr_rate','$purchase_order_id','$prod','$prod_code','$sales_code','$qnty','F.O.C','0','0','0', NOW(),'1')";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
$sql= "insert into sales values('','$lat_temp_sales_id','$client_id','$user_id','$sales_rep','$currency','$curr_rate','$purchase_order_id','$prod','$prod_code','$sales_code','$qnty','F.O.C','0','0','0', NOW(),'1')";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
{
$sql= "insert into temp_sales values('','$client_id','$user_id','$sales_rep','$currency','$curr_rate','$purchase_order_id','$prod','$prod_code','$sales_code','$qnty','Lease','0','0','0', NOW(),'1')";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
$sql= "insert into sales values('','$lat_temp_sales_id','$client_id','$user_id','$sales_rep','$currency','$curr_rate','$purchase_order_id','$prod','$prod_code','$sales_code','$qnty','Lease','0','0','0', NOW(),'1')";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
$sql= "insert into temp_sales values('','$client_id','$user_id','$sales_rep','$currency','$curr_rate','$purchase_order_id','$prod','$prod_code','$sales_code','$qnty','$selling_price','$vat_value','$discount','$disc_value', NOW(),'1')";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
$sql= "insert into sales values('','$lat_temp_sales_id','$client_id','$user_id','$sales_rep','$currency','$curr_rate','$purchase_order_id','$prod','$prod_code','$sales_code','$qnty','$selling_price','$vat_value','$discount','$disc_value', NOW(),'1')";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
