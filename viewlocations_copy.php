...
<td align="right"><?php echo $task_cost=$rowsts->task_cost;?><input type="hidden" name="task_cost[]" value="<?php echo $rowsts->task_cost;?>" size="30"></td>
<td align="center"><?php 
...
{
	?>
	<a rel="facebox" href="edit_quotation_task.php?quotation_task_id=<?php echo $rowsts->quotation_task_id; ?>&booking_id=<?php echo $booking_id; ?>&quotation_id=<?php echo $quotation_id; ?>&convert=1"><img src="images/edit.png"></a>
	<?php
}
else
{
...
<a href="delete_quotation_task.php?quotation_task_id=<?php echo $rowsts->quotation_task_id; ?>&booking_id=<?php echo $booking_id; ?>&quotation_id=<?php echo $quotation_id; ?>&convert=1"><img src="images/delete.png" onClick="return confirmDelete();"></a>
