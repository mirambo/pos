...
header("Content-Disposition: attachment;Filename=Share_Holder_Statement_Of_Owners_Equity.xls");
header("Expires: 0");
...
$rowscont=mysql_fetch_object($resultscont);
 ...
 <tr>
	...
	<table width="100" border="0">
		<tr><td colspan="2"><font size="+1"><strong>Shareholder Details</strong></font></td></tr>
 ...
 <td colspan="4" align="right">JUBA STATIONERY AND PRINTING COMPANY LIMITED</td>
  ...
  <tr height="30">
    <td colspan="5" bgcolor="#000033" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">STATEMENT OF OWNERS EQUITY</span>
