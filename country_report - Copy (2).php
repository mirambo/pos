...
if (!isset($_POST['generate']))
{
$sqlsp="SELECT * FROM nrc_sub_project inner join nrc_project on nrc_project.project_id=nrc_sub_project.project_id where nrc_project.status=1 GROUP BY sub_project_id
...
$sqlsp="SELECT nrc_country,nrc_project.project_id, nrc_sub_project.sub_project_name, nrc_sub_project.sub_project_code, nrc_subprojectvslocation.sub_project_id, nrc_location.area_id, nrc_location.country_id
FROM nrc_project,nrc_sub_project, nrc_subprojectvslocation,nrc_location
WHERE nrc_location.country_id=nrc_country.country_id AND nrc_sub_project.project_id = nrc_project.project_id
