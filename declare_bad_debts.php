...
<form name="rec_inv_pay" action="process_bad_debts.php?invoice_id=<?php echo $id; ?>" method="post">	
<?php 
$sql="select doubtful_debts.doubtful_debt_id,doubtful_debts.client_id,doubtful_debts.currency_code,doubtful_debts.curr_rate,doubtful_debts.date_received,invoices.invoice_no,
...
doubtful_debts.currency_code=currency.curr_id AND doubtful_debts.doubtful_debt_id='$id'";
...
?></td>
  ...
  <tr height="30" bgcolor="#C0D7E5">
    <td bgcolor="">&nbsp;</td>
    <td width="19%" ><strong>Bad Debt Amount (<?php echo $rows->curr_name; ?>): </strong></td>
