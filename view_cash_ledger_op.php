...
<body>
	...
	<?php require_once('includes/client_opening_balance_submenu.php');  ?>
		...
		<h3>::Cash Ledger Opening Balance</h3>
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
	...
	Cash Ledger Opening Balance</strong></font>
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
    ...
    <td width="500"><div align="center"><strong>Client Name</strong></td>
...
$sql="select client_transactions.amount,client_transactions.date_recorded,client_transactions.client_id,clients.c_name from client_transactions,
clients where clients.client_id=client_transactions.client_id AND transaction='Opening Balance' order by clients.c_name asc";
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>
	...
	<td align="center"><a href="edit_client_op.php?client_id=<?php echo $rows->client_id; ?>"><img src="images/edit.png"></a></td>
	<td align="center"><a href="edit_client_op.php?client_id=<?php echo $rows->client_id; ?>"><img src="images/delete.png"></a></td>
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
    ...
    <td colspan="9" height="30" align="center"><font size="+1"><strong>
	Accounts Payables Legder</strong></font>
...
<?php 
$sqlbbd="select  accounts_payables_ledger.transaction_id,accounts_payables_ledger.transactions,accounts_payables_ledger.amount,accounts_payables_ledger.debit,accounts_payables_ledger.credit,accounts_payables_ledger.currency_code,accounts_payables_ledger.curr_rate,accounts_payables_ledger.date_recorded, currency.curr_name 
from accounts_payables_ledger,currency where accounts_payables_ledger.currency_code=currency.curr_id AND date_recorded <'$date_from'order by accounts_payables_ledger.transaction_id asc";
