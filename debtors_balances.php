...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>
  ...
  <td align="" width="20%"><strong><strong>Total Receivables</strong></td>
  <td align="center" width="40%"><strong></strong></td>

  <td width="38%"><strong><font size="+1"><strong><?php echo number_format($job_card_ttl,2);?></strong></font></strong></td>
  
  </tr>
  </table>
<table width="60%" border="0" align="center" class="display nowrap" style="border-radius:5px;" id="example">
  <tr height="30" bgcolor="#FFFFCC">
  <td align="" width="20%"><strong>Total Receivables</strong></td>
  <td align="center" width="40%"><strong></strong></td>

  <td width="38%"><strong><font size="+1"><?php echo number_format($job_card_ttl,2);?></font></strong></td>
