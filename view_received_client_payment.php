...
<strong>Or By Date</strong>
   ...
   <tr style="background:url(images/description.gif);" height="30" >
	...
	<td width="10%"><div align="center"><strong>Amount</strong></td>	
	 ...
	 <td width="45%" ><div align="center"><strong>Invoices Paid For</strong></td>
...
ORDER BY customer_payments_code.date_received desc ";
...
$queryop= "SELECT * FROM customer,mop,customer_payments_code,currency";
    $conditions = array();
...
if($client!='') 
 ...
 if($date_from!='' && $date_to!='' ) 
 {
      ...
      $conditions[] = "customer_payments_code.date_paid >='$date_from' AND customer_payments_code.date_paid <='$date_to'";
}

 if($mop!=0) 
 {
	
      $conditions[] = "customer_payments_code.mop='$mop'";
}
...
$queryop .= " WHERE " . implode(' AND ', $conditions)." AND customer_payments_code.mop=mop.mop_id 
and customer_payments_code.customer_id=customer.customer_id and customer_payments_code.currency_code=currency.curr_id
ORDER BY customer_payments_code.date_received desc";
...
customer_payments.sales_id=sales.sales_id and customer_payments.customer_payment_code_id='$invoice_id'
order by customer_payments.sales_id desc") or die("Query failed: ".mysql_error());
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
	...
	<td><?php echo $row33['order_no']; ?></td>
		...
		<td align="right"><?php 
echo number_format($order_amount_received=$row33['invoice_amount_received'],2); 
...
<?php
 ...
 ?>
	...
	<td align="center"><a href="home.php?receive_client_payment&id=<?php echo $rows->customer_payment_code_id; ?>"><img src="images/edit.png"></a></td>
