...
<form name="emp" action="<?php $_SERVER['PHP_SELF']; ?>" method="post" id="suggestSearch">	
...
<span ><div id='emp_errorloc' class='error_strings'></div></span>
  ...
  <tr height="30" bgcolor="#FFFFCC">
    ...
    <td width="23%" colspan="4" align="center">  <strong>Type The Project Name<font color="#FF0000">* </font></strong>
...
echo '<tr bgcolor="#FFFFCC" height="10" >';
    ...
    <td align="center" colspan="3"><input type="submit" name="submit" value="Save"><input type="hidden" name="assign_project" id="assign_project" value="1">&nbsp;&nbsp;</td>
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("PoNumber","req",">>Please type the project name");
