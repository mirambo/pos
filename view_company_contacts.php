...
<body>
	...
	<?php require_once('includes/companysettings_submenu.php');  ?>
		...
		<h3>:: View / Update Company Contact Details</h3>
...
?>
  ...
  <td align="center" width="200"><strong>Contact Person</strong></td>
    ...
    <td align="center" width="160"><strong>PIN</strong></td>
	<td width="180" align="center"><strong>Email Address</strong></td>
	<td align="center" width="160"><strong>Fax</strong></td>
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>
    ...
    <td align="center"><a href="edit_contacts.php?contacts_id=<?php echo $rows->contacts_id; ?>"><img src="images/edit.png"></a></td>
    <td align="center"><a href="delete_contacts.php?contacts_id=<?php echo $rows->contacts_id; ?>"  onClick="return confirmDelete();"><img src="images/delete.png"></a></td>
    </tr>
  <?php 
