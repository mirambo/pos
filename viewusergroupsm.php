...
self.location='home.php?viewusergroupsm=viewusergroupsm&user_group_id=' + val ;
...
<form name="emp" id="emp" action="process_unassign_sub_module_usergroup.php" method="post">			
...
?></td>
    ...
    <td width="20%"  align="right">Select User Group<font color="#FF0000">*</font></td><td width="10">
    <select name="user_group_id" id="user_group_id" onChange="reload(this.form)">
	<?php 
	
	$query1="select * from user_group where user_group_id='$id'";
...
$queryst="select sub_module.sub_module_name,sub_module.sublink,sub_module.sub_module_id,modules.module_name from user_group,modules_submodules,sub_module,modules,user_group_submodule 
	where modules_submodules.sub_module_id=sub_module.sub_module_id AND modules_submodules.module_id=modules.module_id and modules_submodules.sub_module_id=user_group_submodule.sub_module_id and user_group_submodule.sub_module_id=sub_module.sub_module_id 
	AND user_group_submodule.user_group_id=user_group.user_group_id and user_group_submodule.user_group_id='$id' AND modules.status='0' order by modules.module_name asc";
...
echo '<tr bgcolor="#FFFFCC" height="10" >';
	    ...
	    <td align="center"><input type="checkbox" name="module_id[]" value="<?php echo $rowsst->sub_module_id;?>"></td>
