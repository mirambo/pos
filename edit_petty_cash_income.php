...
$sql="SELECT * from petty_cash_income where petty_cash_income_id='$id'";
...
<body>
	...
	<div id="page-wrap">
		...
		<h3>:: Update Petty Cash Income</h3>
...
<form name="new_supplier" action="processeditpettyinc.php?petty_cash_income_id=<?php echo $id;?>" method="post">			
...
echo '<div align="center" style="background: #FFCC33; height:20px; width:600px; border:#339900 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#339900" >Petty Cash Income Updated successfully!!</font></strong></p></div>';
?>
...
?></td>
  ...
  <tr height="20">
    <td bgcolor="">&nbsp;</td>
    <td width="19%" valign="top">Enter Fund Description<font color="#FF0000">*</font></td>
