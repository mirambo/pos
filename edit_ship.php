...
$sql="SELECT * FROM shippers where shipper_id='$id'";
...
<form name="new_ship" action="processeditship.php?shipper_id=<?php echo $id; ?>" method="post">			
...
echo '<div align="center" style="background: #FFCC33; height:20px; width:600px; border:#339900 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#339900" >Shipper Updated Successfully!!</font></strong></p></div>';
?>
...
?></td>
    ...
    <td width="23%"><input type="text" size="41" name="agent_name" value="<?php echo $rows->shipper_name;?>">
   </td>
