...
$sql="select * FROM staff_work_permit WHERE exp_date BETWEEN '$date1' AND '$date2' ";
...
<? 
 ...
 $subject = "Work Permit Expiry Alerts";
 $body = "Hi Super Administrator,\n\n  We are pleased to inform you that $numrows work permits are almost Expiring.Kindly login into the System for further details then renew them.";
...
$sqlauditsav= "insert into alert_logs values('','Work Permit Alert Send Successfully',NOW())";
