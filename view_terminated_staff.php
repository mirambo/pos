...
?> </span>
  ...
  <?php   
$sql="select * from employees where status='1' order by emp_id asc";
...
echo '<tr bgcolor="#FFFFCC" height="25"  onmouseover="ChangeColor(this, true);" 
 ...
 ?>
    ...
    <td align="center" onClick="document.location.href='employee_det.php?emp_id=<?php echo $rows->emp_id;?>'" ><?php echo $rows->employee_no;?></td>
    <td onClick="document.location.href='employee_det.php?emp_id=<?php echo $rows->emp_id;?>'"><?php echo $rows->emp_firstname.' '.$rows->emp_middle_name.' '.$rows->emp_lastname;?></td>
	<td onClick="document.location.href='employee_det.php?emp_id=<?php echo $rows->emp_id;?>'"><?php echo $rows->job_title_id;?></td>
	<td onClick="document.location.href='employee_det.php?emp_id=<?php echo $rows->emp_id;?>'"><?php echo $rows->emp_email;?></td>
	<td align="center" onClick="document.location.href='employee_det.php?emp_id=<?php echo $rows->emp_id;?>'"><?php echo $rows->emp_phone;?></td>
	<td align="center" onClick="document.location.href='employee_det.php?emp_id=<?php echo $rows->emp_id;?>'">
  ...
  ?>
    ...
    <td onClick="document.location.href='employee_det.php?emp_id=<?php echo $rows->emp_id;?>'" align="center"><a href="employee_det.php?emp_id=<?php echo $rows->emp_id; ?>"><img src="images/edit.png"></a></td>
    <td align="center"><a href="delete_emp.php?emp_id=<?php echo $rows->emp_id; ?>" onClick="return confirmDelete();"><img src="images/delete.png"></a></td>
    </tr>
  <?php 
