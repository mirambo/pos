...
<form name="gen_order" action="processaddprepaidexp.php" method="post">			
...
<select name="exp_cat_id" style="width:100px;">
	<option>Select...........</option>
								  ...
								  </select><a rel="facebox" href="new_exp_account.php?type=1">New</a>
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("exp_cat_id","dontselect=0",">>Please select expense account");
 ...
 frmvalidator.addValidation("curr_rate","req",">>Please enter exchange rate to SSP");
