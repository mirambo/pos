...
<body>
	...
	<div id="page-wrap">
		...
		<h3>:: List of All Cheque Deposits</h3>
...
<a target="_blank" style="float:right; margin-right:200px; font-weight:bold; font-size:13px; color:#000000" href="print_list_cheque_deposit.php?location_id=<?php echo $supplier; ?>&from=<?php echo $date_from ?>&to=<?php echo $date_to; ?>">Print</a>						  
...
{
	?>	
	<a href="edit_cheque_deposits.php?cheque_deposit_id=<?php echo $rows->cheque_deposit_id; ?>"><img src="images/edit.png"></a>
	<?php
}
else
{
