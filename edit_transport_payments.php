...
$invoice_payment_id=$_GET['transport_charges_id'];
$sql="select mop.mop_name,shippers.shipper_name,transport_charges.amount_received,transport_charges.shipper_id,transport_charges.receipt_no,transport_charges.transport_charges_id,transport_charges.mop,transport_charges.ref_no,transport_charges.client_bank,
transport_charges.our_bank,transport_charges.decription,transport_charges.date_paid,transport_charges.receipt_no,transport_charges.date_received,transport_charges.status,currency.curr_name,
...
transport_charges.mop=mop.mop_id and transport_charges.shipper_id=shippers.shipper_id AND transport_charges.currency_code=currency.curr_id 
 AND transport_charges.transport_charges_id='$invoice_payment_id'";
...
<body>
	...
	<?php require_once('includes/transport_charges_submenu.php');  ?>
		...
		<h3>:: Update Transport Payment Details</h3>
...
<form name="gen_order" action="process_edit_transport_payment.php?invoice_payment_id=<?php echo $invoice_payment_id;?>" method="post">			
