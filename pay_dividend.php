...
<form name="new_supplier" action="process_pay_dividend.php?shares_id=<?php echo $shares_id ?>&financial_year_id=<?php echo $financial_year_id; ?>&dividend_id=<?php echo $dividend_id; ?>" method="post">			
...
?></td>
  ...
  <tr height="20">
    ...
    <td width="23%"><textarea name="desc" rows="3" cols="36" readonly="readonly">Withdrawal of dividends for <?php echo $share_holder_name; ?></textarea></td>
  ...
  <tr height="20">
	...
	<tr height="20">
    <td>&nbsp;</td>
    <td>Withdrawn Amount<font color="#FF0000">*</font></td>
