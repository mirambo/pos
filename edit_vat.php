...
<form name="new_supplier" action="processeditvat.php" method="post">			
...
?></td>
  ...
  <tr height="20">
    ...
    <td width="12%" align="right">VAT (%)<font color="#FF0000">*</font></td>
    <td width="23%"><input type="text" size="41" name="user_group" value="<?php echo $rows->vat_setting_perc;?>"></td>
