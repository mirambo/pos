...
header("Content-Disposition: attachment;Filename=Doubtful_Debts_Ledger.doc");
header("Expires: 0");
...
<title>Doubtful Debts Ledger</title>
...
<tr>
  ...
  <tr height="30">
    <td colspan="7" bgcolor="#000033" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">DOUBTFUL DEBTS LEDGER</span>
...
$rowscont=mysql_fetch_object($resultscont);
  ...
  <tr height="30">
    <td colspan="7" bgcolor="#000033" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">DOUBTFULL DEBTS LEDGER</span>
