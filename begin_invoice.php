...
<body>
	...
	<div id="page-wrap">
		...
		<h3>:: Receive Items With Bill Directly into the store</h3>
...
<form name="start_order" action="process_gen_bill_code.php" method="post">	
<?php 
if ($order_code!=0)
{
include('view_direct_bill_details.php');
?>
...
<tr bgcolor="#2E3192"><td colspan="2"  align="center"><img src="images/task_icon.png" align="left" width="20" height="20"><strong><font color="#ffffff">Bill Details</font></strong></td></tr>
<tr height="30">
<td align="center">
<div id='start_order_date_from_errorloc' class="error_strings"></div><div id='emp_date_to_errorloc' class="error_strings"></div>
Bill Date<input type="text" name="date_from" size="20" id="date_from" readonly="readonly" />
...
<option value="0">Select..............................</option>
								  ...
								  </select> <a href="add_supplier.php?newsupb=newsupb">New Supplier</a>
...
<input type="submit" name="submit" onClick="return confirmSave();" value="Save Bill Details" style="background:#2E3192; font-size:14px; color:#ffffff; font-weight:bold; width:300px; height:30px; border-radius:5px;">
	</td></tr>
<?php 
}
?>	
