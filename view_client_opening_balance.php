...
<body>
	...
	<?php require_once('includes/client_opening_balance_submenu.php');  ?>
		...
		<h3>::All Clients Opening Balances</h3>
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
	...
	All Clients Opening Balances</strong></font>
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
    ...
    <td width="500"><div align="center"><strong>Client Name</strong></td>
		 <td width="200" ><div align="center"><strong>Amount (SSP)</strong></td>	
...
customer where customer.customer_id=customer_transactions.customer_id AND transaction='Opening Balance' order by customer.customer_name asc";
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>
	...
	<td align="center"><a href="edit_client_op.php?client_id=<?php echo $rows->customer_id; ?>"><img src="images/edit.png"></a></td>
	<td align="center"><a href="edit_client_op.php?client_id=<?php echo $rows->customer_id; ?>"><img src="images/delete.png"></a></td>
