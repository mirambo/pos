...
if(isset($_GET['subDELETESubProject']))
  { 
$cat_id=$_GET['cat_id'];
delete_subproject($cat_id,$user_id);
  }
?>
...
{
    return confirm("CAUTION!!!.If you delete this category, some data will be affected. So Are you sure you want to delete this category?");
}
...
?>
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
    ...
    <td align="center" width="150"><strong>Item Category Name</strong></td>
    <td align="center" width="200"><strong>Item Category Description</strong></td>
...
$sql="SELECT * FROM items_category order by cat_name asc";
...
if ($project_name!='')
{
$sql="SELECT * FROM items_category where cat_name LIKE '%$project_name%' order by cat_name asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
<?php if ($sess_allow_edit==1) 
	{
	?>	
	<a href="home.php?editsubproject=editsubproject&cat_id=<?php echo $cat_id=$rows->cat_id; ?>"><?php
	echo $redit;
...
if ($rowssupp>123450)
	...
	<a href="delete_category.php?cat_id=<?php echo $rows->cat_id; ?>"  onClick="return confirmDelete();"><?php
	echo $rdelete;
