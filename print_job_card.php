...
$start_date=$rowsj->start_date;

$sqlcurr="select * from currency where curr_id='$curr_id'";
...
<?php
 ...
 ?>
  ...
  <tr height="30">
    <td colspan="10" ><strong>INVOICE NO : <?php echo $invoice_no; ?>
	&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<?php //echo $invoice_no; ?><span style="float:right;">DATE : <?php echo $start_date;
...
<strong><font color="#000000">Total Amount : <?php echo  number_format($grnd_amnt,2); ?></font>
&nbsp;&nbsp;&nbsp;

Discount Value (<?php echo $discount;?>%) : <?php echo  number_format($disc_value=$discount/100*$grnd_amnt,2);?>



Discounted Amount : <?php echo  number_format($discounted_amnt=$grnd_amnt-$disc_value,2);?>
...
<?php 
	   ...
	   echo  number_format($ttl_amount_paid=$rowspd->ttl_amnt,2);
	   ?></font>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

<font color="#ff0000">
Balance : 
<?php echo  number_format($balance=$discounted_amnt-$ttl_amount_paid,2); ?>
...
JOB CARD / WORK ORDER	
  ...
  <tr height="30">
    <td colspan="10" ><strong>JOB CARD NO : <?php echo $invoice_no; ?>
...
?>
  ...
  <tr height="30">
	...
	<table width="100%" border="0">
	<tr>
	<td><strong><span align="left">Begin Date: <i><?php echo $rowsj->start_date; ?></i></span></strong></td>
	<td><span align="center" style="margin:auto;"><strong>Completion Date:<i><?php echo $rowsj->end_date; ?></i></span></strong></td>
	<td><strong><span align="left"> <i>Technician : <?php 
	$technician_id=$rowsj->technician_id;
	$sqlusert="select * FROM users WHERE user_id='$technician_id'";
...
echo $rowsusert->f_name;
	...
	<table width="100%" border="0" class="table">
	 ...
	 <tr bgcolor="#C0D7E5" height="30" align="center">
    <td colspan="9"><strong>SERVICE DETAILS</strong><hr/></td>
 </tr>
 <tr style="background:url(images/description.gif);" height="20" align="center">
<td width="20%"><strong>Service Item</strong></td>
<td width="10%"><strong>Description<strong></td>
...
?>
        ...
        <td width="10%"><?php echo $rowsts->start_from;?></td>   
		   <td align="center">
                <?php echo $quantity=$rowsts->quantity;?>
            </td>
