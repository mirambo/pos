...
<body>
	...
	<?php require_once('includes/sharessubmenu.php');  ?>
		...
		<h3>:: Record Additional Investments</h3>
...
<form name="gen_order" action="process_additional_investments.php" method="post">			
...
?></td>
 <!--<input type="hidden" name="supplier_id" size="20" value="<?php echo $rowstemp->supplier_id; ?>">
  ...
  <tr height="20" bgcolor="#C0D7E5">
    ...
    <td width="15%" valign="top">Select Shareholder<font color="#FF0000"></font></td>
    <td width="15%" valign="top">
	
	<select name="client"><option value="0">Select..............................</option>
								  <?php
								  
								  $query1="select * from shares where status='0' order by share_holder_name asc";
...
if (mysql_num_rows($resultsbnk) > 0)
{
  ...
  <tr height="15" bgcolor="#FFFFCC">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2" align="center"><input type="submit" name="submit" onClick="return confirmDelete();" value="Save Transaction">&nbsp;<input type="reset" value="Cancel"></td>
...
<SCRIPT language="JavaScript">
 ...
 frmvalidator.addValidation("client","dontselect=0",">>Please select shareholder");
