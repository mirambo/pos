...
invoice_payments.mop,invoice_payments.ref_no,invoice_payments.client_bank,invoice_payments.our_bank,invoice_payments.date_paid,
...
invoice_payments.currency_code,invoice_payments.curr_rate,invoice_payments.amount_received FROM sales_code,mop,clients,invoice_payments,
currency where invoice_payments.mop=mop.mop_id and invoice_payments.sales_code_id=sales_code.sales_code_id and 
sales_code.client_id=clients.client_id and invoice_payments.status='0' AND  invoice_payments.currency_code=currency.curr_id  
...
<body>
	...
	<?php require_once('includes/lposubmenu.php');  ?>
		...
		<h3>:: Update Payments Received From Clients</h3>
...
<form name="gen_order" action="process_edit_client_payment.php?invoice_payment_id=<?php echo $invoice_payment_id;?>" method="post">			
