...
<form name="new_user_group" action="processaddgroup.php" method="post">			
...
echo '<div align="center" style="background: #FFCC33; height:20px; width:600px; border:#339900 solid 1px; font-size:11px;" class="br-5"> <p align="center"><font color="#339900" >User Group Created Successfully!!</font></strong></p></div>';
?>
...
?></td>
  ...
  <tr>
    <td bgcolor="">&nbsp;</td>
    <td width="19%">Enter Group Name <font color="#FF0000">*</font></td>
    <td width="23%"><input type="text" size="41" name="group_name"></td>
    <td width="40%" rowspan="2" valign="top"><div id='new_user_group_errorloc' class='error_strings'></div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Enter Description</td>
    <td><textarea rows="5" cols="30" name="group_desc"></textarea></td>
    </tr>
