...
$view=$_GET['view'];
$sqltemp="select * FROM purchase_returns_items,products 
WHERE purchase_returns_items.product_id=products.product_id AND purchase_returns_items.purchase_returns_items_id='$purchase_order_id'";
...
<form name="gen_order" action="processeditprtrans.php?purchase_order_id=<?php echo $purchase_order_id;?>&view=<?php echo $view; ?>&order_code=<?php echo $order_code; ?>" method="post">			
