...
$queryop="select * FROM customer,mop,invoice_payments,currency where invoice_payments.mop=mop.mop_id and invoice_payments.customer_id=customer.customer_id and  invoice_payments.currency_code=currency.curr_id AND invoice_payment_id='$invoice_payment_id'";
...
$invoice_number=$rows34->invoice_no;
if ($invoice_payment_id=='')
{
...
<?php require_once('includes/invoice_payment_submenu.php');  ?>
		...
		<h3>:: Receive Payments from Clients</h3>
...
<form name="gen_order" action="process_client_payment_bulk.php?id=<?php echo $invoice_payment_id; ?>" method="post">			
...
?>
  ...
  <tr height="30" bgcolor="#FFFFCC">
    ...
    <td colspan="9" >Select Payment Date:<input type="text" required name="date_paid" value="<?php echo $date_paid; ?>" size="40" id="date_paid" readonly="readonly" />
...
<option value="<?php echo $account_to_debit; ?>"><?php echo $account_to_debit_name; ?></option>
  ...
  <tr height="20" bgcolor="#C0D7E5">
	...
	<select name="customer_id" required id="customer_id" style="width:150px;">
	...
	<select name="invoice_id" required id="invoice_area" style="width:150px;">
	...
	Amount Received : <font color="#FF0000"></font><span id="sub_cat2"><input type="number" required name="amount" value="<?php echo $rows->amount_received;?>" size="20"></span>
...
<tr height="20" bgcolor="#FFFFCC">
    ...
    <td valign="top" align="right" width="40%">Description:<font color="#FF0000"></font></td>
	   <td valign="top"><textarea cols="44" rows="5" name="desc"><?php echo $rows->description; ?></textarea></td>
