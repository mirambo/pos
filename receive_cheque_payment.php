	...
	<div id="page-wrap">
		...
		<div id="zone-bar" class="br-5">
          <?php include ('topmenu.php');?>
			...
			<?php require_once('includes/receive_cheque_payment_submenu.php');  ?>
		
		<h3>::  Record Cheque/Cash Payments </h3>
...
<form name="start_order" action="process_received_cheque.php?id=<?php echo $id; ?>" method="post">	
<?php 
if ($sales_id!=0)
{
...
<h3 align="center">Enter Payment Details</h3>
...
Accout To Debit
<select name="debit_account_id" id="account_from" required style="width:250px;">
...
<option value="<?php echo $account_to_debit; ?>"><?php echo $account_to_debit_name; ?></option>
								  ...
								  Amount : <input type="text" name="debit_amount" value="<?php echo $rows->debit_amount; ?>" required size="20">
...
<tr bgcolor="#2E3192"><td colspan="5"  align="center"><img src="images/customer_icon.png" align="left" width="20" height="20"><strong><font color="#ffffff">Account To Credit Details</strong></td></tr>

							<tr>
							    <th><input class='check_all' type='checkbox' onclick="select_all()"/></th>
							    
							    <th>Accounts To Credit</th>
...
where cheque_received.account_to_credit=account_type.account_type_id AND 
   ...
   ?>
							...
							<tr>
						    	...
						    	<!--<td><span id='snum'>1.</span></td>-->
						   	 	<td align="center"><input class="form-control" required type='text' placeholder="start to type..if list doesn't appeaer, your item doesn't exist" id='countryname_1' size="60" style="height:30px; border-radius:5px;" name='countryname[<?php echo $cheque_received_id; ?>]' value="<?php echo $rowsemp_det2->account_type_name; ?>"/></td>
						    	
						    	<td align="center">
								<input class="form-control" type='hidden' required id='country_no_1' value="<?php echo $rowsemp_det2->account_to_credit; ?>" name='country_no[<?php echo $cheque_received_id; ?>]'/>
								
								<input class="form-control" type='text' required style="height:30px; border-radius:5px;" value="<?php echo $rowsemp_det2->credit_amount; ?>" id='phone_code_1' name='phone_code[<?php echo $cheque_received_id; ?>]'/>
								
								</td>
								
								<td align="center" width="20%"><select name='vat[]'><option value='<?php echo $vat; ?>'><?php echo $vat_status; ?></option><option value='1'>Yes</option></select></td>
							...
							<tr class="txtMult">
								...
								<input class="val1" type='text' required  style="height:30px; border-radius:5px;" id='phone_code_1' name='phone_code[]'/>
								
								<span class="multTotal" style="display;">4000</span>
								</td>
						...
						<div style="float:right; width:100%; background:;">
								<tr align="center">
							<td><strong><font size="" color="#000000"> Grand Total (<span id="sub_cat23"></span>): </strong><span id="grandTotal">0.00</span></font></td>
