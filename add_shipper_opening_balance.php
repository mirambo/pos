...
<body>
	...
	<div id="page-wrap">
		...
		<h3>:: Adding Shipper Opening Balance Into the system </h3>
...
<form name="new_user" action="processaddshipperopeningbal.php" method="post">			
...
?></td>
	...
	<tr height="30">
    <td>&nbsp;</td>
    <td  width="25%">Select Shipper<font color="#FF0000">*</font></td>
    <td>
