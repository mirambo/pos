...
WHERE nrc_set_template.area_id=$area_id AND nrc_set_template.cc_id=$cc_id and nrc_project.project_id=$project_id AND nrc_project.status=2
...
INNER JOIN nrc_sub_project ON nrc_sub_project.sub_project_id = nrc_set_template.sub_project_id
INNER JOIN nrc_project ON nrc_project.project_id=nrc_set_template.project_id
WHERE nrc_set_template.area_id =$area_id and nrc_project.status=2
GROUP BY nrc_sub_project.sub_project_id
...
INNER JOIN nrc_sub_project ON nrc_sub_project.sub_project_id=nrc_set_template.sub_project_id
INNER JOIN nrc_project ON nrc_project.project_id=nrc_set_template.project_id
WHERE nrc_set_template.area_id=$area_id AND nrc_set_template.cc_id=$cc_id and nrc_project.status=2  GROUP BY nrc_sub_project.sub_project_id  ORDER BY nrc_sub_project.sub_project_id
";
$resultssp=mysql_query($sqlsp) or die ("Error $sqlsp.".mysql_error());
...
WHERE nrc_set_template.area_id=$area_id and nrc_project.project_id=$project_id AND nrc_project.status=2
GROUP BY nrc_sub_project.sub_project_id  ORDER BY nrc_sub_project.sub_project_id";
$resultssp=mysql_query($sqlsp) or die ("Error $sqlsp.".mysql_error());
...
WHERE nrc_set_template.area_id=$area_id AND nrc_set_template.cc_id=$cc_id  AND nrc_project.status=2
GROUP BY nrc_sub_project.sub_project_id  ORDER BY nrc_sub_project.sub_project_id";
$resultssp=mysql_query($sqlsp) or die ("Error $sqlsp.".mysql_error());
...
$sqlsact="SELECT * FROM nrc_set_template where sub_project_id='$sub_proj_id' AND nrc_set_template.cc_id='$cc_id' and area_id='$area_id' and project_id='$project_id'";
$resultsact=mysql_query($sqlsact) or die ("Error $sqlsact.".mysql_error());
