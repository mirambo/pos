...
<body>
	...
	<div id="page-wrap">
		...
		<h3>:: Record Fixed Assets Payments</h3>
...
?>
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
    ...
    <td width="150" ><div align="center"><strong>Value(Other Currency)</strong></td>
	...
	<td width="150"><div align="center"><strong>Amount Paid</strong></td>
	<td width="120" ><div align="center"><strong>Balance</strong></td>
	<td width="10%" align="center"><strong>Record Payment</strong></td>
...
fixed_assets.value,fixed_assets.fixed_asset_category_id ,fixed_assets.dep_value,fixed_assets.date_recorded,currency.curr_name from fixed_assets,currency where 
...
//$curr_rate=$rowcurr->curr_rate;
	...
	?></td>
    <td align="right"><?php echo number_format($bal_fp=$ttl_value_kshs-$ttl_paid,2);?></td>
    <td align="center"><?php 
	if ($ttl_value_kshs==$ttl_paid)
	{
	echo "<i>Fully Paid</i>";
	}
	elseif($ttl_value_kshs>$ttl_paid && $ttl_paid!=0 )
	{?>
 ...
 <tr bgcolor="#FFFFCC" height="30">
    ...
    <td width="100"><div align="center"><strong><?php echo number_format($grnd_value_kshs,2); ?></strong></td>
	 <td width="100"><div align="center"><strong><?php echo number_format($grnd_ttl_paid,2); ?></strong></td>
    <td width="100"><div align="center"><strong><?php echo number_format($grnt_bal_fp,2); ?></strong></td>
