...
header("Content-Disposition: attachment;Filename=Bad_Debts_Ledger.doc");
header("Expires: 0");
...
<tr>
  ...
  <tr height="30">
    <td colspan="7" bgcolor="#000033" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">BAD DEBTS LEDGER</span>
...
from bad_debts_ledger,currency where bad_debts_ledger.currency_code=currency.curr_id order by bad_debts_ledger.transaction_id asc";
...
$rowscont=mysql_fetch_object($resultscont);
  ...
  <tr height="30">
    <td colspan="7" bgcolor="#000033" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">BADL DEBTS LEDGER</span>
...
<?php 
$sqlbbd="select  bad_debts_ledger.transaction_id,bad_debts_ledger.transactions,bad_debts_ledger.amount,bad_debts_ledger.debit,bad_debts_ledger.credit,bad_debts_ledger.currency_code,bad_debts_ledger.curr_rate,bad_debts_ledger.date_recorded, currency.curr_name 
from bad_debts_ledger,currency where bad_debts_ledger.currency_code=currency.curr_id AND date_recorded <'$date_from' order by bad_debts_ledger.transaction_id asc";
...
$grnd_amount_out_kshs=0; 
$sql="select  bad_debts_ledger.transaction_id,bad_debts_ledger.transactions,bad_debts_ledger.amount,bad_debts_ledger.debit,bad_debts_ledger.credit,bad_debts_ledger.currency_code,bad_debts_ledger.curr_rate,bad_debts_ledger.date_recorded, currency.curr_name 
from bad_debts_ledger,currency where bad_debts_ledger.currency_code=currency.curr_id AND date_recorded BETWEEN '$date_from' AND '$date_to' order by bad_debts_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
