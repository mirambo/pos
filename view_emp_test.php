...
if (mysql_num_rows($results) > 0)
 ...
 ?>
 <td align="center" width="150"><strong><?php echo $rows->form_field_name; echo $form_id=$rows->form_field_id; ?></strong></td>
...
<td onClick="document.location.href='employee_det.php?emp_id=<?php echo $data_id=$rowsp->data_id;?>'">
