...
header("Content-Disposition: attachment;Filename=Custom_Clearance_Ledger.doc");
header("Expires: 0");
...
<title>Custom Clearance and Freight Ledger</title>
...
<tr>
  ...
  <tr height="30">
    <td colspan="7" bgcolor="#000033" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">CUSTOM CLEARANCE AND FREIGHT LEDGER</span>
...
from custom_clearance_ledger,currency where custom_clearance_ledger.currency_code=currency.curr_id order by custom_clearance_ledger.transaction_id asc";
...
$grnd_amount_out_kshs=0; 
$sql="select  custom_clearance_ledger.transaction_id,custom_clearance_ledger.transactions,custom_clearance_ledger.amount,custom_clearance_ledger.debit,custom_clearance_ledger.credit,custom_clearance_ledger.currency_code,custom_clearance_ledger.curr_rate,custom_clearance_ledger.date_recorded, currency.curr_name 
from custom_clearance_ledger,currency where custom_clearance_ledger.currency_code=currency.curr_id AND date_recorded BETWEEN '$date_from' AND '$date_to' order by custom_clearance_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
