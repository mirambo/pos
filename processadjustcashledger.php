...
$transaction_desclg="Cash Balance Adjustment, Reason:".$desc;

if ($account==1)
{
$sqltranslg= "insert into cash_ledger values('','$transaction_desclg','-$amnt_paid','','$amnt_paid','6','1',NOW(),'')";
...
header ("Location:adjust_cash_ledger.php? addconfirm=1");
