...
{
$sqllpo= "insert into quotations values('','','','$get_prnt_currency','$get_prnt_curr_rate','$get_prnt_client_id','$latest_quote_code','$user_id','$sess_sales_rep',NOW(),'1')";
...
header ("Location:word_quotation.php?quotation_id=$latest_quotation_id&quote_code=$latest_quote_code&client_id=$get_prnt_client_id&currency=$get_prnt_currency&quotation_no=$quotation_no&payment_termsx=$get_payment_terms&delivery_termsx=$get_delivery_terms");
