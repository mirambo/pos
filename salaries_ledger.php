...
<body>
	...
	<?php require_once('includes/ledgerssubmenu.php');  ?>
		...
		<h3>::Salaries And Commission Expenses Legder</h3>
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
	...
	Salaries And Commission Expenses Legder</strong></font>
	...
	<a href="print_expenses_ledger.php" target="_blank">Print</a>|<a href="print_expenses_ledger_word.php">Export to word </a>
...
from general_expenses_ledger,currency where general_expenses_ledger.currency_code=currency.curr_id AND general_expenses_ledger.amount!='0' and general_expenses_ledger.amount!='-0' and general_expenses_ledger.amount!='-' order by general_expenses_ledger.transaction_id asc";
...
<table width="100%" border="0">
  <tr bgcolor="#FFFFCC">
    ...
    <td colspan="9" height="30" align="right"><font size="+1">
	<a href="print_expenses_ledger.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to; ?>" target="_blank">Print</a> | <a href="print_expenses_ledger_word.php?date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to; ?>">Export to word </a>
...
$grnd_amount_out_kshs=0; 
$sql="select  general_expenses_ledger.transaction_id,general_expenses_ledger.transactions,general_expenses_ledger.amount,general_expenses_ledger.debit,general_expenses_ledger.credit,general_expenses_ledger.currency_code,general_expenses_ledger.curr_rate,general_expenses_ledger.date_recorded, currency.curr_name 
from general_expenses_ledger,currency where general_expenses_ledger.currency_code=currency.curr_id AND date_recorded BETWEEN '$date_from' AND '$date_to' order by general_expenses_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
$grnd_amount_out_kshs=0; 
$sql="select  general_expenses_ledger.transaction_id,general_expenses_ledger.transactions,general_expenses_ledger.amount,general_expenses_ledger.debit,general_expenses_ledger.credit,general_expenses_ledger.currency_code,general_expenses_ledger.curr_rate,general_expenses_ledger.date_recorded, currency.curr_name 
from general_expenses_ledger,currency where general_expenses_ledger.currency_code=currency.curr_id order by general_expenses_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
