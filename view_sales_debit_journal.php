...
and sales_debit_journal.journal_type='DRT' and sales_debit_journal.currency_code=currency.curr_id
...
and sales_debit_journal.journal_type='DRT' and sales_debit_journal.currency_code=currency.curr_id ORDER BY sales_debit_journal.date_received desc";
...
and sales_debit_journal.journal_type='DRT' and sales_debit_journal.customer_id=customer.customer_id and sales_debit_journal.currency_code=currency.curr_id
ORDER BY sales_debit_journal.date_received desc ";
$results= mysql_query($queryop) or die ("Error $queryop.".mysql_error());
...
echo $rows34c->account_code.' - '.$rows34c->account_type_name;
	...
	<td align="center"><a href="home.php?sales_debit_journal&id=<?php echo $rows->sales_debit_journal_id; ?>"><img src="images/edit.png"></a></td>
