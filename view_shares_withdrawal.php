...
<body>
	...
	<?php require_once('includes/sharessubmenu.php');  ?>
		...
		<h3>::List of All Payments Made To shares</h3>
...
?>
	...
	<option value="0">-------------------Select-----------------</option>
								  ...
								  
								  {
                                    ...
                                    <option value="<?php echo $rows1->supplier_id; ?>"><?php echo $rows1->share_holder_name; ?> </option>
...
$sql="select mop.mop_name,shares.share_holder_name,shares_withdrawal.amount_received,shares_withdrawal.receipt_no,shares_withdrawal.shares_withdrawal_id ,shares_withdrawal.mop,shares_withdrawal.ref_no,shares_withdrawal.client_bank,
...
shares_withdrawal.mop=mop.mop_id and shares_withdrawal.shareholder_id=shares.shares_id AND shares_withdrawal.currency_code=currency.curr_id ORDER BY shares_withdrawal.date_received desc";
...
shares_withdrawal.our_bank,shares_withdrawal.date_paid,shares_withdrawal.receipt_no,shares_withdrawal.date_received,shares_withdrawal.status,currency.curr_name,
shares_withdrawal.currency_code,shares_withdrawal.curr_rate,shares_withdrawal.amount_received FROM mop,shares,shares_withdrawal,currency where 
shares_withdrawal.mop=mop.mop_id and shares_withdrawal.shareholder_id=shares.shares_id AND shares_withdrawal.currency_code=currency.curr_id and shares_withdrawal.shareholder_id='$client' order by shares_withdrawal.date_paid  desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
...
shares_withdrawal.our_bank,shares_withdrawal.date_paid,shares_withdrawal.receipt_no,shares_withdrawal.date_received,shares_withdrawal.status,currency.curr_name,
shares_withdrawal.currency_code,shares_withdrawal.curr_rate,shares_withdrawal.amount_received FROM mop,shares,shares_withdrawal,currency where 
shares_withdrawal.mop=mop.mop_id and shares_withdrawal.shareholder_id=shares.shares_id AND shares_withdrawal.currency_code=currency.curr_id and shares_withdrawal.date_paid BETWEEN '$date_from' AND '$date_to' order by shares_withdrawal.date_paid  desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
elseif($client!='0' && $date_from!='' && $date_to!='')
{
...
shares_withdrawal.our_bank,shares_withdrawal.date_paid,shares_withdrawal.receipt_no,shares_withdrawal.date_received,shares_withdrawal.status,currency.curr_name,
shares_withdrawal.currency_code,shares_withdrawal.curr_rate,shares_withdrawal.amount_received FROM mop,shares,shares_withdrawal,currency where 
shares_withdrawal.mop=mop.mop_id and shares_withdrawal.shareholder_id=shares.shares_id AND shares_withdrawal.currency_code=currency.curr_id and 
shares_withdrawal.date_paid BETWEEN '$date_from' AND '$date_to' and shares_withdrawal.shareholder_id='$client' order by shares_withdrawal.date_paid  desc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
...
else
{
	...
	<td align="center"><a href="edit_shares_withdrawal.php?shares_withdrawal_id=<?php echo $rows->shares_withdrawal_id;?>"><img src="images/edit.png"></a></td>
    <td align="center"><a href="delete_shares_withdrawal.php?shares_withdrawal_id=<?php echo $rows->shares_withdrawal_id;?>"  onClick="return confirmDelete();"><img src="images/delete.png"></a></td>
