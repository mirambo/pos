...
<tr height="30">
    ...
    <td width="20%"  align="right"><strong>Select Dropdown Title</strong><font color="#FF0000">*</font></td><td width="10">
	...
	$query1="select * FROM form_fields WHERE form_field_id='$id'";
	$results1=mysql_query($query1) or die ("Error: $query1.".mysql_error());
	$rowsinst1=mysql_fetch_object($results1);
	if ($id=='')
	{
	...
	<?php
	 ...
	 { ?>
	 <option value="<?php echo $rowsinst1->form_field_id;?>"><?php echo $rowsinst1->form_field_name; ?></option>
	 <?php 
