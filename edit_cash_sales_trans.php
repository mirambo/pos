<?php
session_start(); 
$temp_cash_sales_id=$_GET['temp_cash_sales_id'];
...
<body>
	...
	<?php require_once('includes/cashsalessubmenu.php');  ?>
		...
		<h3>:: Update Cash Sales Transaction <?php
...
<form name="gen_order" action="processeditcashsalestrans.php?temp_cash_sales_id=<?php echo $temp_cash_sales_id;?>&sales_code=<?php echo $sales_code; ?>&client_id=<?php echo $client_id; ?>&currency=<?php echo $currency; ?>" method="post">			
...
?></td>
  ...
  <?php 
$sqllpdet="select * from temp_cash_sales where temp_cash_sales_id='$id'";
...
echo $curr_rate=$rowcurr->curr_name;
	...
	?>)</div></td>
    <td valign="top"><input type="text" name="selling_price" size="20" value="<?php echo $rows->selling_price;  ?>"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
