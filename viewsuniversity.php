...
else
{
 ?>
<?php
if(isset($_GET['subDELETEDonor']))
  { 
$unit_id=$_GET['unit_id'];
delete_donor($unit_id,$user_id);
  }
?>
...
?>
	...
	<strong>Search Unit - Enter Unit Name: 
    </strong>
    
    
    <input type="text" name="donor" size="40" />
  ...
  <tr  style="background:url(images/description.gif);" height="30" >
    ...
    <td align="center" width="150"><strong>Unit Make</strong></td>
...
if ($donor!='')
{
$sql="SELECT * FROM units where unit_name LIKE '%$donor%' order by unit_name asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
}
else
{
...
echo '<tr bgcolor="#FFFFCC" height="25" >';
 ...
 ?>
    ...
    <td><?php echo $rows->unit_desc;?></td>
    
	<td align="center"><a href="home.php?edituniversity=edituniversity&unit_id=<?php echo $rows->unit_id; ?>"><img src="images/edit.png"></a></td>
    <td align="center">
	<?php if ($sess_allow_delete==1) 
	{
	?>
	<a href="home.php?viewuniversity=viewuniversity&subDELETEDonor&unit_id=<?php echo $rows->unit_id; ?>"  onClick="return confirmDelete();"><?php
	echo $rdelete;
