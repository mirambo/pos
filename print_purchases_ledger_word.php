...
header("Content-Disposition: attachment;Filename=Purchases_Ledger.doc");
header("Expires: 0");
...
<tr>
  ...
  <tr height="30">
    <td colspan="7" bgcolor="#000033" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">PURCHASES LEDGER</span>
...
from purchases_ledger,currency where purchases_ledger.currency_code=currency.curr_id order by purchases_ledger.transaction_id asc";
...
<?php 
$sqlbbd="select  purchases_ledger.transaction_id,purchases_ledger.transactions,purchases_ledger.amount,purchases_ledger.debit,purchases_ledger.credit,purchases_ledger.currency_code,purchases_ledger.curr_rate,purchases_ledger.date_recorded, currency.curr_name 
from purchases_ledger,currency where purchases_ledger.currency_code=currency.curr_id AND date_recorded <'$date_from' order by purchases_ledger.transaction_id asc";
...
$grnd_amount_out_kshs=0; 
$sql="select  purchases_ledger.transaction_id,purchases_ledger.transactions,purchases_ledger.amount,purchases_ledger.debit,purchases_ledger.credit,purchases_ledger.currency_code,purchases_ledger.curr_rate,purchases_ledger.date_recorded, currency.curr_name 
from purchases_ledger,currency where purchases_ledger.currency_code=currency.curr_id AND date_recorded BETWEEN '$date_from' AND '$date_to' order by purchases_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
