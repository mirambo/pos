...
$additional_investments_id=$_GET['additional_investments_id'];
$sql="select mop.mop_name,shares.share_holder_name,shares.shares_id,additional_investments.amount_received,additional_investments.receipt_no,additional_investments.additional_investments_id ,additional_investments.mop,additional_investments.ref_no,additional_investments.client_bank,
...
additional_investments.mop=mop.mop_id and additional_investments.shareholder_id=shares.shares_id AND additional_investments.currency_code=currency.curr_id  
and additional_investments.additional_investments_id='$additional_investments_id'";
...
<body>
	...
	<div id="page-wrap">
		...
		<h3>:: Update Additional Investments Details</h3>
...
<form name="gen_order" action="process_edit_additional_investments.php?additional_investments_id=<?php echo $additional_investments_id;?>" method="post">			
...
Exchange Rate To(SSP)<input type="text" name="curr_rate" size="10" value="<?php echo $rows->curr_rate; ?>">	</td>
