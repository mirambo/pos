...
$sql="select * from nrc_set_template where set_template_id='$set_template_id'";
...
?>
<form name="new_machine_category" action="process_edit_set_template.php" method="post">			
...
?></td>
  ...
  <tr style="background:url(images/description.gif);" height="20" align="center">
	...
	<td width="100"><input type="text" name="activity" size="50" value="<?php echo $rows->activity?>"></td>
	<td width="100"><input type="text" name="target" size="20" value="<?php echo $rows->target?>"></td>
	<td width="100"><input type="text" name="target_male" size="20" value="<?php echo $rows->target_male?>"></td>
	<td width="100"><input type="text" name="target_female" size="20" value="<?php echo $rows->target_female?>"></td>
