...
header("Content-Disposition: attachment;Filename=Expenses_Ledger.doc");
header("Expires: 0");
...
<tr>
  ...
  <tr height="30">
    <td colspan="7" bgcolor="#000033" align="center"><span style="font-size:17px; font-weight:bold; color: #FFFFFF;">EXPENSES LEDGER</span>
...
from salary_expenses_ledger,currency where salary_expenses_ledger.currency_code=currency.curr_id order by salary_expenses_ledger.transaction_id asc";
...
$grnd_amount_out_kshs=0; 
$sql="select  salary_expenses_ledger.transaction_id,salary_expenses_ledger.transactions,salary_expenses_ledger.amount,salary_expenses_ledger.debit,salary_expenses_ledger.credit,salary_expenses_ledger.currency_code,salary_expenses_ledger.curr_rate,salary_expenses_ledger.date_recorded, currency.curr_name 
from salary_expenses_ledger,currency where salary_expenses_ledger.currency_code=currency.curr_id AND date_recorded BETWEEN '$date_from' AND '$date_to' order by salary_expenses_ledger.transaction_id asc";
$results= mysql_query($sql) or die ("Error $sql.".mysql_error());
