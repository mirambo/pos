...
<tr height="40"> <td colspan="9" align="center"><img src="images/logoeaco.jpg"></td></tr>
<tr height="40"> <td colspan="9" align="center"><H2>EACO DATA COLLECTION PORTAL</H2></td></tr>
<tr height="40"> <td colspan="9" align="center"><H2>Post-Graduate Scholarships Record</H2></td></tr>
...
$sql="SELECT * FROM post_grad_scholarship where institution_id='$institution_id' order by post_grad_scholarship_id desc";
