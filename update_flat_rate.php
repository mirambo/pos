...
edit_donor($donor_name,$donor_desc,$user_id);
 ...
 ?><?php $vehicle_make_id=$_GET['vehicle_make_id'];?>
...
<form name="new_supplier" action="process_update_flat_rate.php" method="post">	

<?php 

$sql="SELECT * FROM  flat_rate_cost order by flat_rate_cost_id desc limit 1";
...
?></td>
  ...
  <tr height="20">
    <td bgcolor="">&nbsp;</td>
    <td width="19%">Flat Rate Cost (Kshs)<font color="#FF0000">*</font></td>
    <td width="23%"><input type="text" size="41" name="flat_rate_cost" value="<?php echo $rows->flat_rate_cost_amount;?>"></td>
  ...
  <!--<tr height="20">
    <td>&nbsp;</td>
    <td>Description</td>
    <td><textarea name="donor_desc" cols="30" rows="5"><?php echo $rows->vehicle_make_desc;?></textarea></td>
    </tr>-->
