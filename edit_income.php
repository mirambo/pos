...
$invoice_payment_id=$_GET['income_id'];
$sql="select * FROM mop,income,currency where 
income.mop=mop.mop_id AND income.currency_code=currency.curr_id 
 AND income.income_id='$invoice_payment_id'";
...
<form name="gen_order" action="processeditinc.php?invoice_payment_id=<?php echo $invoice_payment_id;?>" method="post">			
...
?></td>
  ...
  <tr height="20" bgcolor="#C0D7E5">
   ...
   <td width="15%" valign="top" colspan="2">
	...
	Date:<input type="text" name="date_paid" value="<?php echo $rows->date_paid; ?>" size="20" id="date_paid" readonly="readonly" />
