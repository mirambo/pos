...
self.location='home.php?viewmodulesusergroup=viewmodulesusergroup&user_group_id=' + val ;
...
<form name="emp" id="emp" action="process_unassign_module_usergroup.php" method="post">			
...
$queryst="select modules.module_name,modules.module_id FROM user_group,user_group_module,modules
where user_group_module.module_id=modules.module_id AND user_group_module.user_group_id=user_group.user_group_id and user_group_module.user_group_id='$id'";
