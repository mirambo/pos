...
?></td>
  ...
  <tr bgcolor="#000033" height="30">
	...
	<?php echo $inv_bal ?>&date_generated=<?php echo $date_generated;?>&user=<?php echo $user; ?>&sales_rep=<?php echo $sales_rep ?> "style="color:#FFFFFF;">Print Invoice</a> | 
	...
	&sales_code=<?php echo $get_sales_code; ?>&invoice_no=<?php echo $invoice_no; ?>&currency=<?php echo $currency;?>&curr_rate=<?php echo $curr_rate;?>&inv_bal=
	<?php echo $inv_bal ?>&date_generated=<?php echo $date_generated;?>&user=<?php echo $user; ?>&sales_rep=<?php echo $sales_rep ?> "style="color:#FFFFFF;">Print Invoice in Word</a> | </td>
...
$upd_amount=$rowsupd->invoice_ttl;
	...
	if ($upd_amount!=$grndttl)
	{
$sqlupd1="update invoices set invoice_ttl='$grndttl',inv_bal='$grndttl' where sales_code='$get_sales_code'";
$resultsupd1=mysql_query($sqlupd1) or die ("Error $sqlupd1.".mysql_error());


$sqlupd1="update client_transactions set amount='$grndttl' where sales_code='$get_sales_code' and 
client_id='$get_client_id' AND transaction LIKE '%Inv No:$invoice_no%'";
$resultsupd1=mysql_query($sqlupd1) or die ("Error $sqlupd1.".mysql_error());


$sqlupd1="update accounts_receivables_ledger set amount='$grndttl', debit='$grndttl' where transactions LIKE '%Inv No:$invoice_no%'";
$resultsupd1=mysql_query($sqlupd1) or die ("Error $sqlupd1.".mysql_error());
