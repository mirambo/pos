...
$sqlred="SELECT SUM(amount_received) as ttl_amnt_rec FROM sipet_invoice_payments where invoice_id='$invoice_id'";
...
<form name="rec_inv_pay" action="process_sipet_invoice_payment.php?invoice_id=<?php echo $invoice_id; ?>" method="post">	
<?php 
$sql="select invoices.invoice_id,invoices.invoice_no,invoices.date_generated,invoices.invoice_ttl,invoices.project_id,invoices.month_generated,
clients.c_name,projects.client_id from invoices,clients,projects where invoices.project_id=projects.project_id and projects.client_id=clients.client_id AND invoices.invoice_id='$invoice_id'";
