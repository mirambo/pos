...
<body>
	...
	<div id="page-wrap">
		...
		<h3>:: Update benefit Type Details</h3>
...
<form name="new_machine_category" action="processedit_ben_type.php?benefit_type_id=<?php echo $id; ?>" method="post">			
...
?></td>
 ...
 <tr>
    <td bgcolor="">&nbsp;</td>
    <td width="19%">Benefit Type Name <font color="#FF0000">*</font></td>
    <td width="23%"><input type="text" size="41" name="station_name" value="<?php echo $rowsprodcat->benefit_log_name;?>"></td>
    <td width="40%" rowspan="2" valign="top"><div id='pack_size_errorloc' class='error_strings'></div></td>
  </tr>
   <tr>
    <td bgcolor="">&nbsp;</td>
    <td>Default Benefit Amount<font color="#FF0000">*</font></td>
