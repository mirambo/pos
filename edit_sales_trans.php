...
<form name="gen_order" action="processeditsalestrans.php?temp_sales_id=<?php echo $temp_sales_id;?>&sales_code=<?php echo $sales_code; ?>&client_id=<?php echo $client_id; ?>&currency=<?php echo $currency; ?>&product_id=<?php echo $product_id ?>" method="post">			
...
?></td>
  ...
  <?php 
$sqllpdet="select * from temp_sales where temp_sales_id='$id'";
