...
$sqlupdt= "UPDATE post_grad_scholarship SET full_name='$stud_fname',gender='$gender',nationality='$nationality',admin_year='$adm_year',comp_year='$comp_year',
...
header ("Location:home.php?editpostgraduate=editpostgraduate&post_grad_scholarship_id=$post_grad_scholarship_id&editsuccess=1");
